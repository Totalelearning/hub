        ...
        <div class="px-3 not-iconic">
                    ...
                    <div class="col-12 col-sm">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item bi"><a href="{{ route('preview.learning-blogs') }}">Blogs</a></li>
            ...
            <div class="container mt-4" id="main-content">
                    ...
                    <div class="card-footer border-top">
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto text-end">
                                <p class="small text-secondary mb-0">Published on</p>
                ...
                <div class="row mb-4">
                    <div class="col-12 col-md-8">
                        ...
                        <div class="card adminuiux-card shadow-sm mb-3">
                            <div class="card-body">
                                <div class="height-300 w-100 rounded coverimg mb-4">
                ...
                <div class="text-center my-4 my-xl-5">
                    ...
                    <p class="text-secondary">Stay up to date with latest trending topics.</p>
                </div>
                <!-- Top trending carousel -->
                <div class="swiper swipernav mb-4">
                        ...
                        <div class="swiper-slide width-300">
                            <div class="card adminuiux-card shadow-sm position-relative overflow-hidden theme-red mb-3">
                                <div class="card-body z-index-1 p-xl-4 position-relative">
                                    ...
                                    <p class="text-secondary mb-4">Connects and integrates all your appointment sources - Website, Leads, Mobile, </p>
                                    <div class="row align-items-center">
                                        <div class="col">
                                            <p class="small text-secondary mb-0">Author</p>
                                            <p>Adminuiux</p>
                                        ...
                                        <div class="col-auto text-end">
                                            <p>
                                                <a href="{{ route('preview.learning-blog-details') }}" class="btn btn-link">More <i class="bi bi-arrow-right"></i>
                                                </a>
                                            </p>
                                        </div>
                                    </div>
                        ...
                        <div class="swiper-slide width-300">
                            <div class="card adminuiux-card shadow-sm bg-success text-white position-relative overflow-hidden mb-3">
                                ...
                                <div class=" card-body z-index-1 p-xl-4 position-relative">
                                    ...
                                    <p class="text-truncated h5">Learning UI UX Design with HTML ready to use template is most delighted themes</p>
                                    <p class="mb-4">Connects and integrates all your appointment sources - Website, Leads, Mobile, </p>
...
</div> <!-- page footer --> <!-- standard footer -->
