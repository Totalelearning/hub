              ...
              <div class="container mt-4" id="main-content">
                <div class="row">
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.learning-dashboard') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <p>Dashboard</p>
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.learning-student-home') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <p>Academic</p>
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.learning-attendance') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <p>Attendance </p>
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.learning-student-all') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <p>All Students</p>
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.learning-student-profile') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <p>Student Profile <span class="badge badge-light badge-sm text-bg-danger mx-1">New</span></p>
                          </div>
                          <div class="col-auto">
                            <i class="bi bi-box-arrow-up-right"></i>
                          </div>
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.learning-add-student') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <p>Add Student</p>
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.learning-courses-in-school') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <p>School Courses</p>
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.learning-courses-part-time') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <p>Part-Time Courses</p>
                          </div>
                          <div class="col-auto">
                            <i class="bi bi-box-arrow-up-right"></i>
                          </div>
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.learning-courses-e-courses') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <p>E-Courses</p>
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.learning-course-details') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <p>Course Details <span class="badge badge-light badge-sm text-bg-danger mx-1">New</span></p>
                          </div>
                          <div class="col-auto">
                            <i class="bi bi-box-arrow-up-right"></i>
                          </div>
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.learning-calendar') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <p>Calendar</p>
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.learning-fees') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <p>Fees</p>
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.learning-teachers') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <p>Teachers</p>
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.learning-teacher-profile') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <p>Teacher Profile</p>
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.learning-teacher-add') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <p>Add Teacher</p>
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.learning-aboutus') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <p>About School</p>
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.learning-myprofile') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <p>My Profile <span class="badge badge-light badge-sm text-bg-danger mx-1">New</span></p>
                          </div>
                          <div class="col-auto">
                            <i class="bi bi-box-arrow-up-right"></i>
                          </div>
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.learning-mysubscription') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <p>My Subscription</p>
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.learning-subscriptions') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <p>Subscription</p>
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.learning-referral') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <p>Referral</p>
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.learning-add-blog') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <p>Add Blog</p>
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.learning-add-invoice') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <p>Add Invoice</p>
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.learning-help-center') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <p>Help Center</p>
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.learning-ticket-list') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <p>Ticket List</p>
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.learning-add-ticket') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <p>Add Ticket</p>
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.learning-billing') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <p>Billing</p>
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.learning-earning') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <p>Earning</p>
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.learning-blog-details') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <p>Blog Details</p>
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.learning-blogs') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <p>Blogs</p>
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.learning-change-password') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <p>Change Password</p>
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.learning-chat-call') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <p>Chat and Call</p>
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.learning-contactus') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <p>Contact us</p>
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.learning-inbox') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <p>Inbox</p>
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.learning-login') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <p>Login</p>
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.learning-onboarding') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <p>Onboarding</p>
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.learning-personalization') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <p>Personalize</p>
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.learning-profile-kyc-start') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <p>Profile KYC Start</p>
                          </div>
                          <div class="col-auto">
                            <i class="bi bi-box-arrow-up-right"></i>
                          </div>
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.learning-profile-kyc') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <p>Profile KYC </p>
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.learning-profile-kyc-2') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <p>Profile KYC 2</p>
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.learning-forgot-password') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <p>Forgot Password</p>
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.learning-settings-courses') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <p>Settings courses</p>
                          </div>
                          <div class="col-auto">
                            <i class="bi bi-box-arrow-up-right"></i>
                          </div>
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.learning-settings-payment') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.learning-settings-timing') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <p>Settings Timing</p>
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.learning-settings') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <p>Settings School <span class="badge badge-light badge-sm text-bg-danger mx-1">New</span></p>
                          </div>
                          <div class="col-auto">
                            <i class="bi bi-box-arrow-up-right"></i>
                          </div>
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.learning-signup') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <p>Sign up</p>
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.learning-signup-success') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <p>Signup success</p>
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.page-not-found') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.page-not-found-2') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.page-not-found-3') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.under-construction') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.coming-soon') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <p>Coming Soon</p>
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.learning-privacy-policy') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <p>Privacy Policy</p>
                  ...
                  <div class="col-12 col-md-6 col-lg-4 mb-3">
                    <a href="{{ route('preview.learning-terms-of-use') }}" target="_blank" class="card adminuiux-card shadow-sm style-none">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <p>Terms of use</p>
