                ...
                <div class="row align-items-center">
                    <div class="col-12 col-md">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-3 mb-md-0">
                                ...
                                <li class="breadcrumb-item active bi" aria-current="page">Teachers</li>
                            </ol>
                        </nav>
                    </div>
                    ...
                    <div class="col-6 col-md-auto">
                        <a href="{{ route('preview.learning-teacher-add') }}" class="btn btn-theme">
                            <i data-feather="plus"></i> Add Teacher </a>
                    </div>
                </div>
            </div>
            <!-- content -->
            <div class="container mt-4" id="main-content">
                <div class="row">
                    ...
                    <div class="col-6 col-md-6 col-lg-3 mb-4">
                        <div class="card adminuiux-card shadow-sm position-relative">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        <div class="avatar avatar-50 rounded bg-theme-1-subtle text-theme-1 theme-teal h3 mb-3 mb-sm-0">
                    ...
                    <div class="col-6 col-md-6 col-lg-3 mb-4">
                        <div class="card adminuiux-card shadow-sm position-relative">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        <div class="avatar avatar-50 rounded bg-theme-1-subtle text-theme-1 theme-red h3 mb-3 mb-sm-0">
                    ...
                    <div class="col-6 col-md-6 col-lg-3 mb-4">
                        <div class="card adminuiux-card shadow-sm position-relative">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        <div class="avatar avatar-50 rounded bg-theme-1-subtle text-theme-1 theme-orange h3 mb-3 mb-sm-0">
                    ...
                    <div class="col-6 col-md-6 col-lg-3 mb-4">
                        <div class="card adminuiux-card shadow-sm position-relative">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        <div class="avatar avatar-50 rounded bg-theme-1-subtle text-theme-1 theme-blue h3 mb-3 mb-sm-0">
                ...
                <div class="row">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-12 col-xl mb-3">
                                        ...
                                        <p class="text-secondary small">
                                            <span class="text-success">2% <i class="bi bi-caret-up-fill"></i></span> vs yesterday
                                        </p>
                                    </div>
                                </div>
                                <h6>Top Teacher</h6>
                                <div class="avatar-group mb-3">
                                    <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/user-2.jpg') }}" class="avatar avatar-40 rounded-circle" alt="" data-bs-toggle="tooltip" title="Chia, 98.50%">
                                    <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/user-5.jpg') }}" class="avatar avatar-40 rounded-circle" alt="" data-bs-toggle="tooltip" title="Alex, 94.00%">
                                    <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/user-8.jpg') }}" class="avatar avatar-40 rounded-circle" alt="" data-bs-toggle="tooltip" title="Shivnan, 91.60%">
                                </div>
                            </div>
                            <div class="height-150" style="margin: -5px;">
                                <canvas id="areachartblue1"></canvas>
                            </div>
                        </div>
                    </div>
                    <!-- Salary Summary -->
                    <div class="col-12 col-lg-6 order-3 order-lg-2 mb-4">
                                ...
                                <div class="col-12 col-lg-5">
                                    ...
                                    <div class="card-body pb-0">
                                        <div class="card adminuiux-card bg-theme-1 mb-3">
                                            <div class="card-body">
                                                <p class="text-white mb-1 small">Salary Paid</p>
                                        ...
                                        <div class="card adminuiux-card bg-theme-1-subtle mb-3">
                                            <div class="card-body">
                                                <p class="text-secondary mb-1 small">Expense Made</p>
                    ...
                    <div class="col-12 col-md-6 col-lg-3 order-2 order-lg-3 mb-4">
                        <div class="card adminuiux-card shadow-sm">
                            ...
                            <div class="card-body">
                                <div class="height-160 text-center position-relative mb-4">
                                ...
                                <div class="row gx-3">
                                    <div class="col-6 mb-2">
                                        <div class="align-items-center">
                                            <div><span class="me-1 badge text-bg-success mb-1">45%</span> <span class="fw-medium">12</span></div>
                                            <div>
                                                <p class="small text-secondary">9:30am-10:30am</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-6 mb-2">
                                        <div class="align-items-center">
                                            <div><span class="me-1 badge text-bg-warning mb-1">30%</span> <span class="fw-medium">8</span></div>
                                            <div>
                                                <p class="small text-secondary">10:31am-11:30am</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-6 mb-1">
                                        <div class="align-items-center">
                                            <div><span class="me-1 badge text-bg-primary mb-1">25%</span> <span class="fw-medium">5</span></div>
                                            <div>
                                                <p class="small text-secondary">11:31am-12:30pm</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="align-items-center">
                                            <div><span class="me-1 badge text-bg-secondary mb-1">10%</span> <span class="fw-medium">2</span></div>
                                            <div>
                                                <p class="small text-secondary">12:31pm-1:30pm</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-3 mb-4">
                        <div class="card adminuiux-card shadow-sm">
                            <div class="card-header z-index-1">
                                <div class="row align-items-center">
                                    <div class="col mb-3 mb-lg-0">
                                        <a href="{{ route('preview.learning-teacher-profile') }}" class="style-none">
                                            <h5 class="mb-2">Kitty Smith</h5>
                                        </a>
                                        <h6 class="text-secondary">Class 8<sup>th</sup> - 10<sup>th</sup></h6>
                                    </div>
                                    <div class="col-auto">
                                        <div class="dropdown d-inline-block">
                            ...
                            <div class="card-body py-0 position-relative">
                                <div class="height-260 w-100 rounded coverimg position-relative">
                                    <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/user-1.jpg') }}" alt="">
                                    <div class="position-absolute top-0 end-0 p-2">
                                        <div class="badge badge-light bg-theme-1 text-white theme-green"><i class="bi bi-check-all me-1"></i>Present</div>
                                    </div>
                                </div>
                            </div>
                            <div class="card-footer z-index-1">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <p><span class="text-secondary me-1"><i class="bi bi-journal-bookmark"></i></span> Mathematics </p>
                                    </div>
                                    <div class="col-auto">
                                        <a href="{{ route('preview.learning-teacher-profile') }}" class="btn btn-link btn-square rounded-circle">
                        ...
                        <div class="card adminuiux-card shadow-sm">
                            <div class="card-header z-index-1">
                                <div class="row align-items-center">
                                    <div class="col mb-3 mb-lg-0">
                                        <a href="{{ route('preview.learning-teacher-profile') }}" class="style-none">
                                            <h5 class="mb-2">Kim San <i class="bi bi-star-fill small text-theme-1 theme-yellow"></i></h5>
                                        </a>
                                        <h6 class="text-secondary">Class 8<sup>th</sup> - 10<sup>th</sup></h6>
                                    </div>
                                    <div class="col-auto">
                            ...
                            <div class="card-footer z-index-1">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <p><span class="text-secondary me-1"><i class="bi bi-journal-bookmark"></i></span> Social Study</p>
                                    </div>
                                    <div class="col-auto">
                                        <a href="{{ route('preview.learning-teacher-profile') }}" class="btn btn-link btn-square rounded-circle">
                                            <i class="bi bi-arrow-right"></i>
                        ...
                        <div class="card adminuiux-card shadow-sm">
                            <div class="card-header z-index-1">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto">
                                        <div class="badge badge-light bg-theme-1-subtle text-theme-1 theme-red"><i class="bi bi-check-all me-1"></i>Absent</div>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body py-0 z-index-1 position-relative overflow-hidden">
                                <div class="height-260 w-100 rounded coverimg">
                                    <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/user-4.jpg') }}" alt="">
                                </div>
                            </div>
                            <div class="card-footer z-index-1">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <p><span class="text-secondary me-1"><i class="bi bi-journal-bookmark"></i></span> Science</p>
                                    </div>
                                    <div class="col-auto">
                                        <a href="{{ route('preview.learning-teacher-profile') }}" class="btn btn-link btn-square rounded-circle">
                                            <i class="bi bi-arrow-right"></i>
                        ...
                        <div class="card adminuiux-card shadow-sm">
                            <div class="card-header z-index-1">
                                <div class="row align-items-center">
                                    <div class="col mb-3 mb-lg-0">
                                        <a href="{{ route('preview.learning-teacher-profile') }}" class="style-none">
                                            <h5 class="mb-2">Kiara Alex</h5>
                                        </a>
                                        <h6 class="text-secondary">Class 8<sup>th</sup> -9<sup>th</sup></h6>
                                    </div>
                                    <div class="col-auto">
                                        <div class="badge badge-light bg-theme-1-subtle text-theme-1 theme-green"><i class="bi bi-check-all me-1"></i>Present</div>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body py-0 z-index-1 position-relative overflow-hidden">
                            ...
                            <div class="card-footer z-index-1">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <p><span class="text-secondary me-1"><i class="bi bi-journal-bookmark"></i></span> Sports</p>
                                    </div>
                                    <div class="col-auto">
                                        <a href="{{ route('preview.learning-teacher-profile') }}" class="btn btn-link btn-square rounded-circle">
                                            <i class="bi bi-arrow-right"></i>
                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col order-1 mb-2 mb-md-0">
                                <h6 class="text-truncated">Teachers Attendance Statistics</h6>
                            </div>
                    ...
                    <div class="card-body pt-0">
                        <table class="table mb-0" data-show-toggle="true" id="dataTable">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <a href="{{ route('preview.learning-teacher-profile') }}" class="row gx-3 style-none align-items-center">
                                            <div class="col-auto">
                                            ...
                                            <div class="col">
                                                ...
                                                <p class="text-secondary small">35 years</p>
                                            </div>
                                        </a>
                                    </td>
                                    <td>
                                        <p class="mb-0">8<sup>th</sup>-10<sup>th</sup> Standard</p>
                                        <p class="small text-secondary">Permanent</p>
                                    </td>
                                    <td>
                                        <p class="mb-0">Science</p>
                                        <p class="small text-secondary">All</p>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <a href="{{ route('preview.learning-teacher-profile') }}" class="row gx-3 style-none align-items-center">
                                            ...
                                            <div class="col">
                                                <h6 class="mb-0">Max Ally <i class="bi bi-star-fill text-theme-1 theme-yellow"></i></h6>
                                                <p class="text-secondary small">35 years</p>
                                            </div>
                                        </a>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <p class="small text-secondary">8<sup>th</sup>, 9<sup>th</sup></p>
                                    </td>
                                    <td>
                                        <p class="mb-0">25 Days</p>
                                        <p class="small text-secondary">1 day absent</p>
                                ...
                                <tr>
                                    <td>
                                        <a href="{{ route('preview.learning-teacher-profile') }}" class="row gx-3 style-none align-items-center">
                                            ...
                                            <div class="col">
                                                <h6 class="mb-0">Kiara Alex <i class="bi bi-star-fill text-theme-1 theme-yellow"></i></h6>
                                                <p class="text-secondary small">35 years</p>
                                            </div>
                                        </a>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <a href="{{ route('preview.learning-teacher-profile') }}" class="row gx-3 style-none align-items-center">
                                            ...
                                            <div class="col">
                                                <h6 class="mb-0">Kim San <i class="bi bi-star-fill text-theme-1 theme-yellow"></i></h6>
                                                <p class="text-secondary small">35 years</p>
                                            </div>
                                        </a>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <a href="{{ route('preview.learning-teacher-profile') }}" class="row gx-3 style-none align-items-center">
                                            <div class="col-auto">
                                                <div class="avatar avatar-40 coverimg rounded">
                                                    <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/user-8.jpg') }}" alt="">
                                                </div>
                                            </div>
                                            <div class="col">
                ...
                <div class="swiper swipernavpagination mb-3">
                    <div class="swiper-wrapper mb-3">
                        <div class="swiper-slide width-250 mb-4">
                            <div class="card adminuiux-card shadow-sm">
                                <div class="card-header z-index-1">
                                    <div class="row align-items-center">
                                        <div class="col mb-3 mb-lg-0">
                                            <h6 class="mb-2">Kim San <i class="bi bi-star-fill small text-theme-1 theme-yellow"></i></h6>
                                            <p class="text-secondary">Class 8<sup>th</sup> - 10<sup>th</sup></p>
                                        </div>
                                        <div class="col-auto">
                                            <div class="dropdown d-inline-block">
                                                <a class="btn btn-sm btn-link btn-square no-caret" data-bs-toggle="dropdown"><i class="bi bi-three-dots"></i></a>
                                ...
                                <div class="card-body py-0">
                                    <div class="height-200 w-100 rounded coverimg position-relative">
                                        <div class="position-absolute bottom-0 end-0 p-2">
                                            <div class="badge badge-light bg-theme-1 text-white theme-green"><i class="bi bi-check-all me-1"></i>Present</div>
                                        </div>
                                        <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/user-2.jpg') }}" alt="">
                        ...
                        <div class="swiper-slide width-250 mb-4">
                            <div class="card adminuiux-card shadow-sm">
                                <div class="card-header z-index-1">
                                    <div class="row align-items-center">
                                        <div class="col mb-3 mb-lg-0">
                                            <h6 class="mb-2">Kiara Alex</h6>
                                            <p class="text-secondary">Class 8<sup>th</sup> -9<sup>th</sup></p>
                                        </div>
                                        <div class="col-auto">
                                            <div class="dropdown d-inline-block">
                                                <a class="btn btn-sm btn-link btn-square no-caret" data-bs-toggle="dropdown"><i class="bi bi-three-dots"></i></a>
