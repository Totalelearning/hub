...
<header class="adminuiux-header">
        ...
        <main class="adminuiux-content" onclick="contentClick()">
                        ...
                        <div class="col col-sm mb-2 mb-sm-0">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item active bi" aria-current="page">Dropzone</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="col-auto ">
            ...
            <div class="container mt-4">
                <div class="card adminuiux-card shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <a href="https://www.dropzone.dev/" target="_blank" class="btn btn-link">learn more about dropzone js</a>
                    </div>
            ...
            &lt;/script&gt;
                ...
                <div class="bg-theme-1-subtle rounded px-3 py-2 mb-4">
                    <div class="row">
                        <div class="col">
                            <a href="{{ route('preview.component-full-calendar') }}" class="btn btn-accent me-3 my-2"><i class="bi bi-arrow-left mr-2"></i> Full Calendar</a>
                        </div>
                        <div class="col-auto">
                            <a href="{{ route('preview.component-progressbar-js') }}" class="btn btn-theme my-2">Progressbar Js <i class="bi bi-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <footer class="adminuiux-footer mt-auto">
        <div class="container-fluid text-center">
            <span class="small">Copyright @2024, Creatively designed by <a href="https://adminuiux.com" target="_blank">InvestmentUX - Adminuiux</a> on Earth ❤️ </span>
        </div>
    </footer>
