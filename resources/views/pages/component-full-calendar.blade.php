    ...
    <nav class="navbar navbar-expand-lg fixed-top">
        ...
        <main class="adminuiux-content" onclick="contentClick()">
                        ...
                        <div class="col col-sm mb-2 mb-sm-0">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item active bi" aria-current="page">Full Calendar</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="col-auto ">
            ...
            $(document).ready(function () {
                ...
                var calendar = new FullCalendar.Calendar(calendarEl, {
                    ...
                    events: [
                        ...
                        {
                            title: '&lt;p class="mb-0 small fw-medium"&gt;16:00 am&lt;/p&gt;&lt;div class="row gx-2"&gt;&lt;div  class="col-auto"&gt;&lt;img src="{{ asset('vendor/learninguiux/img/modern-ai-image/user-6.jpg') }}" class="avatar avatar-20 rounded-circle" alt=""&gt; &lt;/div&gt; &lt;div class="col"&gt;Will Johnson&lt;/div&gt;&lt;/div&gt;&lt;p class="mb-0 opacity-75 small text-truncated" &gt;High fever and cough&lt;/p&gt;',
                            className: 'bg-info-subtle',
                            start: thisyear + '-' + thismonth + '-10T20:00:00'
                        },
                        {
                            title: '&lt;span class="position-absolute top-0 end-0 badge bg-danger p-1 m-1"&gt;&lt;small&gt;Unpaid&lt;/small&gt;&lt;/span &gt;&lt;p class="mb-0 small fw-medium"&gt;7:00 am&lt;/p&gt;&lt;div class="row gx-2"&gt;&lt;div  class="col-auto"&gt;&lt;img src="{{ asset('vendor/learninguiux/img/modern-ai-image/user-7.jpg') }}" class="avatar avatar-20 rounded-circle" alt=""&gt; &lt;/div&gt; &lt;div class="col"&gt;Rickie Birthday&lt;/div&gt;&lt;/div&gt;&lt;p class="mb-0 opacity-75 small text-truncated" &gt;Birthday Celebration&lt;/p&gt;',
                            className: 'bg-theme-1-space text-white',
            ...
            &lt;/script&gt;</code></pre>
                    ...
                    <div class="card-body">
                        <p class="text-secondary">The Most Popular JavaScript Calendar. powerfull With over 300 settings, and more being added every release, FullCalendar can do just about anything. Reduce your project's bundle size by using FullCalendar's modular plugins.</p>
                        <a href="https://fullcalendar.io/" target="_blank" class="btn btn-link mb-4">Learn more about FullCalendar</a>
                        <div id="calendar"></div>
                    </div>
                </div>
                <!-- component footer -->
                <div class="bg-theme-1-subtle rounded px-3 py-2 mb-4">
                    <div class="row">
                        <div class="col">
                            <a href="{{ route('preview.component-dragula') }}" class="btn btn-accent me-3 my-2"><i class="bi bi-arrow-left mr-2"></i> Dragula</a>
                        </div>
                        <div class="col-auto">
                            <a href="{{ route('preview.component-dropzone') }}" class="btn btn-theme my-2">DropZone <i class="bi bi-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                </div>
            </div>
...
@push('scripts')
<script src="{{ asset('vendor/learninguiux/js/component/component-fullcalendar.js') }}"></script>
@endpush
