            ...
            <div class="container mt-4" id="main-content">
                <div class="row ">
                    <div class="col-12 col-md-6 col-lg-3 order-1 mb-4">
                        ...
                        <p class="text-secondary mb-1"><i class="bi bi-mortarboard me-2 align-middle"></i> 11<sup>th</sup> Standard</p>
                        <p class="text-secondary mb-1"><i class="bi bi-cake me-2 align-middle"></i> <span class="align-middle">15/09/2000</span></p>
                        <p class="text-secondary"><i class="bi bi-geo-alt me-2 align-middle"></i> <span class="align-middle">13th Street. 47 W 13th St, New York, NY 10011, USA.</span></p>
                    </div>
                    <div class="col-12 col-md-12 col-lg-6 order-3 order-lg-2 mb-4">
                        <div class="row">
                            ...
                            <div class="col-auto">
                                <select class="form-select bg-theme-1-subtle border-0">
                                    <option>2022</option>
                                    <option>2023</option>
                                    <option>2024</option>
                                    <option>2025</option>
                    ...
                    <div class="col-12 col-md-6 col-lg-3 order-2 order-lg-3 mb-4">
                        ...
                        <p class="small text-secondary">in 10<sup>th</sup> Standard</p>
                        <br>
                        <h6 class="mb-0">Parent Contacts</h6>
                        <p class="small mb-3"><span class="text-secondary">You can connect with student parent</span></p>
                        <div class="row mb-3">
                            <div class="col-auto">
                                <div class="avatar avatar-40 coverimg rounded d-block align-top">
                                    <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/user-5.jpg') }}" alt="">
                                </div>
                            </div>
                            <div class="col">
                                <p class="mb-0">Alice Johnson </p>
                                <p class="small text-secondary">Mother</small></p>
                            </div>
                            <div class="col-auto">
                                <a href="tel:+44859@5555525" class="btn btn-sm btn-square btn-link"><i class="bi bi-telephone"></i></a>
                                <a href="{{ route('preview.learning-chat-call') }}" class="btn btn-sm btn-square btn-link"><i class="bi bi-chat-dots"></i></a>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-auto">
                            ...
                            <div class="col">
                                ...
                                <p class="small text-secondary">Father</small></p>
                            </div>
                            <div class="col-auto">
                                <a href="tel:+44859@5555525" class="btn btn-sm btn-square btn-link"><i class="bi bi-telephone"></i></a>
                                <a href="{{ route('preview.learning-chat-call') }}" class="btn btn-sm btn-square btn-link"><i class="bi bi-chat-dots"></i></a>
                        ...
                        <div class="card adminuiux-card shadow-sm mb-4">
                            <div class="card-body">
                                ...
                                <div class="row gx-3 align-items-center">
                                    ...
                                    <div class="col-auto">
                                        <button class="btn btn-link btn-sm btn-square"><i class="bi bi-play"></i></button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card adminuiux-card bg-theme-1 shadow-sm">
                            <div class="card-body">
                                ...
                                <div class="row gx-3 align-items-center">
                                    ...
                                    <div class="col-auto">
                                        <div class="dropdown d-inline-block">
                                            <a class="btn btn-sm btn-link text-white btn-square no-caret" data-bs-toggle="dropdown"><i class="bi bi-three-dots"></i></a>
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li><a class="dropdown-item" href="javascript:void(0)">Add Result</a></li>
                        ...
                        <table class="table mb-0" data-show-toggle="true" id="dataTable">
                            ...
                            <tbody>
                                <tr class="theme-orange">
                                    ...
                                    <td>
                                        <div class="badge badge-light bg-theme-1-subtle text-theme-1 theme-orange">Upcoming</div>
                                    </td>
                                    <td>
                                        <div class="dropdown d-inline-block">
                                ...
                                <tr class="theme-red">
                                    ...
                                    <td>
                                        <div class="badge badge-light bg-theme-1-subtle text-theme-1 theme-red">Failed</div>
                                    </td>
                                    <td>
                                        <div class="dropdown d-inline-block">
                                            <a class="btn btn-sm btn-link btn-square no-caret" data-bs-toggle="dropdown"><i class="bi bi-three-dots"></i></a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="badge badge-light bg-theme-1-subtle text-theme-1 theme-green">Pass</div>
                                    </td>
                                    <td>
                                        <div class="dropdown d-inline-block">
                                            <a class="btn btn-sm btn-link btn-square no-caret" data-bs-toggle="dropdown"><i class="bi bi-three-dots"></i></a>
...
@push('scripts')
<script src="{{ asset('vendor/learninguiux/js/learning/learning-student-progress.js') }}"></script>
@endpush
