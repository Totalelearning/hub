                        ...
                        <div class="col col-sm mb-2 mb-sm-0">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item active bi" aria-current="page">Inputs</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="col-auto ">
            ...
            &lt;input class="form-control form-control-sm" type="text" placeholder=".form-control-sm" aria-label=".form-control-sm example"&gt;
                ...
                <div class="card adminuiux-card shadow-sm mb-4">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <p class="h6">Disabled and Readonly </p>
                            </div>
                            <div class="col-auto">
            ...
            &lt;input class="form-control" type="text" value="Disabled readonly input" aria-label="Disabled input example" disabled readonly&gt;
                ...
                <div class="card adminuiux-card shadow-sm mb-4">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <p class="h6">Password Strength </p>
                            </div>
                            <div class="col-auto">
            ...
            &lt;script&gt;
             ...
             &lt;/script&gt;
                ...
                <div class="bg-theme-1-subtle rounded px-3 py-2 mb-4">
                    <div class="row">
                        <div class="col">
                            <a href="{{ route('preview.component-sliders') }}" class="btn btn-accent me-3 my-2"><i class="bi bi-arrow-left mr-2"></i> Sliders</a>
                        </div>
                        <div class="col-auto">
                            <a href="{{ route('preview.component-selects') }}" class="btn btn-theme my-2">Selects <i class="bi bi-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                </div>
            </div>
...
@push('scripts')
<script src="{{ asset('vendor/learninguiux/js/component/component-inputs.js') }}"></script>
@endpush
