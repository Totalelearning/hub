        ...
        <main class="adminuiux-content" onclick="contentClick()">
                        ...
                        <div class="col col-sm mb-2 mb-sm-0">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item active bi" aria-current="page">Dragula</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="col-auto ">
                ...
                <div class="card adminuiux-card shadow-sm mb-4">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <p class="h6">Drag and Drop cards with dragula js example</p>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <p class="text-secondary">Move booking x card-stuff between these two/three containers. Note how the stuff gets inserted near the mouse pointer? Great stuff.</p>
                        <div class="row mt-4">
                            <!-- upcoming schedules -->
                            <div class="col-12 col-md-6 col-xl-4">
                                ...
                                <div id="upcomingschedules" class="dragzonecard miheight-150">
                                    <!-- booking cards -->
                                    <div class="card mb-3">
                                        <div class="card-body"> Booking 1 </div>
                                    </div>
                                    <div class="card mb-3">
                                        <div class="card-body"> Booking 2 </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-6 col-xl-4">
                                ...
                                <div id="ongoingschedules" class="dragzonecard miheight-150">
                                    <!-- booking cards -->
                                    <div class="card mb-3">
                                        <div class="card-body"> Booking 3 </div>
                                    </div>
                                    <!-- Meeting cards -->
                                    <div class="card bg-orange-subtle mb-3">
                                        <div class="card-body"> Booking 4 </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-6 col-xl-4">
                                ...
                                <div id="completedchedules" class="dragzonecard miheight-150">
                                    ...
                                    <div class="card bg-success-subtle mb-3">
                                        <div class="card-body"> Booking 5 </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <a href="https://bevacqua.github.io/dragula/" target="_blank" class="btn btn-link">Learn more here</a>
                    </div>
            ...
            &lt;/script&gt;
                ...
                <div class="bg-theme-1-subtle rounded px-3 py-2 mb-4">
                    <div class="row">
                        <div class="col">
                            <a href="{{ route('preview.component-daterangepicker') }}" class="btn btn-accent me-3 my-2"><i class="bi bi-arrow-left mr-2"></i> Date Range Picker</a>
                        </div>
                        <div class="col-auto">
                            <a href="{{ route('preview.component-full-calendar') }}" class="btn btn-theme my-2">FullCalendar <i class="bi bi-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                </div>
            </div>
...
@push('scripts')
<script src="{{ asset('vendor/learninguiux/js/component/component-dragula.js') }}"></script>
@endpush
