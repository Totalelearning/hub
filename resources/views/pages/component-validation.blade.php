        ...
        <main class="adminuiux-content" onclick="contentClick()">
                        ...
                        <div class="col col-sm mb-2 mb-sm-0">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item active bi" aria-current="page">Validations</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="col-auto ">
            ...
            &lt;/form&gt;
                ...
                <div class="card adminuiux-card shadow-sm mb-4">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <p class="h6">Server side field specific classes</p>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <p class="text-secondary">After receiving server side validation responsive you have to switch <code>is-valid</code> or <code>is-invalid</code> classes on fields.</p>
                        <form class="row g-3">
                            <div class="col-12 col-md-4">
            ...
            &lt;/form&gt;
                ...
                <div class="card adminuiux-card shadow-sm mb-4">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <p class="h6">Tooltip Validation message</p>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <form class="row g-3 needs-validation was-validated" novalidate>
                            <div class="col-md-4 position-relative">
                                ...
                                <div class="invalid-tooltip"> Please provide a valid First name. </div>
                            </div>
                            <div class="col-md-4 position-relative">
                                <label for="validationTooltip02" class="form-label">Last name</label>
                                <input type="text" class="form-control" id="validationTooltip02" value="Otto" required>
                                <div class="valid-tooltip"> Looks good! </div>
                                <div class="invalid-tooltip"> Please provide a valid Last name. </div>
                            </div>
                            <div class="col-md-4 position-relative">
            ...
            &lt;/form&gt;
                ...
                <div class="bg-theme-1-subtle rounded px-3 py-2 mb-4">
                    <div class="row">
                        <div class="col">
                            <a href="{{ route('preview.component-floating-label') }}" class="btn btn-accent me-3 my-2"><i class="bi bi-arrow-left mr-2"></i> Floating Labels</a>
                        </div>
                        <div class="col-auto">
                            <a href="{{ route('preview.component-bootstrap-icons') }}" class="btn btn-theme my-2">Bootstrap Icons <i class="bi bi-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                </div>
            </div>
