        ...
        <main class="adminuiux-content" onclick="contentClick()">
                        ...
                        <div class="col col-sm mb-2 mb-sm-0">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item active bi" aria-current="page">Modal Dialogues</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="col-auto ">
            ...
            <div class="container mt-4">
                <div class="card adminuiux-card shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        <button type="button" class="btn btn-theme" data-bs-toggle="modal" data-bs-target="#standardmodal"> Standard modal </button>
                    </div>
            ...
            &lt;/div&gt;
                ...
                <div class="card adminuiux-card shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        <button type="button" class="btn btn-theme" data-bs-toggle="modal" data-bs-target="#scrollingmodal"> Scrolling modal </button>
                    </div>
            ...
            &lt;/div&gt;
                ...
                <div class="card adminuiux-card shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        <button type="button" class="btn btn-theme" data-bs-toggle="modal" data-bs-target="#verticalmiddlemodal"> Vertical middle modal </button>
                    </div>
            ...
            &lt;/div&gt;
                ...
                <div class="card adminuiux-card shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        <button type="button" class="btn btn-theme me-2" data-bs-toggle="modal" data-bs-target="#xlmodal"> Extra Large modal </button>
                        <button type="button" class="btn btn-theme me-2" data-bs-toggle="modal" data-bs-target="#lgmodal"> Large modal </button>
                        <button type="button" class="btn btn-theme me-2" data-bs-toggle="modal" data-bs-target="#smmodal"> small modal </button>
                    </div>
            ...
            &lt;/div&gt;
                ...
                <div class="card adminuiux-card shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <br>
                        <button type="button" class="btn btn-theme me-2" data-bs-toggle="modal" data-bs-target="#fullscreenmodal"> Fullscreen modal </button>
                    </div>
            ...
            &lt;/div&gt;
                ...
                <div class="bg-theme-1-subtle rounded px-3 py-2 mb-4">
                    <div class="row">
                        <div class="col">
                            <a href="{{ route('preview.component-list-groups') }}" class="btn btn-accent me-3 my-2"><i class="bi bi-arrow-left mr-2"></i> List Groups</a>
                        </div>
                        <div class="col-auto">
                            <a href="{{ route('preview.component-off-canvas') }}" class="btn btn-theme my-2">Off Canvas <i class="bi bi-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                </div>
            </div>
