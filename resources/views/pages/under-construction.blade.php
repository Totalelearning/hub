    ...
    <div class="adminuiux-sidebar-inner">
      ...
      <main class="adminuiux-content has-sidebar" onclick="contentClick()">
        ...
        <div class="container-fluid mt-2" id="main-content">
          <div class="card adminuiux-card height-dynamic position-relative overflow-hidden bg-none" style="--h-dynamic: calc(100vh - 160px)">
            <div class="card-body z-index-1">
              <div class="row align-items-center justify-content-center text-center h-100 ">
                <div class="col-auto">
                  <p class="h1 fw-bold text-theme-1 theme-orange" style="font-size: 160px;"><i class="bi bi-cone-striped mx-2"></i></p>
                  ...
                  <div class="input-group theme-orange mb-4">
                    <input type="text" class="form-control border-theme-1" placeholder="Your email address" />
