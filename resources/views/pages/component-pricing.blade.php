    ...
    <main class="adminuiux-content" onclick="contentClick()">
            ...
            <div class="col col-sm mb-2 mb-sm-0">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                  ...
                  <li class="breadcrumb-item active bi" aria-current="page">Progress</li>
                </ol>
              </nav>
            </div>
            <div class="col-auto ">
      ...
      <div class="container mt-4">
        <div class="card adminuiux-card shadow-sm mb-4">
          <div class="card-header">
            <div class="row align-items-center">
              <div class="col">
                <p class="h6">Individual Pricing</p>
              </div>
              <div class="col-auto">
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-12 col-md-6 col-lg-4">
                <div class="card adminuiux-card mb-4 bg-theme-1">
                  <div class="card-body px-xl-4">
                    <div class="text-center mb-4">
                    ...
                    <div class="row mb-4">
                      <div class="col-auto">
                        <i class="avatar avatar-60 rounded bg-theme-1-subtle text-theme-1 h4 bi bi-building vm"></i>
                      </div>
                      <div class="col">
                    ...
                    <div class="row align-items-center mb-4">
                      ...
                      <div class="col">
                        <p class="opacity-75">per license</p>
                      </div>
                    </div>
                    <h6>Basic includes:</h6>
                    <ul class="list-group adminuiux-list-group">
        ...
        <div class="card adminuiux-card shadow-sm mb-4">
          ...
          <div class="card-body">
            <div class="card overflow-hidden text-center mb-4">
              <div class="row gx-0">
                <div class="col-12 col-lg">
                  <div class="card-body">
                    <h6>Do more pay less with annual plan</h6>
                    <h1>Best plans for your need</h1>
                    <p class="text-secondary">For customized services please contact us from <a href="{{ route('preview.learning-contactus') }}">customer service</a></p>
                    <div class="text-center">
                      <div class="form-check form-switch mx-auto w-auto d-inline-block mb-4">
                        <input class="form-check-input" type="checkbox" role="switch" id="payannual" checked="">
                        <label class="form-check-label" for="payannual">Save 10% with annual plan</label>
                      </div>
                    </div>
                        ...
                        <thead>
                          <tr>
                            <th class="text-start align-middle">
                              <p class="h6 mb-0">Whats included?</p>
                            </th>
                            <th class="text-center selected">
                              <p class="h4 mb-0">$50.00</p>
                              <p class="text-secondary fw-normal">Personal</p>
                            </th>
                            <th class="text-center">
                              <p class="h4 mb-0">$100.00</p>
                              <p class="text-secondary fw-normal">Pro</p>
                            </th>
                            <th class="text-center">
                              <p class="h4 mb-0">$150.00</p>
                              <p class="text-secondary fw-normal">Ultra Pro</p>
                            </th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr>
                            <td class="text-start align-middle text-secondary"> Unlimited domain </td>
                            <td class="selected">
                          ...
                          <tr>
                            <td class="text-start align-middle text-secondary"> Firewall setup </td>
                            <td class="selected">
                              <i class="text-success bi bi-check-circle h5"></i>
                            </td>
                            <td class="">
                          ...
                          <tr>
                            <td class="text-start align-middle text-secondary"> React support </td>
                          ...
                          <tr>
                            <td class="text-start align-middle text-secondary"> Angular Starter Kit </td>
                            <td class="selected"></td>
                            <td class=""></td>
                            <td class="">
                              <i class="text-success bi bi-check-circle h5"></i>
                          ...
                          <tr>
                            <td class="text-start align-middle text-secondary"> Laravel Starter Kit </td>
                            <td class="selected"></td>
                            <td class=""></td>
                            <td class="">
                              <i class="text-success bi bi-check-circle h5"></i>
                          ...
                          <tr>
                            ...
                            <td class="">
                              <button class="btn btn-outline-theme">Get Started</button>
                            </td>
                            <td class="">
                              <button class="btn btn-outline-theme">Get Started</button>
                            </td>
                ...
                <div class="col-12 col-lg-4 col-lg-4 mnh-250 position-relative overflow-hidden">
                  <div class="coverimg h-100 w-100 position-absolute start-0 top-0" style="background-image: url(&quot;{{ asset('vendor/learninguiux/img/modern-ai-image/flamingo-2.jpg&quot;') }});">
                    <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/flamingo-2.jpg') }}" alt="" style="display: none;">
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="collapse" id="collapse2">
            <div class="card-footer border-top">
              <div class="bg-dark text-white p-2 rounded my-2">
                <pre class="mb-2"><code class="code rounded language-html">
            &lt;div class="card adminuiux-card overflow-hidden text-center mb-4"&gt;
              &lt;div class="row gx-0"&gt;
                &lt;div class="col-12 col-lg"&gt;
                  &lt;div class="card-body"&gt;
                    &lt;h6&gt;Do more pay less with annual plan&lt;/h6&gt;
                    ...
                    &lt;div class="table-responsive"&gt;
                      &lt;table class="table table-bordered mb-0"&gt;
                        ...
                        &lt;tbody&gt;
                          &lt;tr&gt;
                            &lt;td class="text-start align-middle text-secondary"&gt;
                              Unlimited domain
                            &lt;/td&gt;
                            &lt;td class="selected"&gt;
                              &lt;i class="text-success bi bi-check-circle h5"&gt;&lt;/i&gt;
        ...
        <div class="bg-theme-1-subtle rounded px-3 py-2 mb-4">
          <div class="row">
            <div class="col">
              <a href="{{ route('preview.component-popovers') }}" class="btn btn-accent me-3 my-2"><i class="bi bi-arrow-left mr-2"></i> Popover</a>
            </div>
            <div class="col-auto">
              <a href="{{ route('preview.component-toasts') }}" class="btn btn-theme my-2">Toasts <i class="bi bi-arrow-right ms-2"></i></a>
            </div>
          </div>
        </div>
      </div>
