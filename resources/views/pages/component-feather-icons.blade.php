        ...
        <main class="adminuiux-content" onclick="contentClick()">
                        ...
                        <div class="col col-sm mb-2 mb-sm-0">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item active bi" aria-current="page">Feather icons</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="col-auto ">
            ...
            <div class="container mt-4">
                <div class="card adminuiux-card shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        <p class="text-secondary">Feather is a collection of simply beautiful open-source icons.<br> Each icon is designed on a 24x24 grid with an emphasis on simplicity, consistency, and flexibility.</p>
                        <br>
                        <!-- example icon -->
                        <i data-feather="feather" class="me-2"></i>
                        <i data-feather="home" class="me-2"></i>
                        <i data-feather="arrow-right" class="me-2"></i>
                        <br><br>
                        <a href="https://feathericons.com/" target="_blank" class="btn btn-link">More Feather Icons</a>
                    </div>
                    <div class="collapse" id="collapse1">
                        <div class="card-footer border-top">
                            <div class="bg-dark text-white p-2 rounded my-2">
                                <pre class="mb-2"><code class="code rounded language-html">&lt;i data-feather="feather" class="me-2"&gt;&lt;/i&gt;
            &lt;i data-feather="home" class="me-2"&gt;&lt;/i&gt;
            &lt;i data-feather="arrow-right" class="me-2"&gt;&lt;/i&gt;
            &lt;script&gt;
            feather.replace();
            &lt;/script&gt;</code></pre>
                ...
                <div class="bg-theme-1-subtle rounded px-3 py-2 mb-4">
                    <div class="row">
                        <div class="col">
                            <a href="{{ route('preview.component-bootstrap-icons') }}" class="btn btn-accent me-3 my-2"><i class="bi bi-arrow-left mr-2"></i> Bootstrap Icons</a>
                        </div>
                        <div class="col-auto">
                            <a href="{{ route('preview.component-chartjs') }}" class="btn btn-theme my-2">ChartJs <i class="bi bi-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                </div>
            </div>
