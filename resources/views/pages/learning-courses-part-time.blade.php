                    ...
                    <div class="row gx-2">
                        ...
                        <main class="adminuiux-content has-sidebar" onclick="contentClick()">
                            ...
                            <div class="container mt-4">
                                <div class="row align-items-center">
                                    <div class="col-12 col-md">
                                        <h5>Part-Time Courses</h5>
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb mb-3 mb-md-0">
                                                <li class="breadcrumb-item bi"><a href="{{ route('preview.learning-dashboard') }}">Dashboard</a></li>
                                                <li class="breadcrumb-item bi"><a href="#">Courses</a></li>
                                                <li class="breadcrumb-item active bi" aria-current="page">Part-Time Courses</li>
                                            </ol>
                                        </nav>
                                    </div>
                            ...
                            <div class="container mt-4" id="main-content">
                                                ...
                                                <div class="row align-items-center">
                                                    <div class="col-12 col-sm-6 col-md">
                                                        <div class="form-floating">
                                                            ...
                                                            <label for="searchfield-1">I am a</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-sm-6 col-md">
                                                        <div class="form-floating">
                                                            <select class="form-select" id="searchfield-2">
                                                                <option disabled selected>Choose your goal</option>
                                                                <option>Job</option>
                                                                <option>Interview</option>
                                                                <option>Study</option>
                                                                <option>Skill/Learning</option>
                                                            </select>
                                                            <label for="searchfield-2">You are looking for</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-sm-6 col-md">
                                                        <div class="form-floating">
                                                            <select class="form-select" id="searchfield-3">
                                                                ...
                                                                <option>2 Hours a day</option>
                                                                <option>4 Hours a day</option>
                                                                <option>6 Hours a day</option>
                                                                <option>8 Hours a day</option>
                                                            </select>
                                                            <label for="searchfield-3">I've available</label>
                                                        </div>
                                                    </div>
                                ...
                                <p class="text-secondary">Find out which is best suited for you</p>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-6 col-lg-3 mb-4">
                                        <div class="card adminuiux-card shadow-sm">
                                            <div class="card-header">
                                                <h5 class="mb-2">Machine Learning & Artificial Intelligence</h5>
                                                <span class="badge badge-light text-bg-success me-1 mb-1">Placement</span>
                                                <span class="badge badge-light text-bg-theme-1 theme-purple me-1 mb-1">Job Ready</span>
                                            </div>
                                            <div class="card-body py-0 position-relative">
                                                <div class="height-200 w-100 rounded coverimg position-relative mb-3">
                                                    <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/pet-4.jpg') }}" alt="">
                                                </div>

                                                <div class="row align-items-center">
                                                    <div class="col-6 mb-3">
                                                        <p class=""><i class="bi bi-calendar-week text-secondary me-1"></i> 30 Weeks</p>
                                                    </div>
                                                    <div class="col-6 mb-3">
                                                        <p class=""><i class="bi bi-camera-reels text-secondary me-1"></i> 45+ Videos</p>
                                                    </div>
                                                </div>
                                                <div class="row align-items-center">
                                                    <div class="col-6 mb-3">
                                                        <p class=""><i class="bi bi-mortarboard text-secondary me-1"></i> 12 Pass</p>
                                                    </div>
                                                    <div class="col-6 mb-3">
                                                        <p class=""><i class="bi bi-clock text-secondary me-1"></i> 6 hours/day</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="card-footer">
                                                <button class="btn btn-link w-100">View Details <i class="bi bi-chevron-right"></i></button>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Course cards -->
                                    <div class="col-12 col-md-6 col-lg-3 mb-4">
                                        <div class="card adminuiux-card shadow-sm">
                                            <div class="card-header">
                                                <h5 class="mb-2">Certificate Program In Wealth Management</h5>
                                                <span class="badge badge-light text-bg-theme-1 me-1 mb-1">Job Offer</span>
                                                <span class="badge badge-light text-bg-theme-1 theme-purple me-1 mb-1">Job Ready</span>
                                            </div>
                                            <div class="card-body py-0 position-relative">
                                                <div class="height-200 w-100 rounded coverimg position-relative mb-3">
                                                ...
                                                <div class="row align-items-center">
                                                    <div class="col-6 mb-3">
                                                        <p class=""><i class="bi bi-calendar-week text-secondary me-1"></i> 40 hours</p>
                                                    </div>
                                                    <div class="col-6 mb-3">
                                                        <p class=""><i class="bi bi-camera-reels text-secondary me-1"></i> 12+ Videos</p>
                                                    </div>
                                                </div>
                                                <div class="row align-items-center">
                                                    <div class="col-6 mb-3">
                                                        <p class=""><i class="bi bi-mortarboard text-secondary me-1"></i> Graduate</p>
                                                    </div>
                                                    <div class="col-6 mb-3">
                                                        <p class=""><i class="bi bi-clock text-secondary me-1"></i> 4 hours/day</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="card-footer">
                                    ...
                                    <div class="col-12 col-md-6 col-lg-3 mb-4">
                                        <div class="card adminuiux-card shadow-sm">
                                            <div class="card-header">
                                                <h5 class="mb-2">Virtual Sales and Relationship Management Program</h5>
                                                <span class="badge badge-light text-bg-success me-1 mb-1">Placement</span>
                                            </div>
                                            <div class="card-body py-0 position-relative">
                                                <div class="height-200 w-100 rounded coverimg position-relative mb-3">
                                                ...
                                                <div class="row align-items-center">
                                                    <div class="col-6 mb-3">
                                                        <p class=""><i class="bi bi-calendar-week text-secondary me-1"></i> 40 Weeks</p>
                                                    </div>
                                                    <div class="col-6 mb-3">
                                                        <p class=""><i class="bi bi-camera-reels text-secondary me-1"></i> 50+ Videos</p>
                                                    </div>
                                                </div>
                                                <div class="row align-items-center">
                                                    <div class="col-6 mb-3">
                                                        <p class=""><i class="bi bi-mortarboard text-secondary me-1"></i> Master</p>
                                                    </div>
                                                    <div class="col-6 mb-3">
                                                        <p class=""><i class="bi bi-clock text-secondary me-1"></i> 4 hours/day</p>
                                                    </div>
                                    ...
                                    <div class="col-12 col-md-6 col-lg-3 mb-4">
                                        <div class="card adminuiux-card shadow-sm">
                                            <div class="card-header">
                                                <h5 class="mb-2">Post Graduate Program in Full Stack Engineering</h5>
                                                <span class="badge badge-light text-bg-success me-1 mb-1">Placement</span>
                                                <span class="badge badge-light text-bg-theme-1 theme-purple me-1 mb-1">Interview</span>
                                            </div>
                                            <div class="card-body py-0 position-relative">
                                                <div class="height-200 w-100 rounded coverimg position-relative mb-3">
                                                    <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/kids-2.jpg') }}" alt="">
                                                </div>

                                                <div class="row align-items-center">
                                                    <div class="col-6 mb-3">
                                                        <p class=""><i class="bi bi-calendar-week text-secondary me-1"></i> 15 hours</p>
                                                    </div>
                                                    <div class="col-6 mb-3">
                                                        <p class=""><i class="bi bi-camera-reels text-secondary me-1"></i> 45+ Videos</p>
                                                    </div>
                                                ...
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-6 mb-3">
                                                        <p class=""><i class="bi bi-clock text-secondary me-1"></i> 2 hours/day</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="card-footer">
                                    ...
                                    <div class="col-12 col-md-6 col-lg-3 mb-4">
                                        <div class="card adminuiux-card shadow-sm">
                                            <div class="card-header">
                                                <h5 class="mb-2">Full Stack Engineering Programs</h5>
                                                <span class="badge badge-light text-bg-success me-1 mb-1">Placement</span>
                                                <span class="badge badge-light text-bg-theme-1 theme-purple me-1 mb-1">Job Ready</span>
                                            </div>
                                            <div class="card-body py-0 position-relative">
                                    ...
                                    <div class="col-12 col-md-6 col-lg-3 mb-4">
                                        <div class="card adminuiux-card shadow-sm">
                                            <div class="card-header">
                                                <h5 class="mb-2">All in one FinTech Engineering Program</h5>
                                                <span class="badge badge-light text-bg-theme-1 theme-orange me-1 mb-1">Interview</span>
                                                <span class="badge badge-light text-bg-theme-1 theme-purple me-1 mb-1">Job Ready</span>
                                            </div>
                                            <div class="card-body py-0 position-relative">
                                                <div class="height-200 w-100 rounded coverimg position-relative mb-3">
                                                    <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/tree-3.jpg') }}" alt="">
                                                </div>
