        ...
        <main class="adminuiux-content" onclick="contentClick()">
                ...
                <div class="card adminuiux-card shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <span class="input-group-text" id="basic-addon2">@adminuiux.com</span>
                        </div>
                        <div class="mb-3">
            ...
            &lt;/div&gt;
                ...
                <div class="bg-theme-1-subtle rounded px-3 py-2 mb-4">
                    <div class="row">
                        <div class="col">
                            <a href="{{ route('preview.component-selects') }}" class="btn btn-accent me-3 my-2"><i class="bi bi-arrow-left mr-2"></i> Selects</a>
                        </div>
                        <div class="col-auto">
                            <a href="{{ route('preview.component-floating-label') }}" class="btn btn-theme my-2">Floating Labels <i class="bi bi-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                </div>
            </div>
