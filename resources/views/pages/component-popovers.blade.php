        ...
        <main class="adminuiux-content" onclick="contentClick()">
                        ...
                        <div class="col col-sm mb-2 mb-sm-0">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item active bi" aria-current="page">Popovers</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="col-auto ">
                ...
                <div class="card adminuiux-card shadow-sm mb-4">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <p class="h6">Standard Popovers</p>
                            </div>
                            <div class="col-auto">
            ...
            &lt;button type="button" class="btn btn-theme" data-bs-toggle="popover" data-bs-title="Popover title" data-bs-content="And here's some amazing content. It's very engaging. Right?"&gt;Click to toggle popover&lt;/button&gt;
                ...
                <div class="card adminuiux-card shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <button type="button" class="btn btn-secondary" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="bottom" data-bs-content="Bottom popover"> Popover on bottom </button>
                        <button type="button" class="btn btn-secondary" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="left" data-bs-content="Left popover"> Popover on left </button>
                    </div>
            ...
            &lt;/button&gt;
                ...
                <div class="card adminuiux-card shadow-sm mb-4">
                    ...
                    <div class="card-body pb-0">
                        <button type="button" class="btn btn-theme me-2 mb-3" data-bs-toggle="popover" data-bs-placement="top" data-bs-trigger="focus" data-bs-custom-class="adminuiux-theme-popover" data-bs-title="Custom popover" data-bs-content="This popover is themed via CSS variables."> Theme Popover </button>
                        <button type="button" class="btn btn-accent me-2 mb-3" data-bs-toggle="popover" data-bs-placement="top" data-bs-trigger="focus" data-bs-custom-class="adminuiux-accent-popover" data-bs-title="Custom popover" data-bs-content="This popover is themed via CSS variables."> Theme Accent Popover </button>
                        <button type="button" class="btn btn-primary me-2 mb-3" data-bs-toggle="popover" data-bs-placement="top" data-bs-trigger="focus" data-bs-custom-class="adminuiux-primary-popover" data-bs-title="Custom popover" data-bs-content="This popover is themed via CSS variables."> Theme Primary Popover </button>
                        <button type="button" class="btn btn-success me-2 mb-3" data-bs-toggle="popover" data-bs-placement="top" data-bs-trigger="focus" data-bs-custom-class="adminuiux-success-popover" data-bs-title="Custom popover" data-bs-content="This popover is themed via CSS variables."> Theme Success Popover </button>
                        <button type="button" class="btn btn-info me-2 mb-3" data-bs-toggle="popover" data-bs-placement="top" data-bs-trigger="focus" data-bs-custom-class="adminuiux-info-popover" data-bs-title="Custom popover" data-bs-content="This popover is themed via CSS variables."> Theme Info Popover </button>
                        <button type="button" class="btn btn-warning me-2 mb-3" data-bs-toggle="popover" data-bs-placement="top" data-bs-trigger="focus" data-bs-custom-class="adminuiux-warning-popover" data-bs-title="Custom popover" data-bs-content="This popover is themed via CSS variables."> Theme Warning Popover </button>
                        <button type="button" class="btn btn-danger me-2 mb-3" data-bs-toggle="popover" data-bs-placement="top" data-bs-trigger="focus" data-bs-custom-class="adminuiux-danger-popover" data-bs-title="Custom popover" data-bs-content="This popover is themed via CSS variables."> Theme Danger Popover </button>
                        <button type="button" class="btn btn-dark me-2 mb-3" data-bs-toggle="popover" data-bs-placement="top" data-bs-trigger="focus" data-bs-custom-class="adminuiux-dark-popover" data-bs-title="Custom popover" data-bs-content="This popover is themed via CSS variables."> Theme Dark Popover </button>
                        <button type="button" class="btn btn-theme theme-red me-2 mb-3" data-bs-toggle="popover" data-bs-placement="top" data-bs-trigger="focus" data-bs-custom-class="theme-red adminuiux-theme-popover" data-bs-title="Custom popover" data-bs-content="This popover is themed via CSS variables."> Template Theme-Red </button>
                        <button type="button" class="btn btn-theme theme-orange me-2 mb-3" data-bs-toggle="popover" data-bs-placement="top" data-bs-trigger="focus" data-bs-custom-class="theme-orange adminuiux-theme-popover" data-bs-title="Custom popover" data-bs-content="This popover is themed via CSS variables."> Template Theme-orange </button>
                        <button type="button" class="btn btn-theme theme-teal me-2 mb-3" data-bs-toggle="popover" data-bs-placement="top" data-bs-trigger="focus" data-bs-custom-class="theme-teal adminuiux-theme-popover" data-bs-title="Custom popover" data-bs-content="This popover is themed via CSS variables."> Template Theme-teal </button>
                        <button type="button" class="btn btn-theme theme-brown me-2 mb-3" data-bs-toggle="popover" data-bs-placement="top" data-bs-trigger="focus" data-bs-custom-class="theme-brown adminuiux-theme-popover" data-bs-title="Custom popover" data-bs-content="This popover is themed via CSS variables."> Template Theme-brown </button>
                        <button type="button" class="btn btn-theme theme-indigo me-2 mb-3" data-bs-toggle="popover" data-bs-placement="top" data-bs-trigger="focus" data-bs-custom-class="theme-indigo adminuiux-theme-popover" data-bs-title="Custom popover" data-bs-content="This popover is themed via CSS variables."> Template Theme-indigo </button>
                        <span>...</span>
                    </div>
            ...
            &lt;span&gt;...&lt;/span&gt;
                ...
                <div class="bg-theme-1-subtle rounded px-3 py-2 mb-4">
                    <div class="row">
                        <div class="col">
                            <a href="{{ route('preview.component-badges') }}" class="btn btn-accent me-3 my-2"><i class="bi bi-arrow-left mr-2"></i> Badges</a>
                        </div>
                        <div class="col-auto">
                            <a href="{{ route('preview.component-progress') }}" class="btn btn-theme my-2">Progress <i class="bi bi-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                </div>
            </div>
