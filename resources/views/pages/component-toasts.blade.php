        ...
        <main class="adminuiux-content" onclick="contentClick()">
                        ...
                        <div class="col col-sm mb-2 mb-sm-0">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item active bi" aria-current="page">Toasts</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="col-auto ">
                        ...
                        <div class="toast-container position-fixed bottom-0 end-0 p-3">
                            <div id="liveToast1" class="toast border-0" data-bs-delay="1500" role="alert" aria-live="assertive" aria-atomic="true">
                                <div class="toast-header">
                                    <img src="{{ asset('vendor/learninguiux/img/favicon.png') }}" class="rounded me-2" alt="...">
                                    <strong class="me-auto">Adminuiux</strong>
                                    <small>10 sec ago</small>
                                    <button type="button" class="btn-close" data-bs-dismiss="toast" aria-label="Close"></button>
                                </div>
                                <div class="toast-body"> Hello, Beautiful world! This is a toast message ❤️. </div>
                            </div>
            ...
            &lt;/div&gt;
                ...
                <div class="bg-theme-1-subtle rounded px-3 py-2 mb-4">
                    <div class="row">
                        <div class="col">
                            <a href="{{ route('preview.component-progress') }}" class="btn btn-accent me-3 my-2"><i class="bi bi-arrow-left mr-2"></i> Progress</a>
                        </div>
                        <div class="col-auto">
                            <a href="{{ route('preview.component-tooltips') }}" class="btn btn-theme my-2">Tooltips <i class="bi bi-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                </div>
            </div>
...
@push('scripts')
<script src="{{ asset('vendor/learninguiux/js/component/component-toasts.js') }}"></script>
@endpush
