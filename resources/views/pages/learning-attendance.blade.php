                    ...
                    <div class="col-12 col-md">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-3 mb-md-0">
                                ...
                                <li class="breadcrumb-item active bi" aria-current="page">Student Attendance</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="col-12 col-md-auto">
                        <button class="btn btn-theme" data-bs-toggle="modal" data-bs-target="#add-attendance-modal">
                            <i data-feather="plus"></i> Add Attendance </button>
                    </div>
                </div>
            </div>
            <!-- content -->
                    ...
                    <div class="col-12 col-md-6 col-lg-3">
                        <div class="card adminuiux-card shadow-sm mb-4">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        <div class="avatar avatar-50 rounded bg-theme-1-subtle text-theme-1 theme-orange h4">
                    ...
                    <div class="col-12 col-md-6 col-lg-3 mb-4">
                        <div class="card adminuiux-card shadow-sm">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        <div class="avatar avatar-50 rounded bg-theme-1-subtle text-theme-1 theme-blue h4">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="card adminuiux-card shadow-sm mb-4">
                            ...
                            <div class="card-body">
                                <div class="height-250 mb-4">
                                    <canvas id="summarychart"></canvas>
                                </div>
                                <div class="row align-items-center">
                                    <div class="col">
                                        <h4 class="mb-2">11.56 AM</h4>
                                        <p class="text-secondary small">Average In-Time</p>
                                    </div>
                                    <div class="col">
                                        <h4 class="mb-2">5.15 PM</h4>
                                        <p class="text-secondary small">Average Out-Time</p>
                                    </div>
                                    <div class="col">
                                        <h4 class="mb-2">0.80 Sec</h4>
                    ...
                    <div class="col-12 col-md-6 col-lg-3">
                        <div class="card adminuiux-card shadow-sm mb-4">
                            <div class="card-header">
                                <div class="row align-items-center">
                                    <div class="col mb-3 mb-lg-0">
                                        <h6>Real Time Attendance Activity</h6>
                                    </div>
                                    <div class="col-auto">
                            ...
                            <div class="card-body">
                                <div class="row align-items-center mb-4">
                                    <div class="col-6 col-md-6">
                                        <h4 class="mb-2">235</h4>
                                        <div class="progress height-dynamic mb-2" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="--h-dynamic: 5px">
                                            <div class="progress-bar progress-bar-striped progress-bar-animated bg-theme-1 theme-blue" style="width: 70%"></div>
                                        </div>
                                        <p class="text-secondary small">In-Class</p>
                                    </div>
                                    <div class="col-6 col-md-6">
                                        <h4 class="mb-2">30</h4>
                                        <div class="progress height-dynamic mb-2" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="--h-dynamic: 5px">
                                            <div class="progress-bar progress-bar-striped progress-bar-animated bg-theme-1 theme-orange" style="width: 10%"></div>
                                        </div>
                                        <p class="text-secondary small">In-Campus</p>
                                    </div>
                                </div>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="row align-items-center">
                                            <div class="col-auto">
                                                <p class="mb-0">-NA-</p>
                                                <p class="small text-secondary">Check-in</p>
                                            </div>
                                            <div class="col border-top">
                                            </div>
                                            <div class="col-auto d-none d-md-block">
                                                <p class="small text-secondary">-NA-</p>
                                            </div>
                                            <div class="col border-top d-none d-md-block">
                                            </div>
                                            <div class="col-auto">
                                                <p class="mb-0">-NA-</p>
                                                <p class="small text-secondary">Check-out</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="badge badge-light bg-theme-1-subtle text-theme-1 theme-red">Not Available</div>
                                    </td>
                                    <td>
                                        <button class="btn btn-sm btn-outline-success" data-bs-toggle="modal" data-bs-target="#add-attendance-modal">Mark Present</button>
                                        <div class="dropdown d-inline-block">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="row align-items-center">
                                            <div class="col-auto">
                                                <p class="mb-0">11:45 am</p>
                                                <p class="small text-secondary">Check-in</p>
                                            </div>
                                            <div class="col border-top">
                                            </div>
                                            <div class="col-auto d-none d-md-block">
                                                <p class="small text-secondary">5hr 25min</p>
                                            </div>
                                            <div class="col border-top d-none d-md-block">
                                            </div>
                                            <div class="col-auto">
                                                <p class="mb-0">5:10 pm</p>
                                                <p class="small text-secondary">Check-out</p>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="badge badge-light bg-theme-1-subtle text-theme-1 theme-orange">In-Campus</div>
                                    </td>
                                    <td>
                                        <button class="btn btn-sm btn-outline-danger" data-bs-toggle="modal" data-bs-target="#add-attendance-modal">Mark Absent</button>
                                        <div class="dropdown d-inline-block">
                                            <a class="btn btn-sm btn-link btn-square no-caret" data-bs-toggle="dropdown"><i class="bi bi-three-dots"></i></a>
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li><a class="dropdown-item" href="javascript:void(0)">Add Attendance</a></li>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="row align-items-center">
                                            <div class="col-auto">
                                                <p class="mb-0">11:55 am</p>
                                                <p class="small text-secondary">Check-in</p>
                                            </div>
                                            <div class="col border-top">
                                            </div>
                                            <div class="col-auto d-none d-md-block">
                                                <p class="small text-secondary">5hr 20min</p>
                                            </div>
                                            <div class="col border-top d-none d-md-block">
                                            </div>
                                            <div class="col-auto">
                                                <p class="mb-0">5:15 pm</p>
                                                <p class="small text-secondary">Check-out</p>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="badge badge-light bg-theme-1-subtle text-theme-1">In-Class</div>
                                    </td>
                                    <td>
                                        <button class="btn btn-sm btn-outline-danger" data-bs-toggle="modal" data-bs-target="#add-attendance-modal">Mark Absent</button>
                                        <div class="dropdown d-inline-block">
...
<div class="position-fixed bottom-0 end-0 m-3 z-index-5">
    ...
    <div class="modal adminuiux-modal fade" id="add-attendance-modal" tabindex="-1" aria-labelledby="add-attendance-modalmodalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <p class="modal-title h5" id="add-attendance-modalmodalLabel">Add Attendance</p>
                ...
                <div class="modal-body">
                    <div class="input-group mb-3">
                        ...
                        <div class="form-floating">
                            <input class="form-control" type="search" placeholder="Search student..." id="searchstudent">
                            <label for="searchstudent">Search Student</label>
                        </div>
                    </div>
                    <div class="form-check form-switch mb-3">
                        <input class="form-check-input" type="checkbox" role="switch" id="absent">
                        <label class="form-check-label" for="absent">Student is absent</label>
                    </div>
                    <!-- toggle hide when absent selected -->
                    <div class="row">
                ...
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-theme">Confirm</button>
...
@push('scripts')
<script src="{{ asset('vendor/learninguiux/js/learning/learning-attendance.js') }}"></script>
@endpush
