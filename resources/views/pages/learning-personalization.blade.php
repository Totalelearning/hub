                ...
                <div class="row gx-3 align-items-center">
                  ...
                  <div class="col-auto">
                    <div class="d-block text-center">
                      <span class="avatar avatar-40 rounded-circle bg-r-gradient border">
                      </span>
                    </div>
                  </div>
                  <div class="col-auto">
                    <div class="d-block text-center">
                      <span class="avatar avatar-40 rounded-circle bg-theme-r-gradient">
                      </span>
                    </div>
                  </div>
                  <div class="col-auto">
                    <div class="d-block text-center">
                      <span class="avatar avatar-40 rounded-circle bg-theme-accent-r-gradient">
                      </span>
                    </div>
                  </div>
                  <div class="col-auto">
                    <div class="d-block text-center">
                      <span class="avatar avatar-40 rounded-circle bg-theme-l-gradient">
                      </span>
                    </div>
                  </div>
                  <div class="col-auto">
                    <div class="d-block text-center">
                      <span class="avatar avatar-40 rounded-circle bg-theme-accent-l-gradient">
                      </span>
                    </div>
                  </div>
              ...
              <div class="container mt-4" id="main-content">
                ...
                <div class="row mb-4">
                  <div class="col text-center">
                    ...
                    <p class="text-secondary">Why not for your application? Let's personalize your application experience for
                      user interface now.</p>
                  </div>
                </div>
                    ...
                    <div id="personalizeAccordOne" class="accordion-collapse collapse show" aria-labelledby="personalizeAccordHOne" data-bs-parent="#personalizeAccord" style="">
                      <div class="accordion-body">
                        <p class="text-secondary">
                          Theme colors in web design are pivotal as they influence user emotions, perceptions, and actions.Theme colors in web design are pivotal as they influence user emotions, perceptions, and actions.
                        </p>
                        <div class="row theme-select">
                          <div class="col-auto">
                            <div class="select-box text-center mb-2" data-title="">
                              <span class="avatar avatar-60 rounded-circle mb-2 bg-default">
                      ...
                      <div class="accordion-body">
                        <div class="row theme-background">
                          ...
                          <div class="col-auto mb-3">
                            <div class="select-box text-center mb-2" data-title="bg-none">
                              <span class="avatar avatar-60 rounded-circle ">
                                <i class="bi bi-arrow-clockwise"></i>
                              </span>
                              <p class="small">None</p>
                            </div>
                          ...
                          <div class="col-auto mb-3">
                            <div class="select-box text-center mb-2">
                              <span class="avatar avatar-60 rounded-circle coverimg">
                                <img src="{{ asset('vendor/learninguiux/img/background-image/background-image-1.jpg') }}" alt="" class="w-100">
                              </span>
                          ...
                          <div class="col-auto mb-3">
                            <div class="select-box text-center mb-2">
                              <span class="avatar avatar-60 rounded-circle coverimg">
                                <img src="{{ asset('vendor/learninguiux/img/background-image/background-image-2.jpg') }}" alt="" class="w-100">
                              </span>
                          ...
                          <div class="col-auto">
                            <div class="select-box text-center mb-2">
                              <span class="avatar avatar-60 rounded-circle coverimg">
                                <img src="{{ asset('vendor/learninguiux/img/background-image/background-image-3.jpg') }}" alt="" class="w-100">
                              </span>
                          ...
                          <div class="col-auto mb-3">
                            <div class="select-box text-center mb-2">
                              <span class="avatar avatar-60 rounded-circle coverimg">
                                <img src="{{ asset('vendor/learninguiux/img/background-image/background-image-4.jpg') }}" alt="" class="w-100">
                              </span>
                          ...
                          <div class="col-auto">
                            <div class="select-box text-center mb-2">
                              <span class="avatar avatar-60 rounded-circle coverimg">
                                <img src="{{ asset('vendor/learninguiux/img/background-image/background-image-5.jpg') }}" alt="" class="w-100">
                              </span>
                          ...
                          <div class="col-auto mb-3">
                            <div class="select-box text-center mb-2">
                              <span class="avatar avatar-60 rounded-circle coverimg">
                                <img src="{{ asset('vendor/learninguiux/img/background-image/background-image-7.jpg') }}" alt="" class="w-100">
                              </span>
                          ...
                          <div class="col-auto mb-3">
                            <div class="select-box text-center mb-2">
                              <span class="avatar avatar-60 rounded-circle coverimg">
                                <img src="{{ asset('vendor/learninguiux/img/background-image/background-image-8.jpg') }}" alt="" class="w-100">
                              </span>
                          ...
                          <div class="col-auto mb-3">
                            <div class="select-box text-center mb-2">
                              <span class="avatar avatar-60 rounded-circle coverimg">
                                <img src="{{ asset('vendor/learninguiux/img/background-image/background-image-9.jpg') }}" alt="" class="w-100">
                              </span>
                          ...
                          <div class="col-auto mb-3">
                            <div class="select-box text-center mb-2">
                              <span class="avatar avatar-60 rounded-circle coverimg">
                                <img src="{{ asset('vendor/learninguiux/img/background-image/background-image-10.jpg') }}" alt="" class="w-100">
                              </span>
                          ...
                          <div class="col-auto mb-3">
                            <div class="select-box text-center mb-2">
                              <span class="avatar avatar-60 rounded-circle coverimg">
                                <img src="{{ asset('vendor/learninguiux/img/background-image/background-image-11.jpg') }}" alt="" class="w-100">
                              </span>
                          ...
                          <div class="col-auto mb-3">
                            <div class="select-box text-center mb-2">
                              <span class="avatar avatar-60 rounded-circle coverimg">
                                <img src="{{ asset('vendor/learninguiux/img/background-image/background-image-12.jpg') }}" alt="" class="w-100">
                              </span>
                            ...
                            <div class="row" id="personalise-preview-sidebar">
                              ...
                              <div class="col-auto" data-bs-img='dark'>
                                <div class="select-box text-center mb-2" data-title="adminuiux-sidebar-fill-white">
                                  <span class="avatar avatar-60 rounded-circle mb-2 bg-black"></span>
                                  <p class="small">Black</p>
                                </div>
                              </div>
                              ...
                              <div class="col-auto">
                                <div class="select-box text-center mb-2" data-title="adminuiux-sidebar-fill-bg">
                                  <span class="avatar avatar-60 rounded-circle mb-2 bg-body-1"></span>
                                  <p class="small">Background</p>
                                </div>
                              </div>
                              <div class="col-auto">
                                <div class="select-box text-center mb-2" data-title="adminuiux-sidebar-fill-theme">
                                  <span class="avatar avatar-60 rounded-circle mb-2 bg-theme-1"></span>
                                  <p class="small">Theme</p>
                                </div>
                              </div>
                              <div class="col-auto">
                                <div class="select-box text-center mb-2" data-title="adminuiux-sidebar-fill-accent">
                                  <span class="avatar avatar-60 rounded-circle mb-2 bg-theme-accent-1"></span>
                ...
                <div class="row">
                  ...
                  <div class="col-12 col-md-6">
                    <div class="card adminuiux-card shadow-sm mb-4">
                      ...
                      <div class="card-body">
                        <p class="text-secondary">RTL (Right-to-Left) layout mode is essential for languages that are read from right
                          to left, such as Arabic, Hebrew, and Persian. Elements like headings, paragraphs, links, images, and form
                          elements should be auto-adjusted to rtl</p>
                      </div>
                      <div class="card-footer">
                        <!-- rtl -->
                        <div class="row align-items-center no-rtl">
                          ...
                          <div class="col-auto px-0">
                            <div class="form-check form-switch rtlcheck">
                              <input class="form-check-input" type="checkbox" role="switch" id="btn-layout-dir-rtl">
                              <label class="form-check-label" for="btn-layout-dir-rtl">
