        ...
        <main class="adminuiux-content" onclick="contentClick()">
                        ...
                        <div class="col col-sm mb-2 mb-sm-0">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item active bi" aria-current="page">Radios</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="col-auto ">
                ...
                <div class="card adminuiux-card shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="flexCheckIndeterminate"> Indeterminate radio </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" value="" id="flexCheckIndeterminateDisabled" disabled checked>
                            <label class="form-check-label" for="flexCheckIndeterminateDisabled"> Disabled indeterminate radio </label>
                        </div>
                        <div class="form-check">
            ...
            &lt;/div&gt;
                ...
                <div class="card adminuiux-card shadow-sm mb-4">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <p class="h6">Standard radio Buttons</p>
                            </div>
                            <div class="col-auto">
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                                <div class="form-check mb-3">
                                    ...
                                    <label class="form-check-label" for="radioC1"> Theme radio </label>
                                </div>
                                <div class="form-check mb-3" style="--adminuiux-theme-1:var(--adminuiux-theme-accent-1)">
                                    ...
                                    <label class="form-check-label" for="radioC2"> Accent radio </label>
                                </div>
                                <div class="form-check theme-brown mb-3">
                                    <input class="form-check-input" type="radio" value="" id="radioC14" checked>
                                    <label class="form-check-label" for="radioC14"> Theme-purple radio </label>
                                </div>
                                <div class="form-check mb-3" style="--adminuiux-theme-1:var(--bs-primary)">
                                    ...
                                    <label class="form-check-label" for="radioC3"> Primary radio </label>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                                <div class="form-check mb-3" style="--adminuiux-theme-1:var(--bs-secondary)">
                                    ...
                                    <label class="form-check-label" for="radioC4"> Secondary radio </label>
                                </div>
                                <div class="form-check mb-3" style="--adminuiux-theme-1:var(--bs-info)">
                                    ...
                                    <label class="form-check-label" for="radioC5"> Info radio </label>
                                </div>
                                <div class="form-check mb-3" style="--adminuiux-theme-1:var(--bs-success)">
                                    ...
                                    <label class="form-check-label" for="radioC6"> Success radio </label>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                                <div class="form-check mb-3" style="--adminuiux-theme-1:var(--bs-warning)">
                                    ...
                                    <label class="form-check-label" for="radioC7"> Warning radio </label>
                                </div>
                                <div class="form-check mb-3" style="--adminuiux-theme-1:var(--bs-danger)">
                                    ...
                                    <label class="form-check-label" for="radioC8"> Danger radio </label>
                                </div>
            ...
            &lt;label class="btn btn-dark" for="btn-check20"&gt;Dark&lt;/label&gt;
                ...
                <div class="bg-theme-1-subtle rounded px-3 py-2 mb-4">
                    <div class="row">
                        <div class="col">
                            <a href="{{ route('preview.component-sidebars') }}" class="btn btn-accent me-3 my-2"><i class="bi bi-arrow-left mr-2"></i> Sidebars</a>
                        </div>
                        <div class="col-auto">
                            <a href="{{ route('preview.component-checkboxes') }}" class="btn btn-theme my-2">Checkboxes <i class="bi bi-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                </div>
            </div>
