        ...
        <main class="adminuiux-content" onclick="contentClick()">
                        ...
                        <div class="col col-sm mb-2 mb-sm-0">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item active bi" aria-current="page">Progressbar js</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="col-auto ">
            ...
            <div class="container mt-4">
                <div class="card adminuiux-card shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        <p class="text-secondary">With ProgressBar.js, it's easy to create responsive and stylish progress bars for the web. Animations perform well even on mobile devices. It provides a few built-in shapes like Line, Circle and SemiCircle but you can also create custom shaped progress bars with any vector graphic editor.</p>
                        <br>
                        <!-- example icon -->
                        ...
                        <a href="https://kimmobrunfeldt.github.io/progressbar.js//" target="_blank" class="btn btn-link">More examples at progressbar js</a>
                    </div>
            ...
            &lt;/script&gt;
                ...
                <div class="bg-theme-1-subtle rounded px-3 py-2 mb-4">
                    <div class="row">
                        <div class="col">
                            <a href="{{ route('preview.component-dropzone') }}" class="btn btn-accent me-3 my-2"><i class="bi bi-arrow-left mr-2"></i> Dropzone</a>
                        </div>
                        <div class="col-auto">
                            <a href="{{ route('preview.component-smartwizard') }}" class="btn btn-theme my-2">SmartWizard <i class="bi bi-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                </div>
            </div>
...
@push('scripts')
<script src="{{ asset('vendor/learninguiux/js/component/component-progressbarjs.js') }}"></script>
@endpush
