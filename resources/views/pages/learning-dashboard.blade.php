        ...
        <ul class="nav flex-column menu-active-line">
            ...
            @auth
                @if (auth()->user()?->is_admin)
                    <li class="nav-item">
                        <a href="{{ route('app.admin.assignments') }}" class="nav-link">
                            <i class="menu-icon bi bi-shield-lock"></i>
                            <span class="menu-name">Admin Section</span>
                        </a>
                    </li>
                @endif
            @endauth
                                    ...
                                    <div class="card adminuiux-card shadow-sm overflow-hidden">
                                        <div class="card-body">
                                            <!-- <div class="row gx-3 mb-3">
                                                                <div class="col-auto">
                                                                    <figure class="avatar avatar-20 coverimg rounded">
                                                                        <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/shooping-5.jpg') }}" alt="">
                                                                    </figure>
                                                                </div>
                                                                <div class="col">
                                                                    <p class="small">Johnson University</p>
                                                                </div>
                                                            </div> -->
                                            ...
                                            <div class="row gx-3 align-items-center">
                                                <div class="col">
                                                    <p class="text-secondary small"><i class="bi bi-file-play"></i> Chapter 3 - 5:00min</p>
                                                </div>
                                                <div class="col-auto">
                                                    <button class="btn btn-sm btn-square btn-success"><i class="bi bi-play"></i></button>
                                                </div>
                                            </div>
                                            <div class="progress position-absolute w-100 bottom-0 start-0 height-dynamic rounded-0" style="--h-dynamic: 5px" role="progressbar" aria-label="Basic example" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100">
                                    ...
                                    <div class="card adminuiux-card shadow-sm">
                                        <div class="card-body">
                                            <!-- <div class="row gx-3 align-items-center mb-3">
                                                                <div class="col-auto">
                                                                    <figure class="avatar avatar-20 coverimg rounded">
                                                                        <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/tax-3.jpg') }}" alt="">
                                                                    </figure>
                                                                </div>
                                                                <div class="col">
                                                                    <p class="small">Lobardo University</p>
                                                                </div>
                                                            </div> -->
                                            <figure class="height-120 w-100 coverimg rounded mb-3">
                                            ...
                                            <div class="row gx-3 align-items-center">
                                                <div class="col">
                                                    <p class="text-secondary small">Professional Certificate</p>
                                                </div>
                                                <div class="col-auto">
                                                    <button class="btn btn-theme btn-sm">Start <i class="bi bi-play"></i></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card adminuiux-card shadow-sm">
                                        <div class="card-body">
                                            <!-- <div class="row gx-3 align-items-center mb-3">
                                                                ...
                                                                <div class="col">
                                                                    <p class="small">LVSK Institute</p>
                                                                </div>
                                                            </div> -->
                                            <figure class="height-120 w-100 coverimg rounded mb-3">
                                                <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/flamingo-1.jpg') }}" alt="">
                                            ...
                                            <div class="row gx-3 align-items-center">
                                                ...
                                                <div class="col-auto">
                                                    <button class="btn btn-theme btn-sm">Buy <i class="bi bi-cart"></i></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-3">
                        <div class="card adminuiux-card shadow-sm mb-4">
                            <div class="card-body">
                                ...
                                <p class="text-secondary small mb-0">You have completed 2/9 chapters</p>
                                <p class="text-secondary small mb-0">You have passed 2/10 assignment</p>
                            </div>
                        </div>
                    </div>
                    <!-- course summary -->
                    ...
                    <div class="col-12 col-md-6 col-lg-3 mb-4">
                        <div class="card adminuiux-card shadow-sm">
                            <div class="card-body">
                                ...
                                <div class="row gx-3 align-items-center">
                                    <div class="col">
                                        <p class="text-secondary small mb-0">9 chapters 25hr 15mi</p>
                                        <p class="text-secondary small">Professional Certificate</p>
                                    </div>
                                    <div class="col-auto">
                                        <button class="btn btn-theme btn-sm">Buy <i class="bi bi-cart"></i></button>
                        ...
                        <div class="card adminuiux-card shadow-sm mb-1">
                            <div class="card-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto">
                                        <p class="text-secondary"><span class="bi bi-award text-theme-1 theme-orange"></span> Level 9</p>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body pb-0">
                                ...
                                <div class="row">
                                    <div class="col-6 col-lg-6 mb-3">
                                        <p class="small"><span class="me-1 avatar avatar-10 rounded-circle bg-green"></span> IT <span class="text-success fw-normal ms-1">45%</span></p>
                                    </div>
                                    <div class="col-6 col-lg-6 mb-3">
                                        <p class="small"><span class="me-1 avatar avatar-10 rounded-circle bg-yellow"></span> Biotech <span class="text-success fw-normal ms-1">30%</span></p>
                                    </div>
                                    <div class="col-6 col-lg-6 mb-3">
                                        <p class="small"><span class="me-1 avatar avatar-10 rounded-circle bg-purple"></span> Design <span class="text-success fw-normal ms-1">25%</span></p>
                                    </div>
                                    <div class="col-6 col-lg-6 mb-3">
                                        <p class="small"><span class="me-1 avatar avatar-10 rounded-circle bg-secondary"></span> Other <span class="text-success fw-normal ms-1">10%</span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-4 col-md-4">
                                <div class="card adminuiux-card shadow-sm">
                                    <div class="card-body">
                                        ...
                                        <h4 class="mb-0">6</h4>
                                        <p class="text-secondary small text-truncated mb-0">Courses</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-4 col-md-4">
                                <div class="card adminuiux-card shadow-sm">
                                    <div class="card-body">
                                        ...
                                        <h4 class="mb-0">3</h4>
                                        <p class="text-secondary small text-truncated mb-0">Certificate</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-4 col-md-4">
                                <div class="card adminuiux-card shadow-sm">
                                    <div class="card-body">
                                        ...
                                        <h4 class="mb-0">35</h4>
                                        <p class="text-secondary small text-truncated mb-0">Tasks</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-6">
                                <div class="card adminuiux-card shadow-sm height-150 bg-theme-1 theme-teal mb-4 hover-action">
                                    <div class="card-body position-relative">
                                        <div class="hover-action-visible position-absolute top-0 end-0 m-3" data-bs-toggle="modal" data-bs-target="#addreminder" title="Add Reminder">
                                            <button class="btn btn-sm btn-square btn-theme theme-blue rounded-circle"><i class="bi bi-plus"></i></button>
                                        </div>
                                        <h4 class="mb-0">26</h4>
                                        <p class="opacity-75 mb-4">Monday</p>
                                        <p class="text-truncated small mb-0">Bio Management</p>
                                        <p class="text-truncated opacity-75 fs-12 mb-0">Chapeter 1 Test</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6">
                            ...
                            <div class="col-6">
                                <div class="card adminuiux-card shadow-sm height-150 bg-theme-accent-1 mb-4 hover-action">
                                    <div class="card-body position-relative">
                                        ...
                                        <p class="text-truncated opacity-75 fs-12 mb-0">Chapeter 3</p>
                                        <div class="avatar avatar-20 position-absolute bottom-0 end-0 rounded-circle bg-white-opacity text-white text-center m-2" data-bs-toggle="tooltip" title="Bio Management Chapter 1: Test-2">
                    ...
                    <div class="col-12 col-md-6 col-lg-3">
                        <div class="card adminuiux-card shadow-sm mb-4">
                                ...
                                <div class="swiper swipernav dateselect">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide text-center pt-1">
                                            <p class="small text-secondary text-uppercase text-truncated mb-0">Wed</p>
                                            <div class="avatar avatar-30 rounded">4</div>
                                        </div>
                                        <div class="swiper-slide text-center pt-1">
                                            <p class="small text-secondary text-uppercase text-truncated mb-0">Thu</p>
                                            <div class="avatar avatar-30 rounded">5</div>
                                        </div>
                                        <div class="swiper-slide text-center pt-1 active">
                                            <p class="small text-secondary text-uppercase text-truncated mb-0">Fri</p>
                                            <div class="avatar avatar-30 rounded">6</div>
                                        </div>
                                        <div class="swiper-slide text-center pt-1">
                                            <p class="small text-secondary text-uppercase text-truncated mb-0">Sat</p>
                                            <div class="avatar avatar-30 rounded">7</div>
                                        </div>
                                        <div class="swiper-slide text-center pt-1">
                                            <p class="small text-secondary text-uppercase text-truncated mb-0">Sun</p>
                                            <div class="avatar avatar-30 rounded">8</div>
                                        </div>
                                        <div class="swiper-slide text-center pt-1">
                                            <p class="small text-secondary text-uppercase text-truncated mb-0">Mon</p>
                            ...
                            <div class="card-body height-dynamic overflow-auto pb-0" style="--h-dynamic:233px">
                                ...
                                <div class="card mb-3">
                                    <div class="card-body">
                                        <p class="mb-2 small fw-medium">10:00 am - 11:30 am <span class="text-warning bi bi-tag"></span></p>
                                        <div class="row align-items-center gx-2 mb-0">
                                            <div class="col-auto"><img src="{{ asset('vendor/learninguiux/img/background-image/background-image-11.jpg') }}" class="avatar avatar-20 rounded" alt=""></div>
                                            <div class="col">
                                                <h6>IT Data Modal</h6>
                                            </div>
                                        </div>
                                        <p class="text-secondary small text-truncated">Chapter 2 starting.</p>
                                    </div>
                                </div>
                                <!-- appointment card -->
                                <div class="card mb-3">
                                    <div class="card-body">
                                        ...
                                        <div class="row gx-2 mb-0">
                                            <div class="col-auto"><img src="{{ asset('vendor/learninguiux/img/modern-ai-image/user-4.jpg') }}" class="avatar avatar-20 rounded-circle" alt=""> <img src="https://i.pravatar.cc/300" class="avatar avatar-20 rounded-circle" alt=""></div>
                                            <div class="col">
                                                <h6>Bio-diversity</h6>
                                            </div>
                                        </div>
                        ...
                        <div class="card adminuiux-card shadow-sm bg-theme-1 overflow-hidden position-relative mb-4">
                            ...
                            <div class="card-body height-dynamic position-relative" style="--h-dynamic:322px">
                                ...
                                <div class="row align-items-center justify-content-center h-100">
                                    <div class="col-11">
                                        <h3 class="fw-normal mb-0">Learn more<br>with AI-ML Course</h3>
                        ...
                        <table class="table mb-0" data-show-toggle="true" id="dataTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p><a class="btn btn-link theme-red"><i class="bi bi-file-earmark-pdf"></i> <span class="align-middle">Certificate</span> </a></p>
                                    </td>
                                    <td>
...
@push('scripts')
<script src="{{ asset('vendor/learninguiux/js/learning/learning-dashboard.js') }}"></script>
@endpush
