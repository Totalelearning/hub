                                        ...
                                        <div class="row h-100 align-items-center justify-content-center mt-md-3">
                                            <div class="col-11 col-sm-8 col-md-11 col-xl-11 col-xxl-10 login-box">
                                                <div class="text-center mb-4">
                                                    ...
                                                    <p class="text-secondary">Provide your registered email address, we will send you an email with change
                                                        password link with steps.</p>
                                                </div>
                                                ...
                                                <a href="{{ route('preview.learning-change-password') }}" class="btn btn-lg btn-theme w-100 mb-4">Reset Now</a>
                                                <!-- <button class="btn btn-lg btn-theme w-100 mb-4">Login</button> -->
                                                <div class="text-center mb-3">
                                                    Already have password? <a href="{{ route('preview.learning-login') }}" class=" ">Login</a> here.
                                                </div>
                                                <br><br>
                                            </div>
                                        </div>
