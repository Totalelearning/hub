        ...
        <main class="adminuiux-content" onclick="contentClick()">
                        ...
                        <div class="col col-sm mb-2 mb-sm-0">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item active bi" aria-current="page">DataTable</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="col-auto ">
                            ...
                            <table class="table w-100 nowrap" id="dataTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{ route('preview.learning-student-profile') }}" class="btn btn-square btn-link" data-bs-toggle="tooltip" title="View">
                                                <i class="bi bi-eye"></i>
                                            </a>
                                            <div class="dropdown d-inline-block">
                                                <a class="btn btn-link no-caret" data-bs-toggle="dropdown">
            ...
            function lastvisibletd() {
                ...
                <div class="bg-theme-1-subtle rounded px-3 py-2 mb-4">
                    <div class="row">
                        <div class="col">
                            <a href="{{ route('preview.component-chartjs') }}" class="btn btn-accent me-3 my-2"><i class="bi bi-arrow-left mr-2"></i> Chart Js</a>
                        </div>
                        <div class="col-auto">
                            <a href="{{ route('preview.component-datatable') }}" class="btn btn-theme my-2">DataTable <i class="bi bi-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                </div>
            </div>
...
@push('scripts')
<script src="{{ asset('vendor/learninguiux/js/component/component-dataTable.js') }}"></script>
@endpush
