        ...
        <main class="adminuiux-content" onclick="contentClick()">
                        ...
                        <div class="col col-sm mb-2 mb-sm-0">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item active bi" aria-current="page">List Group</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="col-auto ">
                ...
                <div class="card adminuiux-card shadow-sm mb-4">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <p class="h6">Standard List Group</p>
                            </div>
                            <div class="col-auto">
            ...
            &lt;/div&gt;
                ...
                <div class="card adminuiux-card shadow-sm mb-4">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <p class="h6">Rich minimal list-group</p>
                            </div>
                            <div class="col-auto">
            ...
            &lt;/div&gt;
                ...
                <div class="card adminuiux-card shadow-sm mb-4">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <p class="h6">Numbered List Group</p>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 col-lg-4 col-xl-3">
                                <ul class="list-group">
                                    <li class="list-group-item d-flex justify-content-between align-items-center"> A list item <span class="badge text-bg-primary rounded-pill">14</span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center"> A second list item <span class="badge text-bg-primary rounded-pill">2</span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center"> A third list item <span class="badge text-bg-primary rounded-pill">1</span>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4 col-xl-3">
            ...
            &lt;/div&gt;
                ...
                <div class="card adminuiux-card shadow-sm mb-4">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <p class="h6">Colored List Group</p>
                            </div>
                            <div class="col-auto">
            ...
            &lt;/div&gt;
                ...
                <div class="card adminuiux-card shadow-sm mb-4">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <p class="h6">Radio and Checkbox List Group</p>
                            </div>
                            <div class="col-auto">
            ...
            &lt;/div&gt;
                ...
                <div class="bg-theme-1-subtle rounded px-3 py-2 mb-4">
                    <div class="row">
                        <div class="col">
                            <a href="{{ route('preview.component-collapse') }}" class="btn btn-accent me-3 my-2"><i class="bi bi-arrow-left mr-2"></i> Collapse</a>
                        </div>
                        <div class="col-auto">
                            <a href="{{ route('preview.component-modal-dialogues') }}" class="btn btn-theme my-2">Modal Dialog <i class="bi bi-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                </div>
            </div>
