                        ...
                        <main class="adminuiux-content has-sidebar" onclick="contentClick()">
                            ...
                            <div class="container mt-4">
                                <div class="row gx-3 align-items-center">
                                    ...
                                    <div class="col-auto">
                                        <a href="{{ route('preview.learning-add-invoice') }}" class="btn btn-theme">
                                            <i class="bi bi-receipt me-0 me-md-1"></i>
                                            ...
                                            <div class="card-body">
                                                <div class="row align-items-center mb-3">
                                                    ...
                                                    <div class="col px-0">
                                                        ...
                                                        <p class="text-secondary small">Total Amount Paid
                                                ...
                                                <p class="text-secondary small">This is total expense occurred in our investment and paid bills amount.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-sm-6 col-xxl-3 mb-4">
                                        <div class="card adminuiux-card shadow-sm">
                                            <div class="card-body">
                                                ...
                                                <p class="text-secondary small">Rental and Cleaning Expense<br>
                                    ...
                                    <div class="col-12 col-sm-6 col-xxl-3 mb-4">
                                        <div class="card adminuiux-card shadow-sm">
                                            <div class="card-body">
                                                ...
                                                <p class="text-secondary small">Invoices amount <br>
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-12 col-sm ">
                                                    <div class="row align-items-center mb-2">
                                                        <div class="col">
                                                            <a href="{{ route('preview.learning-student-profile') }}" class="h6 style-none">Alicia Smith</a>
                                                            <p>
                                                        ...
                                                        <div class="col-auto ">
                                                            <a href="{{ route('preview.learning-student-profile') }}" class="btn btn-square btn-link" data-bs-toggle="tooltip" title="View">
                                                    ...
                                                    <p class="text-secondary">
                                                        12, Featherstone Street, Ward, London, NG25 5AY<br>United Kingdom
                                                    </p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="modal-footer">
                                            <div class="col-auto pe-2">
                                                <button class="btn btn-outline-accent">
                                                    <i class="bi bi-send"></i> <span>Email Customer</span>
                                                </button>
                                            </div>
                                            <div class="col">
