    ...
    <nav class="navbar navbar-expand-lg fixed-top">
        ...
        <main class="adminuiux-content" onclick="contentClick()">
                        ...
                        <div class="col col-sm mb-2 mb-sm-0">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item active bi" aria-current="page">Cards</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="col-auto ">
            ...
            &lt;/div&gt;
                ...
                <div class="card adminuiux-card shadow-sm mb-4">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <p class="h6">Card with Header and Footer</p>
                            </div>
                            <div class="col-auto">
            ...
            &lt;/div&gt;
                                ...
                                <button type="button" class="btn btn-outline-light  btn-square copycode"><i class="bi bi-clipboard"></i></button>
                                <button type="button" class="btn btn-outline-light btn-square ms-2" data-bs-toggle="collapse" data-bs-target="#collapse5" aria-expanded="false">
                                    <i class="bi bi-code-slash"></i>
                                </button>
                            </div>
                        </div>
                ...
                <div class="bg-theme-1-subtle rounded px-3 py-2 mb-4">
                    <div class="row">
                        <div class="col">
                            <a href="{{ route('preview.component-accordions') }}" class="btn btn-accent me-3 my-2"><i class="bi bi-arrow-left mr-2"></i> Buttons</a>
                        </div>
                        <div class="col-auto">
                            <a href="{{ route('preview.component-collapse') }}" class="btn btn-theme my-2">Icon Buttons <i class="bi bi-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                </div>
            </div>
