                                    ...
                                    <div class="col-12 col-sm">
                                        ...
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb mb-0">
                                                ...
                                                <li class="breadcrumb-item bi"><a href="{{ route('preview.learning-pages') }}">Pages</a></li>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-12 col-md-6 col-lg-5">
                                        <div class="card adminuiux-card shadow-sm mb-4">
                                            <div class="card-body">
                                                <h2 class="mb-3">We will be happy<br>to help you!</h2>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 col-lg-12 mb-2">
                                                        <div class="form-group mb-3 position-relative">
                                                            <div class="input-group input-group-lg">
                                                                <span class="input-group-text text-theme-1"><i class="bi bi-question-circle"></i></span>
                                                                <div class="form-floating">
                                                                    <input type="text" placeholder="Subject" value="Johnson" required="" class="form-control">
                                                                    <label>Subject</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="col-12 col-md-6 col-lg-7">
                                        <div class="text-center mb-4">
                                            <img src="{{ asset('vendor/learninguiux/img/learning/banner-2.png') }}" alt="" class="maxwidth-400 mb-3">
                                            <h2 class="text-theme-1">Live as if you were to die tomorrow.<br>Learn as if you were to live forever.</h2>
                                            <p class="text-secondary">- M K Gandhi</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- email communication -->
                                <p class="text-secondary"><b>Technical problem:</b> If you have any type of technical challenges and would like to get help from us please drop an email at <a href="mailto:info@adminuiux.cos">tech@adminuiux.coms</a></p>
                                <p class="text-secondary mb-4"><b>General Support:</b> If you have any type of challenges regarding products and would like to get help from us please drop an email at <a href="mailto:info@adminuiux.cos">sales@adminuiux.coms</a></p>
                            </div>
                        </main>
