        ...
        <main class="adminuiux-content" onclick="contentClick()">
                        ...
                        <div class="col col-sm mb-2 mb-sm-0">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item active bi" aria-current="page">Icons Bootstrap</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="col-auto ">
            ...
            <div class="container mt-4">
                <div class="card adminuiux-card shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        <p class="text-secondary">Free, high quality, open source icon library with over 2,000 icons.<br> Include them anyway you like—SVGs, SVG sprite, or web fonts. Use them with or without Bootstrap in any project.</p>
                        <br>
                        <p class="h6">Icon font</p>
                        <div class="mb-3">
                            <i class="bi-alarm me-2"></i>
                            <i class="bi-alarm me-2" style="font-size: 2rem; color: cornflowerblue;"></i>
                        </div>
                        <a href="https://icons.getbootstrap.com/" target="_blank" class="btn btn-link">More Bootstrap Icons</a>
                    </div>
            ...
            &lt;i class="bi-alarm me-2"&gt;&lt;/i&gt;
            &lt;i class="bi-alarm me-2" style="font-size: 2rem; color: cornflowerblue;"&gt;&lt;/i&gt;</code></pre>
                ...
                <div class="bg-theme-1-subtle rounded px-3 py-2 mb-4">
                    <div class="row">
                        <div class="col">
                            <a href="{{ route('preview.component-validation') }}" class="btn btn-accent me-3 my-2"><i class="bi bi-arrow-left mr-2"></i> Validation</a>
                        </div>
                        <div class="col-auto">
                            <a href="{{ route('preview.component-feather-icons') }}" class="btn btn-theme my-2">Feather Icons <i class="bi bi-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                </div>
            </div>
