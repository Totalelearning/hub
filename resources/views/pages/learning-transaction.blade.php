                                ...
                                <div class="row gx-3 align-items-center">
                                    ...
                                    <div class="col-auto py-1">
                                        <a href="{{ route('preview.learning-add-invoice') }}" class="btn btn-theme">
                                            <i data-feather="plus" class="me-0 me-md-1"></i> <span class="d-none d-md-inline-block">Invoice</span>
                                        </a>
                                    </div>
                                        ...
                                        <table id="dataTable" class="table w-100 nowrap">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('preview.learning-myprofile') }}" class="btn btn-square btn-link" data-bs-toggle="tooltip" title="View">
                                                            <i class="bi bi-eye"></i>
                                                        </a>
                                                        <div class="dropdown d-inline-block">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="{{ route('preview.learning-myprofile') }}" class="btn btn-square btn-link" data-bs-toggle="tooltip" title="View">
                                                            <i class="bi bi-eye"></i>
                                                        </a>
                                                        <div class="dropdown d-inline-block">
                                                            <a class="btn btn-link no-caret" data-bs-toggle="dropdown">
