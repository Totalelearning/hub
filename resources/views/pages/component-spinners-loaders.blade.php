        ...
        <main class="adminuiux-content" onclick="contentClick()">
                ...
                <div class="bg-theme-1-subtle rounded px-3 py-3">
                    <div class="row gx-3 align-items-center">
                        <div class="col col-sm mb-2 mb-sm-0">
                            <p class="h5">Spinners and Loaders</p>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item active bi" aria-current="page">Spinners and Loaders</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="col-auto ">
            ...
            &lt;/div&gt;
                ...
                <div class="card adminuiux-card shadow-sm mb-4">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <p class="h6">Customized Loaders</p>
                            </div>
                            <div class="col-auto">
            ...
            &lt;/div&gt;
                    ...
                    <div class="card-body">
                        ...
                        <a href="https://cssloaders.github.io/" target="_blank" class="btn btn-link">Visit for more css loaders</a>
                    </div>
                </div>
                <!-- component footer -->
                <div class="bg-theme-1-subtle rounded px-3 py-2 mb-4">
                    <div class="row">
                        <div class="col">
                            <a href="{{ route('preview.component-tooltips') }}" class="btn btn-accent me-3 my-2"><i class="bi bi-arrow-left mr-2"></i> Tooltips</a>
                        </div>
                        <div class="col-auto">
                            <a href="{{ route('preview.component-accordions') }}" class="btn btn-theme my-2">Accordions <i class="bi bi-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                </div>
            </div>
