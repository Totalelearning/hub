                ...
                <div class="card-body p-2">
                    <div class="row gx-2">
                        ...
                        <main class="adminuiux-content has-sidebar" onclick="contentClick()">
                                    ...
                                    <div class="col-12 col-md mb-3 mb-md-0">
                                        ...
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb mb-3 mb-md-0">
                                                ...
                                                <li class="breadcrumb-item active bi" aria-current="page">Course Fees</li>
                                            </ol>
                                        </nav>
                                    </div>
                                    <div class="col col-md-auto mb-md-0">
                            ...
                            <div class="container mt-4">
                                <div class="alert alert-warning theme-yellow">
                                    <div class="row align-items-center">
                                        <div class="col-auto">
                                            <h1>🥳</h1>
                                        </div>
                                        <div class="col mb-3 mb-md-0">
                                            <h5 class="text-dark mb-1">Offer 100% FREE Admission</h5>
                                            <p class="text-dark opacity-75">New Admission on 25<sup>th</sup> March - 30<sup>th</sup> March</p>
                                        </div>
                                        <div class="col-12 col-md-auto mb-3 mb-md-0">
                                            <input type="text" class="form-control" placeholder="Email Address">
                                        </div>
                                        <div class="col-12 col-md-auto">
                                            <button class="btn btn-theme w-100">Alert me</button>
                                        </div>
                                    </div>
                                </div>
                                <!-- search filters -->
                                <div class="card adminuiux-card bg-theme-l-gradient shadow-sm mb-4">
                                    <div class="card-body p-1">
                                        <div class="card adminuiux-card">
                                            <div class="card-body">
                                                <h4>Find appropriate fees structure?</h4>
                                                <div class="row align-items-center">
                                                    <div class="col-12 col-sm-6 col-md">
                                                        <div class="form-floating">
                                                            <select class="form-select" id="searchfield-1">
                                                                <option selected="selected">Choose standard</option>
                                                            ...
                                                            <label for="searchfield-1">Looking fees for</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-sm-6 col-md">
                                                        <div class="form-floating">
                                                            <select class="form-select" id="searchfield-2">
                                                                <option disabled selected>Select admission type</option>
                                                                <option>New Admission</option>
                                                                <option>No, Regular Student</option>
                                                            </select>
                                                            <label for="searchfield-2">Is this a new admission?</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-sm-6 col-md">
                                                        <div class="form-floating">
                                                            <select class="form-select" id="searchfield-3">
                                                            ...
                                                            <label for="searchfield-3">Check fees for year</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-sm-auto">
                                                        <button class="btn btn-lg btn-square rounded-circle btn-link">
                                                            <i data-feather="search"></i>
                                                        </button>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card adminuiux-card shadow-sm mb-4">
                                            <div class="card-body">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-auto">
                                                        <span class="badge badge-light text-bg-theme-1">Regular</span>
                                                    </div>
                                                </div>
                                                <h2>$ 1500.00</h2>
                                                ...
                                                <ul class="lists">
                                                    <li>Tuition Fees</li>
                                                    <li>Optional Activity/Facility Fees</li>
                                                    <li>Educational Features Included</li>
                                                </ul>
                                                <p class="small text-secondary">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer cursus blandit dolor, nec rutrum urna facilisis vitae.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- fees card -->
                                        ...
                                        <div class="card adminuiux-card shadow-sm mb-4">
                                            <div class="card-body">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-auto">
                                                        <span class="badge badge-light text-bg-theme-1 theme-teal">New Admission</span>
                                                    </div>
                                                </div>
                                                <h2>$ 2500.00</h2>
                                                <p class="mb-1">Includes:</p>
                                                <ul class="lists">
                                                    <li>Tuition Fees + Processing Fee</li>
                                                    <li>Optional Activity/Facility Fees</li>
                                                    <li>Educational Features Included</li>
                                                </ul>
                                                <p class="small text-secondary">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer cursus blandit dolor, nec rutrum urna facilisis vitae.</p>
                                ...
                                <!-- payment options -->
                                <p class="small text-center text-secondary">We accepts online payments</p>
                                <div class="row justify-content-center mb-4">
                                    <div class="col-auto">
                                        <i class="bi bi-paypal h3 text-secondary" data-bs-toggle="tooltip" title="PayPal Payment"></i>
                                    </div>
                                    <div class="col-auto">
                                        <i class="bi bi-bank h3 text-secondary" data-bs-toggle="tooltip" title="Net Banking"></i>
                                    </div>
                                    <div class="col-auto">
                                        <i class="bi bi-credit-card h3 text-secondary" data-bs-toggle="tooltip" title="Credit/Debit card"></i>
                                    </div>
                                    <div class="col-auto">
                                        <i class="bi bi-qr-code-scan h3 text-secondary" data-bs-toggle="tooltip" title="UPI Payment"></i>
                                    </div>
                                </div>
                                <!-- features -->
                                <h5>Our features</h5>
                                    ...
                                    <div class="card-body">
                                        <div class="row justify-content-center text-center py-md-4">
                                            <div class="col-12 col-md-10 col-lg-8">
                                                ...
                                                <p>Its possible human made mistakes and possibly we may missed it. We are happy to assist you as well as upgrade our system. Do let us know your query, concern and feedback.</p><a href="{{ route('preview.learning-contactus') }}" class="btn btn-theme mx-1">Connect with us</a> <a href="" class="btn btn-outline-theme mx-1">Leave us feedback</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <h5>Online mode for fees payment</h5>
                                <p>As a continuous attempt to reduces the inconveniency of paying fees by cheque, the management has decided to collect the fees through online portal, 'Connecting Millions'.</p>

                                <p>You can pay the fees choosing any one of the following payment modes:</p>
                                <ul class="list">
                                    <li><b>Net Banking</b> - Parents can pay fees by login in to their bank accounts and make payments.</li>
                                    <li><b>Credit/Debit card</b> - Parents can make the payment by entering Credit/Debit card details.</li>
                                    <li><b>UPI</b> - Parents can enter their virtual payment ID or active connected phone number i.e. VPA to pay the fees.</li>
                                    <li><b>NEFT/ RTGS</b> - Parents can pay the fees by clicking the NEFT/ RTGS.</li>
                                    <li><b>Easy Pay</b> - we are using 'PayNow' payment gateway by American-XR Bank</li>
                                </ul>
                                <p>On successful completion of transactions, a receipt gets generated, and parents can download it for their record.</p>
                                <br>
                                <p class="small text-secondary">*The all Fees here does not include cost of uniform, books and transportation. The School does not provide these products/ services and parents are free to get them from open market.</p>
                            </div>
                        </main>
                </div>
                <!-- theming offcanvas-->
...
<div class="position-fixed bottom-0 end-0 m-3 z-index-5">
    ...
    <button class="btn btn-theme btn-square shadow mt-2 d-none rounded-circle" id="backtotop"><i class="bi bi-arrow-up"></i></button>
                        ...
                        <div class="modal adminuiux-modal fade" id="addeventmodal" tabindex="-1" aria-labelledby="addeventmodalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <p class="modal-title h5" id="addeventmodalLabel">Add Event</p>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <p class="small text-secondary mb-1">Search Participants </p>
                                        <div class="mb-2">
                                            <div class="input-group mb-2">
                                                <span class="input-group-text">
                                                    <i class="bi bi-search"></i>
                                                </span>
                                                <input class="form-control" type="search" placeholder="Search Participants..." id="searchattendis">
                                            </div>
                                            <!-- selected Participants -->
                                            <span class="badge badge-light text-bg-theme-1 theme-green me-1 mb-1">
                                                <span class="row align-items-center gx-2">
                                                    <span class="col-auto"><img src="{{ asset('vendor/learninguiux/img/modern-ai-image/user-6.jpg') }}" class="avatar avatar-20 rounded-circle" alt=""> </span>
                                                    <span class="col">Will Johnson</span>
                                                    <span class="col-auto">
                                                        <button class="btn btn-link p-0 avatar avatar-20 rounded-circle theme-red"><i class="bi bi-x"></i></button>
                                                    </span>
                                                </span>
                                            </span>
                                        </div>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-12 col-sm">
                                                <div class="form-check form-switch mb-3">
                                                    <input class="form-check-input" type="checkbox" role="switch" id="multipleday" checked>
                                                    <label class="form-check-label" for="multipleday">This is multi-day event</label>
                                                </div>
                                            </div>
                                            <div class="col-12 col-sm">
                                                <div class="form-check form-switch mb-3">
                                                    <input class="form-check-input" type="checkbox" role="switch" id="fullday" checked>
                                                    <label class="form-check-label" for="fullday">This is full-day event</label>
                                                </div>
                                            </div>
                                        </div>

                                        <p class="small text-secondary mb-1">Choose event days</p>
                                        ...
                                        <!-- toggle hide when full day selected -->
                                        <div class="row">
                                            <div class="col-12 col-sm-6 mb-3">
                                                <p class="small text-secondary mb-1">Start time</p>
                                                <div class="row gx-1">
                                                    <div class="col">
                                            ...
                                            <div class="col-12 col-sm-6 mb-3">
                                                <p class="small text-secondary mb-1">End time</p>
                                                <div class="row gx-1">
                                                    <div class="col">
                                        ...
                                        <p class="small text-secondary mb-1">Event Description</p>
