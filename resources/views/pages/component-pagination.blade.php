        ...
        <main class="adminuiux-content" onclick="contentClick()">
                        ...
                        <div class="col col-sm mb-2 mb-sm-0">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item active bi" aria-current="page">Pagination</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="col-auto ">
                ...
                <div class="card adminuiux-card shadow-sm mb-4">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <p class="h6">Standard pagination</p>
                            </div>
                            <div class="col-auto">
            ...
            &lt;/nav&gt;
                ...
                <div class="card adminuiux-card shadow-sm mb-4">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <p class="h6">Pagination Alignment</p>
                            </div>
                            <div class="col-auto">
            ...
            &lt;/nav&gt;
                ...
                <div class="bg-theme-1-subtle rounded px-3 py-2 mb-4">
                    <div class="row">
                        <div class="col">
                            <a href="{{ route('preview.component-dropdowns') }}" class="btn btn-accent me-3 my-2"><i class="bi bi-arrow-left mr-2"></i> Dropdowns</a>
                        </div>
                        <div class="col-auto">
                            <a href="{{ route('preview.component-alerts') }}" class="btn btn-theme my-2">Alerts <i class="bi bi-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                </div>
            </div>
