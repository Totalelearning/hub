        ...
        <div class="px-3 not-iconic">
            ...
            <main class="adminuiux-content has-sidebar" onclick="contentClick()">
              ...
              <div class="container mt-4" id="main-content">
                <!-- cover-->
                <div class="card adminuiux-card shadow-sm overflow-hidden z-index-0 mb-0 pt-5">
                  <figure class="coverimg start-0 top-0 w-100 h-100 z-index-0 position-absolute overlay-gradiant">
                    <div class="position-absolute top-0 end-0 m-2"><button class="btn btn-theme" onclick="$(this).next().click()"><i class="bi bi-camera"></i> Change Cover</button> <input type="file" class="d-none"></div>
                    <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/pet-1.jpg') }}" class="mw-100" alt="">
                  </figure>
                  <div class="card-body text-center text-white z-index-1">
                    <div class="d-inline-block position-relative w-auto mx-auto my-3">
                      <figure class="avatar avatar-150 coverimg rounded-circle" style="background-image: url(&quot;{{ asset('vendor/learninguiux/img/modern-ai-image/user-6.jpg&quot;') }});"><img src="{{ asset('vendor/learninguiux/img/modern-ai-image/user-6.jpg') }}" alt="" style="display: none;"></figure>
                      <div class="position-absolute bottom-0 end-0 z-index-1 h-auto"><button class="btn btn-lg btn-theme btn-square" onclick="$(this).next().click()"><i class="bi bi-camera"></i></button> <input type="file" class="d-none"></div>
                    </div>
                    <h4>Learning UIUX</h4>
                ...
                <!-- navigation -->
                <div class="position-sticky z-index-1" style="top:5.5rem">
                  <div class="card adminuiux-card shadow-sm mb-4">
                    <div class="card-body p-0 overflow-x-auto">
                      <ul class="nav nav-pills adminuiux-nav-pills flex-nowrap">
                        <li class="nav-item"><a class="nav-link active" aria-current="page" href="{{ route('preview.learning-settings') }}">
                            <div class="avatar avatar-28 icon">
                              <i data-feather="user"></i>
                            </div>
                            <div class="col text-truncated">
                              <p class="h6 mb-0">About School</p>
                              <p class="small opacity-75">School Details</p>
                            </div>
                          </a></li>
                        <li class="nav-item"><a class="nav-link" aria-current="page" href="{{ route('preview.learning-settings-courses') }}">
                            <div class="avatar avatar-28 icon"><i class="bi bi-people fs-4"></i></div>
                            <div class="col text-truncated">
                              <p class="h6 mb-0">Courses</p>
                              <p class="small opacity-75">School and E-Courses</p>
                            </div>
                          </a></li>
                        <li class="nav-item"><a class="nav-link" aria-current="page" href="{{ route('preview.learning-settings-timing') }}">
                            <div class="avatar avatar-28 icon">
                              <i data-feather="clock"></i>
                            </div>
                            <div class="col text-truncated">
                              <p class="h6 mb-0">School Timing</p>
                              <p class="small opacity-75">Operating hours</p>
                            </div>
                          </a></li>
                        <li class="nav-item"><a class="nav-link" aria-current="page" href="{{ route('preview.learning-settings-payment') }}">
                ...
                <div class="card adminuiux-card shadow-sm overflow-hidden z-index-0 mb-4">
                  <div class="card-body pb-0">
                    ...
                    <div class="row mb-2">
                      <div class="col-12 col-md-6 col-lg-4 col-xl-3">
                        <div class="form-floating mb-3">
                          <input placeholder="First Name" value="LearningUIUX" required="" class="form-control is-valid">
                          <label>School Name</label>
                        </div>
                        <div class="invalid-feedback">Please enter valid input</div>
                      </div>
                      <div class="col-12 col-md-6 col-lg-4 col-xl-3">
                        <div class="form-floating"><input type="email" placeholder="Email Address" value="guest@adminuiux.com" disabled="" required="" class="form-control"> <label>Email Address</label></div>
                      ...
                      <div class="col-12 col-md-6 col-lg-4 col-xl-3">
                        <div class="form-floating mb-3">
                          <input placeholder="Start Date" value="26-04-1982" required="" class="form-control datepicker">
                    ...
                    <div class="row mb-2">
                      <div class="col-12 col-md-6 col-lg-4 col-xl-3">
                        <div class="form-floating mb-3"><input placeholder="Address Line 1" value="" required="" class="form-control"> <label>Address Line 1</label></div>
                        <div class="invalid-feedback">Please enter valid input</div>
                      </div>
                      <div class="col-12 col-md-6 col-lg-4 col-xl-3">
                        <div class="form-floating mb-3"><input type="email" placeholder="Address Line 2" required="" class="form-control"> <label>Address Line 2</label></div>
                        <div class="invalid-feedback mb-3">Add insert valid data</div>
                      </div>
                      <div class="col-12 col-md-6 col-lg-4 col-xl-3">
                        <div class="form-floating mb-3"><input placeholder="Landmark" required="" class="form-control"> <label>Landmark</label></div>
                        <div class="invalid-feedback">Please enter valid input</div>
                      </div>
                      <div class="col-12 col-md-6 col-lg-4 col-xl-3">
                        <div class="form-floating mb-3"><input type="email" placeholder="Street" required="" class="form-control"> <label>Street</label></div>
                        <div class="invalid-feedback mb-3">Add insert valid data</div>
                      </div>
                      <div class="col-12 col-md-6 col-lg-4 col-xl-3">
                        <div class="form-floating mb-3"><input placeholder="Country" value="" required="" class="form-control"> <label>Country</label></div>
                        <div class="invalid-feedback">Please enter valid input</div>
                      </div>
                      <div class="col-12 col-md-6 col-lg-4 col-xl-3">
                        <div class="form-floating mb-3"><input placeholder="Pincode" value="" required="" class="form-control"> <label>Pincode</label></div>
                        <div class="invalid-feedback">Please enter valid input</div>
                      </div>
                      <div class="col-12 col-md-6 col-lg-4 col-xl-3">
                        <div class="form-floating mb-3"><input placeholder="State" value="" required="" class="form-control"> <label>State</label></div>
                        <div class="invalid-feedback">Please enter valid input</div>
                      </div>
                      <div class="col-12 col-md-6 col-lg-4 col-xl-3">
                        <div class="form-floating mb-3"><input placeholder="City" value="" required="" class="form-control is-invalid"> <label>City</label></div>
                        <div class="invalid-feedback">Please enter valid input</div>
                      </div>
                    </div>
                    <h6 class="mb-3">School Description bio</h6>
                    <div class="mb-4">
                      <textarea class="FroalaEditor"></textarea>
                    </div>
                    <div class="row align-items-center">
                      <div class="col">
                        <h6 class="mb-3">Specialized Courses</h6>
                      </div>
                      <div class="col-auto mb-3"><button class="btn btn-link"><i class="bi bi-plus"></i> Add More</button></div>
                    </div>
                    <div class="row mb-2">
                      <div class="col-12 col-md-6 col-lg-4 col-xl-3">
                        <div class="form-floating mb-3">
                          <input placeholder="Course 1" value="Physics" class="form-control">
                          <label>Courses 1</label>
                        </div>
                        <div class="invalid-feedback">Please enter valid input</div>
                      </div>
                      <div class="col-12 col-md-6 col-lg-4 col-xl-3">
                        <div class="form-floating mb-3">
                          <input placeholder="Course 2" value="Chemistry" class="form-control">
                          <label>Courses 2</label>
                        </div>
                        <div class="invalid-feedback">Please enter valid input</div>
                      </div>
                      <div class="col-12 col-md-6 col-lg-4 col-xl-3">
                        <div class="form-floating mb-3">
                          <input placeholder="Course 3" value="Mathematics" class="form-control">
                          <label>Courses 3</label>
                        </div>
                        <div class="invalid-feedback">Please enter valid input</div>
                      </div>
                      <div class="col-12 col-md-6 col-lg-4 col-xl-3">
                        <div class="form-floating mb-3">
                          <input placeholder="Course 4" value="Language" class="form-control">
                          <label>Courses 4</label>
                        </div>
                        <div class="invalid-feedback">Please enter valid input</div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-12 col-md-6 col-lg-4 col-xl-3 mb-3">
                        <div class="form-check form-switch"><input class="form-check-input" type="checkbox" id="profileswitch1" checked=""> <label class="form-check-label" for="profileswitch1">Show profile publicly</label></div>
                      </div>
                      <div class="col-12 col-md-6 col-lg-4 col-xl-3 mb-3">
                        <div class="form-check form-switch"><input class="form-check-input" type="checkbox" id="profileswitch2" checked=""> <label class="form-check-label" for="profileswitch2">Show availability</label></div>
                      </div>
                      <div class="col-12 col-md-6 col-lg-4 col-xl-3 mb-3">
                        <div class="form-check form-switch"><input class="form-check-input" type="checkbox" id="profileswitch3"> <label class="form-check-label" for="profileswitch3">Show tagline in profile</label></div>
                      </div>
                      <div class="col-12 col-md-6 col-lg-4 col-xl-3 mb-3">
                        <div class="form-check form-switch"><input class="form-check-input" type="checkbox" id="profileswitch4"> <label class="form-check-label" for="profileswitch4">Make profile inactive</label></div>
                      </div>
                    </div>
                  </div>
                  <div class="card-footer">
                    <div class="row">
                      ...
                      <div class="col-auto"><button class="btn btn-link theme-red">Cancel</button></div>
                    </div>
                  </div>
                </div>
