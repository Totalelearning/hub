...
<div class="adminuiux-sidebar shadow-sm">
    <div class="adminuiux-sidebar-inner">
        ...
        <div class="px-3 not-iconic">
            ...
            <div class="container mt-4" id="main-content">
                    ...
                    <div class="card adminuiux-card shadow-sm mb-4">
                        <div class="card-body p-0 overflow-x-auto">
                            <ul class="nav nav-pills adminuiux-nav-pills flex-nowrap">
                                ...
                                <li class="nav-item"><a class="nav-link" href="{{ route('preview.learning-settings-courses') }}">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" aria-current="page" href="{{ route('preview.learning-settings-payment') }}">
                ...
                <div class="card adminuiux-card shadow-sm mb-4">
                    <div class="card-body pb-0">
                        ...
                        <div class="swiper swipernav mb-3">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide width-280">
                                    <div class="card adminuiux-card bg-theme-1 w-100 border mb-2 overflow-hidden">
                                        ...
                                        <div class="card-body z-index-1 rounded">
                                            ...
                                            <p class="h5 mb-4"> 000 0000 0001 546598 </p>
                                            <div class="row">
                                                <div class="col-auto">
                                ...
                                <div class="swiper-slide width-280">
                                    <a href="javascript:void(0)" data-bs-target="#addcreditcard" data-bs-toggle="modal" class="text-theme-1 border height-190 w-100 rounded text-center d-flex align-items-center justify-content-center style-none">
                                        <div class="py-4">
                                            <p>
                        ...
                        <h6 class="mb-3">PayPal ID <small class="text-secondary fw-normal">- Provide to receive payouts</small>
                        </h6>
                        <div class="row">
                            ...
                            <div class="col-auto align-self-center">
                                <p class="mb-4 text-success"><i class="bi bi-patch-check me-1"></i> Verified</p>
                            </div>
                        </div>
                    </div>
            ...
            <!-- add credit card  -->
            <div class="modal adminuiux-modal fade" id="addcreditcard" tabindex="-1" aria-labelledby="addcreditcardLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                    <div class="modal-content">
                        <div class="modal-header" id="addcreditcardLabel">
                            <p class="h6">Add Credit Card</p>
                        </div>
                        <div class="modal-body pb-0">
                            <div class="input-group mb-3">
                                <span class="input-group-text"><i class="bi bi-person"></i></span>
                                <div class="form-floating">
                                    <input type="text" placeholder="Card Holder Name" value="Max Johnson" required="" class="form-control">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="input-group mb-3">
                                        ...
                                        <div class="form-floating">
                                            <input type="text" placeholder="Card Number" value="" required="" class="form-control">
                                ...
                                <div class="col-4">
                                    <div class="input-group mb-3">
                                        ...
                                        <div class="form-floating">
                                            <input type="number" placeholder="CVV" value="" required="" class="form-control">
                                            <label>CVV</label>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="modal-footer">
                            <div class="col">
                                <button class="btn btn-theme">Add Card</button>
                            </div>
                            <div class="col-auto">
