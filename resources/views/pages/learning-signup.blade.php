...
</header> <main class="flex-shrink-0 pt-0">
    <div class="container-fluid">
              ...
              <div class="row h-100 align-items-center justify-content-center mt-md-3">
                <div class="col-12 col-sm-8 col-md-11 col-xl-11 col-xxl-10 login-box">
                  ...
                  <div class="row">
                    ...
                    <div class="col">
                      <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="namel" placeholder="Enter last name" value="Doe">
                  ...
                  <a href="{{ route('preview.learning-signup-success') }}" class="btn btn-lg btn-theme w-100 mb-4">Sign up</a>
                  <!-- <button class="btn btn-lg btn-theme w-100 mb-4">Login</button> -->
                  <div class="text-center mb-3"> Already have account? <a href="{{ route('preview.learning-login') }}" class=" ">Login</a> here. </div>
