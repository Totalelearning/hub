<x-layouts.learninguiux>
    <div class="main-bg main-bg-opac sharpcornerui adminuiux-header-standard adminuiux-sidebar-iconic theme-blue adminuiux-header-transparent adminuiux-sidebar-fill-white bg-gradient-1 scrollup"
        ...
        <header class="adminuiux-header">
            <nav class="navbar navbar-expand-lg fixed-top">
                <div class="container-fluid">
                    ...
                    <div class="ms-auto">
                        <button class="btn btn-link btn-square btnsunmoon btn-link-header"
