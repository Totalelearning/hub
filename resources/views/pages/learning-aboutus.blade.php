                                    ...
                                    <div class="col-12 col-md">
                                        ...
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb mb-3 mb-md-0">
                                                ...
                                                <li class="breadcrumb-item active bi" aria-current="page">About School</li>
                                            </ol>
                                        </nav>
                                    </div>
                            ...
                            <div class="container mt-4" id="main-content">
                                    ...
                                    <div class="card-body position-relative py-0">
                                        <div class="row align-items-center">
                                            <div class="col-12 col-md-7 py-4">
                                                <h2 class="mb-2">Learn more<br>with AI-ML Course</h2>
                                                <p class="opacity-75">Get unlimited access to 2000+ learning courses from leading educational university.</p>
                                                <button class="btn btn-light">Create Account</button>
                                                <button class="btn btn-outline-light border-0"><i class="bi bi-play-circle"></i> How it works?</button>
                                            </div>
                                            <div class="col-12 col-md-5 text-center px-0">
                                                <img src="{{ asset('vendor/learninguiux/img/learning/banner-2.png') }}" alt="" class="maxwidth-300 my-3">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row align-items-center mt-5 mb-4">
                                    <div class="col-12 col-md-6 py-4">
                                        <h2>About Us</h2>
                                        <p class="text-secondary">We empower education at it best to deliver<br> good quality of human being.</p>
                                        <p>
                                            <a href="{{ route('preview.learning-courses-in-school') }}" class="btn btn-theme me-1">School courses</a>
                                            <a href="{{ route('preview.learning-courses-part-time') }}" class="btn btn-outline-theme ms-1">Part-Time courses</a>
                                        </p>
                                        <br>
                                        <div class="row">
                                            <div class="col-auto mb-4">
                                                <h2>200K</h2>
                                                <p class="small text-secondary">Students in School</p>
                                            </div>
                                            <div class="col-auto mb-4">
                                                <h2>1.58K</h2>
                                                <p class="small text-secondary">E-Courses Subscriptions</p>
                                            </div>
                                            <div class="col-auto mb-4">
                                                <h2>985</h2>
                                                <p class="small text-secondary">Part-time Students</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="card adminuiux-card shadow-sm text-center mb-4">
                                                    <div class="card-body">
                                                        <div class="avatar avatar-60 h1 text-theme-1 mb-3">
                                                            <i class="bi bi-sunrise"></i>
                                                        </div>
                                                        <h6>Physics</h6>
                                                        <p class="small text-secondary">Lorem ipsum dolor sit amet, consectetur adipiscing elit. </p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-6 col-lg-3">
                                        <div class="card adminuiux-card shadow-sm text-center mb-4">
                                            <div class="card-body">
                                                <div class="w-100 height-180 coverimg rounded">
                                                    <img src="{{ asset('vendor/learninguiux/img/learning/1.jpg') }}" alt="">
                                                </div>
                                                <p class="mt--25 mb-3">
                                                    <i class="bi bi-puzzle avatar avatar-60 h4 rounded-circle shadow bg-theme-1 text-white theme-orange"></i>
                                                </p>
                                                <h5>Best Teaching Environment</h5>
                                    ...
                                    <div class="col-12 col-md-6 col-lg-3">
                                        <div class="card adminuiux-card shadow-sm text-center mb-4">
                                            <div class="card-body">
                                                <div class="w-100 height-180 coverimg rounded">
                                                    <img src="{{ asset('vendor/learninguiux/img/learning/2.jpg') }}" alt="">
                                                </div>
                                                <p class="mt--25 mb-3">
                                                    <i class="bi bi-people avatar avatar-60 h4 rounded-circle shadow bg-theme-1 text-white theme-purple"></i>
                                                </p>
                                                <h5>Parent Orientation Programs</h5>
                                                <p class="small text-secondary">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer cursus blandit dolor, nec rutrum urna facilisis vitae.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6 col-lg-3">
                                        <div class="card adminuiux-card shadow-sm text-center mb-4">
                                            <div class="card-body">
                                                <div class="w-100 height-180 coverimg rounded">
                                                    <img src="{{ asset('vendor/learninguiux/img/learning/3.jpg') }}" alt="">
                                                </div>
                                                <p class="mt--25 mb-3">
                                                    <i class="bi bi-book avatar avatar-60 h4 rounded-circle shadow bg-theme-1 text-white theme-teal"></i>
                                                </p>
                                                <h5>Well Maintained Library</h5>
                                                <p class="small text-secondary">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer cursus blandit dolor, nec rutrum urna facilisis vitae.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6 col-lg-3">
                                        <div class="card adminuiux-card shadow-sm text-center mb-4">
                                            <div class="card-body">
                                                <div class="w-100 height-180 coverimg rounded">
                                                    <img src="{{ asset('vendor/learninguiux/img/learning/4.jpg') }}" alt="">
                                                </div>
                                                <p class="mt--25 mb-3">
                                                    <i class="bi bi-easel avatar avatar-60 h4 rounded-circle shadow bg-theme-1 text-white theme-yellow"></i>
                                                </p>
                                                <h5>World Class Presentation</h5>
                                                <p class="small text-secondary">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer cursus blandit dolor, nec rutrum urna facilisis vitae.</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row justify-content-center text-center py-md-4">
                                            <div class="col-12 col-md-10 col-lg-8">
                                                ...
                                                <p class="opacity-75">Its possible human made mistakes and possibly we may missed it. We are happy to assist you as well as upgrade our system. Do let us know your query, concern and feedback.</p>
                                                <br>
                                                <div class="row">
                                                    <div class="col-12 col-md-6 mb-2">
                                                        <div class="form-group mb-3 position-relative check-valid">
                                                            <div class="input-group input-group-lg"><span class="input-group-text text-theme-1"><i class="bi bi-person"></i></span>
                                                                <div class="form-floating"><input placeholder="First Name" value="Max" required="" class="form-control"> <label>First Name</label></div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-12 col-md-6 mb-2">
                                                        <div class="form-group mb-3 position-relative">
                                                            <div class="input-group input-group-lg"><span class="input-group-text text-theme-1"><i class="bi bi-person"></i></span>
                                                                <div class="form-floating"><input placeholder="Last Name" value="Johnson" required="" class="form-control"> <label>last Name</label></div>
                                                            </div>
                                                        </div>
                                                        <div class="invalid-feedback mb-3">Add valid data</div>
                                                    </div>
                                                    <div class="col-12 col-md-12 mb-2">
                                                        <div class="form-group mb-3 position-relative">
                                                            <div class="input-group input-group-lg"><span class="input-group-text text-theme-1"><i class="bi bi-envelope"></i></span>
                                                                <div class="form-floating"><input type="email" placeholder="Email Address" required="" class="form-control"> <label>Email Address</label></div>
                                                            </div>
                                                        </div>
                                                        <div class="invalid-feedback mb-3">Add valid data</div>
                                                    </div>
                                                    <div class="col-12 col-md-12 mb-2">
                                                        <div class="form-group mb-3 position-relative check-valid">
                                                            <div class="input-group input-group-lg"><span class="input-group-text text-theme-1"><i class="bi bi-chat-right-text"></i></span>
                                                                <div class="form-floating"><textarea placeholder="Message" class="form-control h-auto" rows="4"></textarea> <label>Message</label></div>
                                                            </div>
                                                        </div>
                                                        <div class="invalid-feedback mb-3">Add valid data</div>
                                                    </div>
                                                </div>
                                                <div class="text-center"><button type="button" class="btn btn-theme">Submit Message</button></div>
