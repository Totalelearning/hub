                                    ...
                                    <div class="col-12 col-md-auto">
                                        <div class="row align-items-center">
                                            <div class="col text-md-end order-2 order-md-1">
                                                <h6 class="mb-1">65% Profile Complete</h6>
                                    ...
                                    <div class="card-body pt-4 pb-0">
                                        <div class="tab-content">
                                            ...
                                            <div id="step-31" class="tab-pane px-0 pb-0" role="tabpanel" aria-labelledby="step-31">
                                                <div class="row align-items-center mb-2">
                                                    <div class="col">
                                                        <p class="h6 py-2">Past Education</p>
                                                    </div>
                                                    <div class="col-auto">
                                                        <button class="btn btn-link"><i data-feather="plus"></i> Add Another</button>
                                                    </div>
                                                            ...
                                                            <div class="col col-lg ">
                                                                <div class="row align-items-center">
                                                                    <div class="col-12 col-lg">
                                                                        ...
                                                                        <p>Graduate in Social Science</p>
                                                                    </div>
                                                                    <div class="col col-lg-auto">
                                                                        <p class="text-secondary mb-0">2020-2024</p>
                                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 mb-3">
                                                        <div class="form-floating">
                                                            <input type="text" class="form-control" id="url-1a">
                                                ...
                                                <div class="row">
                                                    <div class="col-12 col-md-6 col-lg col-xl mb-3">
                                                        <div class="form-floating">
                                                            <select class="form-select" id="uni-2a">
                                                                ...
                                                                <option>Post Graduate Courses</option>
                                                            </select>
                                                            <label for="uni-2a">Course Type</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-md-6 col-lg col-xl mb-3">
                                                        <div class="form-floating">
                                                            <select class="form-select" id="course-2a">
                                                                <option>8th Standard</option>
                                                                <option selected>9th Standard</option>
                                                                <option>10th Standard</option>
                                                            </select>
                                                            <label for="course-2a">Course/Degree</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-6 col-sm-5 col-lg-2 col-xl-2 mb-3">
                                                        <div class="form-floating">
                                                            ...
                                                            <label for="start-year-2a">Start Year</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-6 col-sm-5 col-lg-2 col-xl-2 mb-3">
                                                        <div class="form-floating">
                                                            ...
                                                            <label for="end-year-2a">Status</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 mb-3">
                                                        <div class="form-floating">
                                                            <input type="file" class="form-control" id="url-2a">
                                                            <label for="url-2a">Select Credential</label>
                                                        </div>
                                                    </div>
                                                </div>
...
@push('scripts')
<script src="{{ asset('vendor/learninguiux/js/learning/learning-student-add.js') }}"></script>
@endpush
