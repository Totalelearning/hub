                    ...
                    <div class="col-12 col-sm">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item bi"><a href="{{ route('preview.learning-ticket-list') }}">Support Tickets</a></li>
                                <li class="breadcrumb-item active bi" aria-current="page">Create Ticket</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="container mt-4" id="main-content">
                        ...
                        <div class="card adminuiux-card shadow-sm mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="FroalaEditor mb-4">
                                    <h4>This is best interface design template I have ever seen.</h4>
                                    <p>I am really very impressed of work, flexibility, extensibility and elasticity across devices. Its awesome and I really appreciate this.</p>
                                </div>
                                <!-- Tags -->
                                <div class="form-floating mb-4">
                        ...
                        <div class="row ">
                            ...
                            <div class="col-auto">
                                <figure class="avatar avatar-60 rounded coverimg mb-3">
                                    <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/user-6.jpg') }}" alt="">
                                    <button class="btn btn-square btn-theme " onclick="$(this).next().click()">
                ...
                <div class="alert alert-success">
                    <p>
                        ...
                        </span> Please wait... We are creating your ticket, it will be posted in few seconds.
                    </p>
                </div>
                <!-- save and cancel buttons -->
                <div class="row mb-3">
                    <div class="col">
                        <button class="btn btn-theme my-2">Create</button>
                    </div>
                    <div class="col-auto">
                        <button class="btn btn-link theme-red my-2">Cancel</button>
                    </div>
                </div>
                <hr>
                <div class="my-4 text-center">
                    <h1>Still you can check most relevant topics...</h1>
                    <p class="mb-4"> We are happy to assist you as well as upgrade our system. Do let us know your query, concern and feedback.</p>
                </div>
                <div class="row">
                        ...
                        <div class="card adminuiux-card shadow-sm mb-4">
                            <div class="card-body">
                                <div class="row align-items-center mb-4">
                                    <div class="col-auto">
                                        <div class="avatar avatar-40 bg-theme-1-subtle text-theme-accent-1 rounded">
                                            <i class="bi bi-person-circle fs-5"></i>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <p class="h5">Login and Logout</p>
                                    </div>
                                </div>
                        ...
                        <div class="card adminuiux-card shadow-sm mb-4">
                            <div class="card-body">
                                <div class="row align-items-center mb-4">
                                    ...
                                    <div class="col">
                                        <p class="h5">Customization &amp; Settings</p>
                                    </div>
                                </div>
                                <div class="list-group adminuiux-list-group list-group-flush">
                        ...
                        <div class="card adminuiux-card shadow-sm mb-4">
                            <div class="card-body">
                                <div class="row align-items-center mb-4">
                                    ...
                                    <div class="col">
                                        <p class="h5">License and Usage</p>
                                    </div>
                                </div>
                                <div class="list-group adminuiux-list-group list-group-flush">
