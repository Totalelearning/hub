                    ...
                    <div class="row gx-2">
                        ...
                        <main class="adminuiux-content has-sidebar" onclick="contentClick()">
                            ...
                            <div class="container-fluid mt-2" id="main-content">
                                <div class="card adminuiux-card height-dynamic position-relative overflow-hidden bg-theme-1" style="--h-dynamic: calc(100vh - 140px)">
                                    <figure class="m-0 position-absolute top-0 start-0 h-100 w-100 coverimg opacity-75">
                                        <img src="{{ asset('vendor/learninguiux/img/learning/error2.jpg') }}" alt="">
                                    </figure>
                                    <div class="card-body z-index-1">
                                        <div class="row justify-content-center text-center h-100">
                                            <div class="col-auto mt-5 pt-lg-4">
                                                <h1 class="fw-bold text-theme-1 theme-red" style="font-size: 100px;">4<i class="bi bi-sign-dead-end mx-2 text-white"></i>4</h1>
                                                <h1 class="mb-3">Something went <b>WRONG</b>!</h1>
                                                <p class="lead">The page doesn't exist or removed.<br>Please check url or we suggest to go back to home.</p>
                                                <br>
                                                <a href="{{ route('preview.learning-dashboard') }}" class="btn btn-theme">Back to home <i class="bi bi-arrow-right"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
