                    ...
                    <div class="col-12 col-md order-1 order-md-1">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-3 mb-md-0">
                                ...
                                <li class="breadcrumb-item active bi" aria-current="page">Students</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="col col-md-auto order-3 order-md-2 mb-md-0">
                        <select class="form-select">
                            <option selected="selected">All Course</option>
                            <option>Standard 1-4</option>
                            <option>Standard 5-8</option>
                            <option>Standard 9-10</option>
                            <option>Standard 11-12</option>
                            <option>Graduation</option>
                        </select>
                    </div>
                    <div class="col-12 col-md-auto order-2 order-md-3 mb-3 mb-md-0">
                        <div class="input-group">
                            <span class="input-group-text text-secondary" id="calendarpciker" onclick="$(this).next().click()">
                                <i data-feather="calendar"></i>
                            </span>
                            <input type="text" class="form-control" id="daterangepickerranges">
                        </div>
                    </div>
                    <div class="col-auto col-md-auto order-4 mb-md-0">
                        <a href="{{ route('preview.learning-add-student') }}" class="btn btn-theme">
                            <i data-feather="plus"></i> Add Student </a>
                    </div>
                </div>
            </div>
            <!-- content -->
            <div class="container mt-4" id="main-content">
                <div class="row">
                    ...
                    <div class="col-6 col-md-6 col-lg-3 mb-4">
                        <div class="row align-items-center">
                            <div class="col-auto">
                                <div class="avatar avatar-50 rounded text-theme-1 theme-teal h2">
                                    <i class="bi bi-person-check"></i>
                                </div>
                            </div>
                            <div class="col">
                                <h4 class="mb-1">265</h4>
                                <p class="small opacity-75">Present</p>
                            </div>
                        </div>
                    </div>
                    <!-- attendance summary -->
                    <div class="col-6 col-md-6 col-lg-3 mb-4">
                        <div class="row align-items-center">
                            <div class="col-auto">
                                <div class="avatar avatar-50 rounded text-theme-1 theme-red h2">
                                    <i class="bi bi-person-x"></i>
                                </div>
                            </div>
                            <div class="col">
                                <h4 class="mb-1">15</h4>
                                <p class="small opacity-75">Absent</p>
                            </div>
                        </div>
                    </div>
                    <!-- attendance summary -->
                    <div class="col-6 col-md-6 col-lg-3 mb-4">
                        <div class="row align-items-center">
                            <div class="col-auto">
                                <div class="avatar avatar-50 rounded text-theme-1 theme-orange h2">
                                    <i class="bi bi-door-closed"></i>
                                </div>
                            </div>
                            <div class="col">
                                <h4 class="mb-1">30 </h4>
                                <p class="small text-secondary">In-Campus</p>
                            </div>
                        </div>
                    </div>
                    <!-- attendance summary -->
                    <div class="col-6 col-md-6 col-lg-3 mb-4">
                        <div class="row align-items-center">
                            <div class="col-auto">
                                <div class="avatar avatar-50 rounded text-theme-1 theme-blue h2">
                                    <i class="bi bi-house"></i>
                                </div>
                            </div>
                            <div class="col">
                                <h4 class="mb-1">5</h4>
                                <p class="small text-secondary">On Leave</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-12 col-xl mb-3">
                                                ...
                                                <p class="text-secondary small">
                                                    <span class="text-success">2% <i class="bi bi-caret-up-fill"></i></span> vs last year
                                                </p>
                                            </div>
                                        </div>
                                        <h6>Top Ranker</h6>
                                        <div class="avatar-group mb-3">
                                            <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/user-1-kid.jpg') }}" class="avatar avatar-40 rounded-circle" alt="" data-bs-toggle="tooltip" title="Chia, 89.50%">
                                            <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/user-7-kid.jpg') }}" class="avatar avatar-40 rounded-circle" alt="" data-bs-toggle="tooltip" title="Alex, 89.00%">
                                            <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/user-5-kid.jpg') }}" class="avatar avatar-40 rounded-circle" alt="" data-bs-toggle="tooltip" title="Shivnan, 88.60%">
                                        </div>
                                    </div>
                                    <div class="col text-end">
                                        <div class="row align-items-center">
                                            <div class="col-12 col-xl order-2 order-xl-1 mb-3">
                                                <h6 class="mb-0">Assignments Given</h6>
                                                <p class="text-secondary small"><span class="text-success"><i class="bi bi-check-all"></i> 42</span> Completed</p>
                                            </div>
                                            <div class="col-12 col-xl-auto order-1 order-xl-2 mb-3">
                                                <h1>46</h1>
                                            </div>
                                        </div>
                                        <h6>Top Scorer</h6>
                                        <div class="avatar-group mb-3">
                                            <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/user-3.jpg') }}" class="avatar avatar-40 rounded-circle" alt="" data-bs-toggle="tooltip" title="Kittu, 89.50%">
                                            <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/user-7-kid.jpg') }}" class="avatar avatar-40 rounded-circle" alt="" data-bs-toggle="tooltip" title="Alex, 89.00%">
                                            <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/user-6-kid.jpg') }}" class="avatar avatar-40 rounded-circle" alt="" data-bs-toggle="tooltip" title="Shivnan, 88.60%">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="height-140" style="margin: -5px;">
                        ...
                        <div class="card adminuiux-card shadow-sm">
                            <div class="row gx-0">
                                <div class="col-12 col-lg-5">
                                    <div class="card-header">
                                        <h6>Fees Statistics</h6>
                                    </div>
                                    <div class="card-body pb-0">
                                        <div class="card adminuiux-card bg-theme-1 mb-3">
                                            <div class="card-body">
                                                <p class="text-white mb-0 small">Fees Collected</p>
                                                <h4>$ 65.52k <span class="text-white fs-14"><i class="bi bi-arrow-up-short me-1"></i> 18.5%</span></h4>
                                            </div>
                                        </div>
                                        <div class="card adminuiux-card bg-theme-1-subtle mb-3">
                                            <div class="card-body">
                                                <p class="text-secondary mb-0 small">Donation Received</p>
                                                <h4>$ 15.51k <span class="text-success fs-14"><i class="bi bi-arrow-up-short me-1"></i> 11.5%</span></h4>
                                            </div>
                                        </div>
                                        <div class="card adminuiux-card bg-theme-1-subtle mb-3">
                                            <div class="card-body">
                                                <p class="text-secondary mb-0 small">Pending Collection</p>
                                                <h4>$ 45.00k</h4>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-3 mb-4">
                        <div class="card adminuiux-card shadow-sm">
                            ...
                            <div class="card-body pb-0">
                                <div class="height-180 text-center position-relative mb-4">
                                ...
                                <div class="row gx-3">
                                    <div class="col-12 mb-3">
                                        <div class="d-flex align-items-center">
                                            <div class="me-2 badge text-bg-success">45%</div>
                                            <div>
                                                <p>9:30am - 10:30am</p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12 mb-3">
                                        <div class="d-flex align-items-center">
                                            <div class="me-2 badge text-bg-warning">30%</div>
                                            <div>
                                                <p>10:31am - 11:30am</p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12 mb-3">
                                        <div class="d-flex align-items-center">
                                            <div class="me-2 badge text-bg-primary">25%</div>
                                            <div>
                                                <p>11:31am - 12:30pm</p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12 mb-3">
                                        <div class="d-flex align-items-center">
                                            <div class="me-2 badge text-bg-secondary">10%</div>
                                            <div>
                                                <p>12:31pm - 1:30pm</p>
                                            </div>
                                        </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-3">
                        <div class="card adminuiux-card shadow-sm mb-4">
                            ...
                            <div class="card-body">
                                <figure class="height-130 w-100 coverimg rounded mb-3">
                                    <img src="{{ asset('vendor/learninguiux/img/background-image/background-image-11.jpg') }}" alt="" style="display: none;">
                                </figure>
                                <h5 class="mb-0">IT Data Modal</h5>
                                <p class="small text-secondary">Prof. John Jackson</p>
                                <div class="row my-3 border-top border-bottom">
                                    <div class="col py-2">
                                        <h5 class="mb-0">1</h5>
                                        <p class="small text-secondary">Year</p>
                                    </div>
                                    <div class="col text-end border-start py-2">
                                        <h5 class="mb-0">$ 300.00</h5>
                                        <p class="small text-secondary">Fees</p>
                                    </div>
                                </div>
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                    ...
                                    <div class="col">
                                        ...
                                        <p class="small text-secondary">Students</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- rank card -->
                    <div class="col-12 col-md-6 col-lg-3 mb-4">
                        <div class="card adminuiux-card shadow-sm position-relative overflow-hidden">
                            <div class="position-absolute top-0 start-0 w-100 h-100 coverimg overlay-gradiant">
                            ...
                            <div class="card-body height-300 mb-2 z-index-1">
                            </div>
                            <div class="card-footer z-index-1">
                                <div class="row align-items-end text-white">
                                    <a href="{{ route('preview.learning-student-profile') }}" class="col style-none text-white">
                                        <h5 class="mb-0">Kittu Johnson <i class="bi bi-arrow-right align-middle"></i></h5>
                                        <p class="small">Class 9<sup>th</sup>, Grade A+</p>
                                    </a>
                                    <div class="col-auto text-end">
                                        <h2 class="mb-1">88<small class="fs-14">%</small></h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <!-- student rank summary -->
                    <div class="col-12 col-md-6 col-lg-3">
                        <div class="row">
                            <div class="col-6 mb-4">
                                <div class="card adminuiux-card shadow-sm position-relative overflow-hidden mb-4">
                                    <div class="position-absolute top-0 start-0 w-100 h-100 coverimg overlay-gradiant">
                                        <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/user-6-kid.jpg') }}" alt="">
                                    </div>
                                    <div class="card-header z-index-1">
                                        <div class="row align-items-center">
                                            <div class="col mb-3 mb-lg-0">
                                    ...
                                    <div class="card-body height-50 mb-1 z-index-1">
                                    </div>
                                    <div class="card-footer text-white z-index-1">
                                        <h5 class="mb-1">84.60<small class="fs-14">.56%</small></h5>
                                        <a href="{{ route('preview.learning-student-profile') }}" class="style-none text-white">
                                            <p class="mb-0 text-truncated">Ariana Gill</p>
                                            <p class="small">10<sup>th</sup>, Grade A+</p>
                                        </a>
                                    </div>
                                </div>
                                <div class="card adminuiux-card shadow-sm bg-theme-accent-1 theme ">
                                    <div class="card-body height-130 mb-2 position-relative">
                                        <h4 class="mb-0">26</h4>
                                        <p class="opacity-75 mb-3">Students in 75-80% range</p>
                                    </div>
                                    <div class="card-footer text-white z-index-1">
                                        <p class="text-truncated small mb-0">11 Students</p>
                                        <p class="text-truncated opacity-75 fs-12 mb-0">in 12<sup>th</sup> Standard</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6 mb-4">
                                <div class="card adminuiux-card shadow-sm bg-theme-1 mb-4">
                                    <div class="card-body height-130 mb-1 position-relative">
                                        <h4 class="mb-0">12</h4>
                                        <p class="opacity-75 mb-3">Students above 80%</p>
                                    </div>
                                    <div class="card-footer text-white z-index-1">
                                        <p class="text-truncated small mb-0">10 Student</p>
                                        <p class="text-truncated opacity-75 fs-12 mb-0">in 10<sup>th</sup> Standard</p>
                                    </div>
                                </div>
                                <div class="card adminuiux-card shadow-sm position-relative overflow-hidden">
                                    <div class="position-absolute top-0 start-0 w-100 h-100 coverimg overlay-gradiant">
                                        <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/user-1-kid.jpg') }}" alt="">
                                    </div>
                                    <div class="card-header z-index-1">
                                        <div class="row align-items-center">
                                            <div class="col mb-3 mb-lg-0">
                                    ...
                                    <div class="card-body height-50 mb-2 z-index-1">
                                    </div>
                                    <div class="card-footer text-white z-index-1">
                                        <h5 class="mb-1">82.50<small class="fs-14">.89%</small></h5>
                                        <a href="{{ route('preview.learning-student-profile') }}" class="style-none text-white">
                                            <p class="mb-0 text-truncated">Jenelia Smith</p>
                                            <p class="small">10<sup>th</sup>, Grade A+</p>
                                        </a>
                                    </div>
                                </div>
                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col order-1 mb-2 mb-md-0">
                                <h6 class="text-truncated">Student Attendance Statistics</h6>
                            </div>
                            <div class="col-6 col-md-auto order-3 order-md-2">
                                <div class="input-group input-group-sm">
                                    ...
                                    <input class="form-control" type="search" placeholder="Search here..." id="searchglobal2">
                                </div>
                            </div>
                            ...
                            <div class="col-auto order-2 order-md-4 mb-2 mb-md-0"><button class="btn btn-sm btn-square btn-link"><i class="bi bi-arrow-clockwise"></i></button></div>
                        </div>
                    </div>
                        ...
                        <table class="table mb-0" data-show-toggle="true" id="dataTable">
                            <thead>
                                <tr>
                                    ...
                                    <th class="desktop">Last Grade</th>
                                    <th class="tablet desktop">Attendance</th>
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <a href="{{ route('preview.learning-student-profile') }}" class="row gx-3 style-none align-items-center">
                                            <div class="col-auto">
                                            ...
                                            <div class="col">
                                                <h6 class="mb-0">Jenelia Smith <i class="bi bi-star-fill text-theme-1 theme-yellow"></i></h6>
                                                <p class="text-secondary small">16 year, A+</p>
                                            </div>
                                        </a>
                                    </td>
                                    <td>
                                        <p class="mb-0">10<sup>th</sup> Standard</p>
                                        <p class="small text-secondary">Regular Course</p>
                                    </td>
                                    <td>
                                        <p class="mb-0">88.50%, A+ Grade</p>
                                        <p class="small text-secondary">9<sup>th</sup> Standard</p>
                                    </td>
                                    <td>
                                        <p class="mb-0">25 Days</p>
                                        <p class="small text-secondary">1 day absent</p>
                                    </td>
                                    <td>
                                        <div class="badge badge-light bg-theme-1-subtle text-theme-1 theme-red">Unpaid</div>
                                        <button class="btn btn-sm btn-square btn-outline-theme rounded-circle"><i class="bi bi-cash-stack"></i></button>
                                    </td>
                                    <td>
                                        <div class="dropdown d-inline-block">
                                            <a class="btn btn-sm btn-link btn-square no-caret" data-bs-toggle="dropdown"><i class="bi bi-three-dots"></i></a>
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li><a class="dropdown-item" href="javascript:void(0)">Add Attendance</a></li>
                                ...
                                <tr>
                                    <td>
                                        <a href="{{ route('preview.learning-student-profile') }}" class="row gx-3 style-none align-items-center">
                                            ...
                                            <div class="col">
                                                <h6 class="mb-0">Kittu Johnson <i class="bi bi-star-fill text-theme-1 theme-yellow"></i></h6>
                                                <p class="text-secondary small">15 Years, A</p>
                                            </div>
                                        </a>
                                    </td>
                                    <td>
                                        <p class="mb-0">9<sup>th</sup> Standard</p>
                                        <p class="small text-secondary">Regular Course</p>
                                    </td>
                                    <td>
                                        <p class="mb-0">84.35%, A+ Grade</p>
                                        <p class="small text-secondary">8<sup>th</sup> Standard</p>
                                    </td>
                                    <td>
                                        <p class="mb-0">24 Days</p>
                                        <p class="small text-secondary">2 day absent</p>
                                    </td>
                                    <td>
                                        <div class="badge badge-light bg-theme-1-subtle text-theme-1 theme-green">Paid</div>
                                    </td>
                                    <td>
                                        <div class="dropdown d-inline-block">
                                            <a class="btn btn-sm btn-link btn-square no-caret" data-bs-toggle="dropdown"><i class="bi bi-three-dots"></i></a>
                                ...
                                <tr>
                                    <td>
                                        <a href="{{ route('preview.learning-student-profile') }}" class="row gx-3 style-none align-items-center">
                                            <div class="col-auto">
                                                <div class="avatar avatar-40 coverimg rounded">
                                                    <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/user-7-kid.jpg') }}" alt="">
                                                </div>
                                            </div>
                                            <div class="col">
                                                <h6 class="mb-0">Will Smith</h6>
                                                <p class="text-secondary small">14 Years, A+</p>
                                            </div>
                                        </a>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <a href="{{ route('preview.learning-student-profile') }}" class="row gx-3 style-none align-items-center">
                                            ...
                                            <div class="col">
                                                <h6 class="mb-0">Ariana Gill <i class="bi bi-star-fill text-theme-1 theme-red"></i></h6>
                                                <p class="text-secondary small">16 Years, A</p>
                                            </div>
                                        </a>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <a href="{{ route('preview.learning-student-profile') }}" class="row gx-3 style-none align-items-center">
                                            <div class="col-auto">
                                                <div class="avatar avatar-40 coverimg rounded">
                                                    <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/user-5-kid.jpg') }}" alt="">
                                                </div>
                                            </div>
                                            <div class="col">
                                                <h6 class="mb-0">Awilly Mongia</h6>
                                                <p class="text-secondary small">12 Years, B+</p>
                                            </div>
                                        </a>
                                    </td>
                                    <td>
                                        <p class="mb-0">3<sup>rd</sup> Standard</p>
                                        <p class="small text-secondary">Regular Course</p>
                                    </td>
                                    <td>
                                        <p class="mb-0">89.78%, A+ Grade</p>
                                        <p class="small text-secondary">2<sup>nd</sup> Standard</p>
                                    </td>
                                    <td>
                                        <p class="mb-0">20 Days</p>
                                        <p class="small text-secondary">5 day absent</p>
                                    </td>
                                    <td>
                                        <div class="badge badge-light bg-theme-1-subtle text-theme-1 theme-green">Paid</div>
                                    </td>
...
@push('scripts')
<script src="{{ asset('vendor/learninguiux/js/learning/learning-student-home.js') }}"></script>
@endpush
