                    ...
                    <div class="row gx-2">
                        ...
                        <main class="adminuiux-content has-sidebar" onclick="contentClick()">
                                    ...
                                    <div class="col-12 col-md">
                                        ...
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb mb-3 mb-md-0">
                                                ...
                                                <li class="breadcrumb-item bi"><a href="{{ route('preview.learning-courses-e-courses') }}">Courses</a></li>
                            ...
                            <div class="container mt-4" id="main-content">
                                <div class="row">
                                    <div class="col-12 col-md-8">
                                        ...
                                        <div class="card adminuiux-card bg-theme-1-subtle mb-4">
                                            <div class="card-body">
                                                <h4 class="mb-3 text-truncated">UX Research and Wireframing in industry </h4>
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-auto mb-3 mb-sm-0">
                                                        <h6 class="mb-0">Kim San</h6>
                                                        <p class="small text-secondary">ME, M.Tech, San Diago</p>
                                                    </div>
                                                    <div class="col-auto mb-3 mb-sm-0">
                                                        <button class="btn btn-sm btn-outline-theme">Follow</button>
                                                    </div>
                                                    <div class="col-12 col-sm-auto ms-auto mb-sm-0">
                                                        <span class="badge badge-light text-bg-theme-1 theme-red ms-1 my-1">
                                                            <i class="bi bi-person me-1"></i> 5000
                                                        </span>
                                                        <span class="badge badge-light text-bg-theme-1 theme-orange ms-1 my-1">
                                                            <i class="bi bi-eye me-1"></i> 2501
                                                        </span>
                                                        <span class="badge badge-light text-bg-theme-1 theme-green ms-1 my-1">
                                                            <i class="bi bi-hand-thumbs-up me-1"></i> 1500
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <iframe class="height-400 w-100 rounded mb-2 border-0" src="https://www.youtube.com/embed/2uhJ75NcKsA?si=A76A0A7mVe5ENw_c" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                                        <p class="small text-secondary mb-4">* This is YouTube sample video embed link</p>
                                                    ...
                                                    <ul class="nav nav-pills adminuiux-nav-pills flex-nowrap" id="list-example">
                                                        ...
                                                        <li class="nav-item">
                                                            <a class="nav-link" href="#review">
                                                                ...
                                                                <div class="col text-truncated">
                                                                    <p class="h6 mb-0">Reviews <span class="badge text-bg-theme-1 ms-1">256</span></p>
                                                                </div>
                                                            </a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a class="nav-link" href="#discussion">
                                                                ...
                                                                <div class="col text-truncated">
                                                                    <p class="h6 mb-0">Discussion <span class="badge text-bg-theme-1 ms-1">115</span></p>
                                                                </div>
                                                            </a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a class="nav-link" href="#projectsnresources">
                                                                <div class="avatar avatar-28 icon"><i class="bi bi-folder2 fs-4"></i></div>
                                                                <div class="col text-truncated">
                                        ...
                                        <div class="card adminuiux-card shadow-sm mb-4" id="description">
                                            ...
                                            <div class="card-body">
                                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In malesuada erat vel semper imperdiet. Pellentesque porttitor egestas sem ac suscipit. Suspendisse nec porta nisl, vitae ornare augue. Phasellus tempus varius tellus facilisis blandit. Nulla vel lobortis lectus, at tincidunt diam. Etiam pellentesque nisi quis nisi fermentum, scelerisque aliquam sem tempor. Aliquam erat ante, auctor quis tortor ut, aliquam sollicitudin libero. Praesent vel
                                                    tincidunt nisi. Interdum et malesuada fames ac ante ipsum primis in faucibus. Praesent arcu augue, consectetur ac scelerisque nec, pellentesque sit amet nisi. In eros purus, interdum tristique lorem at, placerat scelerisque nulla. Curabitur luctus turpis non cursus aliquet. Nunc eu tortor a elit congue facilisis vitae nec eros.</p>
                                                <p>Morbi tincidunt nibh eros. Vivamus ac justo eu est molestie ornare at in nunc. Mauris condimentum nunc odio, in faucibus quam maximus quis. Aenean sit amet malesuada nunc. Aliquam ultrices feugiat velit. Nullam varius iaculis purus id eleifend. Nam vel sollicitudin velit, mollis fringilla nibh. Duis vel condimentum ante, in sodales elit. Duis at diam ullamcorper, aliquam ex nec, semper odio. Phasellus lectus turpis, vestibulum a lorem nec,
                                                    sodales dapibus velit. Etiam nec sollicitudin ante, ut dictum lacus. Ut at varius tellus, et ultricies felis. Praesent eu augue egestas, lobortis lacus eu, euismod arcu.</p>
                                                <div class="collapse mb-3" id="collapse-content">
                                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In malesuada erat vel semper imperdiet. Pellentesque porttitor egestas sem ac suscipit. Suspendisse nec porta nisl, vitae ornare augue. Phasellus tempus varius tellus facilisis blandit. Nulla vel lobortis lectus, at tincidunt diam. Etiam pellentesque nisi quis nisi fermentum, scelerisque aliquam sem tempor. Aliquam erat ante, auctor quis tortor ut, aliquam sollicitudin libero. Praesent
                                                        vel tincidunt nisi. Interdum et malesuada fames ac ante ipsum primis in faucibus. Praesent arcu augue, consectetur ac scelerisque nec, pellentesque sit amet nisi. In eros purus, interdum tristique lorem at, placerat scelerisque nulla. Curabitur luctus turpis non cursus aliquet. Nunc eu tortor a elit congue facilisis vitae nec eros.</p>
                                                </div>
                                                <button class="btn btn-sm btn-link" data-bs-toggle="collapse" data-bs-target="#collapse-content" aria-expanded="false" aria-controls="collapse-content">Read more</button>
                                            </div>
                                        </div>

                                        <div class="card adminuiux-card shadow-sm mb-4" id="review">
                                            <div class="card-header">
                                                <div class="row align-items-center">
                                                    <div class="col">
                                                        <h6>Reviews</h6>
                                                    ...
                                                    <div class="col-auto">
                                                        <button class="btn btn-sm btn-link">View All <i class="bi bi-arrow-right"></i></button>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="card-body pb-0">
                                                <h4 class="mb-4">
                                                    ...
                                                    <br>
                                                    4.5 <span class="fw-normal small text-secondary mx-2">(256)</span>
                                                </h4>
                                                <div class="swiper swipernav z-index-0">
                                                    <div class="swiper-wrapper">
                                                        <div class="swiper-slide width-350 mb-3">
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    <i class="bi bi-quote h4 me-1 lh-20"></i>
                                                                    <p>
                                                                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. In malesuada erat vel semper imperdiet. Pellentesque porttitor egestas sem ac suscipit.
                                                                    </p>
                                                                    <br>
                                                                    <div class="row align-items-center">
                                                                        <div class="col-auto mb-3 mb-sm-0">
                                                                        ...
                                                                        <div class="col-auto mb-3 mb-sm-0">
                                                                            <h5 class="mb-0">Juliet</h5>
                                                                            <p class="small text-secondary">12<sup>th</sup> Student, California</p>
                                                                        </div>
                                                            ...
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="row align-items-center">
                                                                        ...
                                                                        <div class="col-auto mb-3 mb-sm-0">
                                                                            <h5 class="mb-0">Sazam</h5>
                                                                            <p class="small text-secondary">Graphic Designer, California</p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="row align-items-center">
                                                                        ...
                                                                        <div class="col-auto mb-3 mb-sm-0">
                                                                            <h5 class="mb-0">Salena</h5>
                                                                            <p class="small text-secondary">11<sup>th</sup> Student, California</p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="card mb-4">
                                                    <div class="card-body">
                                                        <div class="row align-items-center mb-3">
                                                            <div class="col">
                                                                <h5><a href="" class="style-none text-theme-1">How to create admin dashboard for Investment and Finance </a> </h5>
                                                            </div>
                                                            <div class="col-auto">
                                                                <div class="dropdown">
                                                                    <button class="btn btn-link btn-square btn-sm text-secondary dropdown-toggle no-caret" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                        ...
                                                        <div class="row align-items-center mb-3">
                                                            <div class="col-auto">
                                                                <figure class="avatar avatar-40 rounded coverimg align-middle">
                                                                    <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/user-4.jpg') }}" alt="" style="display: none;">
                                                                </figure>
                                                            </div>
                                                            <div class="col px-0">
                                                            ...
                                                            <div class="col-auto">
                                                                <span class="badge badge-light text-bg-theme-1 theme-green">Answered</span>
                                                                <span class="badge badge-light text-bg-theme-1 theme-red">Closed</span>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <p>
                                                            <span class="badge badge-light bg-pink-subtle text-pink-emphasis me-1 mt-1">User Interface</span>
                                                            <span class="badge badge-light bg-orange-subtle text-orange-emphasis me-1 mt-1">User Experience</span>
                                                        </p>
                                                    </div>
                                                    <div class="card-body">
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col-auto d-none d-lg-block">
                                                                <div class="avatar avatar-40 coverimg rounded me-1">
                                                                    <img src="{{ asset('vendor/learninguiux/img//modern-ai-image/user-5.jpg') }}" alt="">
                                                                </div>
                                                                <div class="avatar avatar-40 coverimg rounded me-1">
                                                                    <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/user-7.jpg') }}" alt="">
                                                                </div>
                                                                <div class="avatar avatar-40 coverimg rounded me-1">
                                                                    <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/user-2.jpg') }}" alt="">
                                                                </div>
                                                            ...
                                                            <div class="col-auto">
                                                                <a class="btn btn-outline-theme" data-bs-toggle="collapse" href="#comment1" role="button" aria-expanded="false" aria-controls="comment1">Answer</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="collapse" id="comment1">
                                                        <div class="card-body border-top">
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-auto"><a class="btn btn-link theme-red" data-bs-toggle="collapse" href="#comment1" role="button" aria-expanded="true" aria-controls="comment1">Cancel</a>
                                                                </div>
                                                            </div>
                                                            <hr>
                                                            <!-- answer per user -->
                                                            <div class="card adminuiux-card bg-success-subtle mb-1">
                                                                <div class="card-body">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col ps-0">
                                                                            <p>
                                                                                <a href="" class="h6 style-none">Jack Lee</a><br>
                                                                                <span class="text-secondary d-inline-block small">2 min ago</span>
                                                                            </p>
                                                                            <p><span class="badge badge-light bg-success text-white">Correct Answer</span></p>
                                                                            <p class="text-secondary">I found a solution to your problem. The installer works fine once I removed it out of my cluttered download folder<br>
                                                                                I ran various tests and I'm pretty sure that i found the root to the problem. You can easily find template for UI with best customize facility named "GetAdminuiux". Adminuiux just right template for all your need flexible, adoptable and elastic bootstrap based HTML template. ever When you get older many people will listen you carefully, no matter if its correct discussion or not.
                                                                            </p>
                                                                        </div>
                                                                        <div class="col-auto">
                                                                            <div class="dropdown">
                                                                                <button class="btn btn-link dropdown-toggle no-caret" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                                                    <i class="bi bi-three-dots-vertical align-middle"></i>
                                                                                </button>
                                                            ...
                                                            <!-- answer per user -->
                                                            <div class="card adminuiux-card mb-1">
                                                                <div class="card-body">
                                                                    <div class="row">
                                                                        <a href="" class="col-auto">
                                                                            <figure class="avatar avatar-40 coverimg rounded">
                                                                        ...
                                                                        <div class="col ps-0">
                                                                            <p>
                                                                                <a href="" class="style-none">Silva D'souza</a><br>
                                                                                <span class="text-secondary d-inline-block small">5 min ago</span>
                                                                            </p>
                                                                            <p class="text-secondary">I'll be back on this soon
                                                                            </p>
                                                                        </div>
                                                                        <div class="col-auto">
                                                                            <div class="dropdown">
                                        ...
                                        <div class="card adminuiux-card shadow-sm mb-4" id="projectsnresources">
                                            <div class="card-header">
                                                <div class="row align-items-center">
                                                    <div class="col">
                                                        <h6>Resources</h6>
                                                    ...
                                                    <div class="col-auto">
                                                        <button class="btn btn-link btn-sm" onclick="$(this).next().click();">Upload File <i class="bi bi-cloud-arrow-up"></i></button>
                                                ...
                                                <div class="row gx-2 mb-3">
                                                    <div class="col-auto">
                                                        <div class="avatar avatar-80 rounded coverimg hover mb-2">
                                                            <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/user-1.jpg') }}" alt="">
                                                            <div class="overlay">
                                                                <button class="btn btn-square btn-light text-danger"><i class="bi bi-trash"></i></button>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-auto">
                                                        <div class="avatar avatar-80 rounded coverimg hover mb-2">
                                                            <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/modern-bg-3.jpg') }}" alt="">
                                                            <div class="overlay">
                                                                <button class="btn btn-square btn-light text-danger"><i class="bi bi-trash"></i></button>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-auto">
                                                        <div class="avatar avatar-80 rounded coverimg hover mb-2">
                                                            <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/modern-bg-1.jpg') }}" alt="">
                                                            <div class="overlay">
                                                                <button class="btn btn-square btn-light text-danger"><i class="bi bi-trash"></i></button>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-auto">
                                                        <div class="avatar avatar-70 bg-danger text-white rounded hover mb-2 position-relative">
                                                    ...
                                                    <div class="col-auto">
                                                        <div class="avatar avatar-70 rounded bg-success text-white hover mb-2">
                                                            <i class="bi bi-filetype-xls h1"></i>
                                                            <div class="overlay">
                                                                <button class="btn btn-square btn-light text-danger">
                                                                    <i class="bi bi-trash"></i>
                                                                </button>
                                    ...
                                    <div class="col-12 col-md-4">
                                        ...
                                        <div class="card adminuiux-card shadow-sm mb-4">
                                            <div class="card-header">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-auto">
                                                        <h5 class="text-theme-1">30%</h5>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="progress w-100 height-dynamic rounded-0" style="--h-dynamic: 5px" role="progressbar" aria-label="Basic example" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100">
                                                <div class="progress-bar progress-bar-striped bg-theme-1" style="width: 30%"></div>
                                            </div>
                                            <div class="card-body pb-0 overflow-y-auto height-dynamic" style="--h-dynamic: 500px">
                                                <!-- chapters -->
                                                <div class="row">
                                                    <div class="col-auto mb-3">
                                                        <div class="avatar avatar-40 rounded bg-theme-1">
                                                            <h5>01</h5>
                                                        </div>
                                                    </div>
                                                    <div class="col mb-3">
                                                        <div class="card adminuiux-card bg-theme-1">
                                                            <div class="card-body">
                                                                <div class="row mb-2">
                                                                    <div class="col">
                                                                        <h6>Introduction</h6>
                                                                        <p class="small opacity-75">The basic information about user and user experience</p>
                                                                    </div>
                                                                    <div class="col-auto">
                                                                        <div class="btn btn-square rounded-circle btn-outline-light">
                                                                            <i class="bi bi-pause h5"></i>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="row mb-2">
                                                                    <div class="col">
                                                                        <p class="small opacity-50">0:45min</p>
                                                                    </div>
                                                                    <div class="col-auto">
                                                                        <p class="small opacity-50">10:00min</p>
                                                                    </div>
                                                                </div>
                                                                <div class="progress w-100 height-dynamic bg-white-opacity rounded-0" style="--h-dynamic: 5px" role="progressbar" aria-label="Basic example" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100">
                                                                    <div class="progress-bar progress-bar-striped bg-white" style="width: 30%"></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-auto mb-3">
                                                        <div class="avatar avatar-40 rounded border">
                                                            <h5>02</h5>
                                                        </div>
                                                    </div>
                                                    <div class="col mb-3">
                                                        <div class="card ">
                                                            <div class="card-body ">
                                                                <div class="row mb-2">
                                                                    <div class="col">
                                                                        <h6>Working with Tools</h6>
                                                                        <p class="small opacity-75">The basic information about user and user experience</p>
                                                                    </div>
                                                                    <div class="col-auto">
                                                                        <div class="btn btn-square rounded-circle btn-link">
                                                                            <i class="bi bi-play h5"></i>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="row mb-2">
                                                                    <div class="col">
                                                                        <p class="small opacity-50">2:30min</p>
                                                                    </div>
                                                                    <div class="col-auto">
                                                                        <p class="small opacity-50">10:00min</p>
                                                                    </div>
                                                                ...
                                                                <div class="progress w-100 height-dynamic  rounded-0" style="--h-dynamic: 5px" role="progressbar" aria-label="Basic example" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100">
                                                                    <div class="progress-bar progress-bar-striped bg-theme-1" style="width: 25%"></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="card ">
                                                            <div class="card-body ">
                                                                <div class="row mb-2">
                                                                    <div class="col">
                                                                        <h6>Assignment</h6>
                                                                        <p class="small opacity-75">Test your knowledge</p>
                                                                    </div>
                                                                    <div class="col-auto">
                                                                        <div class="btn btn-square rounded-circle btn-link theme-red">
                                                                            <i class="bi bi-lock h5"></i>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="row mb-2">
                                                                    <div class="col">
                                                                        <p class="small opacity-50">00:00min</p>
                                                                    </div>
                                                                    <div class="col-auto">
                                                                        <p class="small opacity-50">30:00min</p>
                                                                    </div>
                                                                </div>
                                                                <div class="progress w-100 height-dynamic  rounded-0" style="--h-dynamic: 5px" role="progressbar" aria-label="Basic example" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100">
                                                                    <div class="progress-bar progress-bar-striped bg-theme-1" style="width: 1%"></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <!-- switch by and course status if subscribed -->
                                        ...
                                        <div class="card adminuiux-card shadow-sm bg-theme-1 overflow-hidden position-relative mb-4">
                                            ...
                                            <div class="card-header">
                                                <h4 class="fw-normal">Total 5 Lessons</h4>
                                            </div>
                                            <div class="card-body">
                                                ...
                                                <div class="row align-items-center">
                                                    <div class="col">
                                                        <h4>$ 25.00<small class="opacity-50 fw-normal">/Year</small></h4>
                                                    </div>
                                                    <div class="col-auto">
                                                        <button class="btn btn-light">Enrol me Now</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="text-center mb-4">
                                            <a href="{{ route('preview.learning-dashboard') }}" class="btn btn-square btn-link rounded-circle" data-toggle="tooltip" title="Dashboard"><i class="bi bi-house"></i></a>
                                        ...
                                        <!-- re-commendations -->
                                        <h6 class="mb-3">Course Recommendations</h6>
                                        <div class="card adminuiux-card shadow-sm mb-4">
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-3">
                                                        <div class="height-110 w-100 rounded coverimg position-relative">
                                                            <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/user-5.jpg') }}" alt="">
                                                        </div>
                                                    </div>
                                                    <div class="col-9">
                                                        <a href="{{ route('preview.learning-course-details') }}" class="style-none d-block mb-3">
                                                        ...
                                                        <div class="row align-items-center">
                                                            <div class="col">
                                                                <h5 class="mb-1">$ 75.00 <s class="opacity-50 fs-14">$ 110.00</s></h5>
                                                                <p class="small text-secondary"><b>4.5</b>
                                                                    <i class="bi bi-star-fill small text-warning"></i>
                                                                    <i class="bi bi-star-fill small text-warning"></i>
                                                                    <i class="bi bi-star-fill small text-warning"></i>
                                                                    <i class="bi bi-star-fill small text-warning"></i>
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-9">
                                                        ...
                                                        <div class="row align-items-center">
                                                            <div class="col">
                                                                <h5 class="mb-1">$ 80.00 <s class="opacity-50 fs-14">$ 125.00</s></h5>
                                                                <p class="small text-secondary"><b>4.5</b>
                                                                    <i class="bi bi-star-fill small text-warning"></i>
                                                                    <i class="bi bi-star-fill small text-warning"></i>
                                                                    <i class="bi bi-star-fill small text-warning"></i>
                                ...
                                <h5 class="mb-2">Top courses in Development</h5>
                                ...
                                <div class="swiper swipernavpagination mb-3">
                                    <div class="swiper-wrapper mb-3">
                                        <div class="swiper-slide width-250">
                                            <div class="card adminuiux-card shadow-sm mb-4">
                                                <div class="card-header">
                                                    <a href="{{ route('preview.learning-course-details') }}" class="style-none">
                                                ...
                                                <div class="card-body pt-0 position-relative">
                                                    ...
                                                    <div class="row align-items-center mb-2">
                                                        <div class="col">
                                                            <h5 class="mb-0">$ 115.00 <s class="opacity-50 fs-14">$ 150.00</s></h5>
                                                            <p class="text-secondary">
                                                                <i class="bi bi-star-fill small text-warning"></i> <b>4.0</b>
                                                                <small class="text-secondary">(251 Reviews)</small>
                                                            </p>
                                                        </div>
                                                        <div class="col-auto">
                                                    ...
                                                    <div class="row align-items-center">
                                                        <div class="col">
                                                            <button class="btn btn-sm btn-square btn-outline-theme rounded-circle theme-red me-1"><i class="bi bi-heart"></i></button>
                                                            <button class="btn btn-sm btn-square btn-outline-theme rounded-circle theme-skyblue me-1"><i class="bi bi-arrow-90deg-right"></i></button>
                                                        </div>
                                                        <div class="col-auto">
                                                            <button class="btn btn-link btn-square rounded-circle">
                                                                <i class="bi bi-cart"></i>
                                        ...
                                        <div class="swiper-slide width-250">
                                            <div class="card adminuiux-card shadow-sm mb-4">
                                                ...
                                                <div class="card-body pt-0 position-relative">
                                                    ...
                                                    <div class="row align-items-center mb-2">
                                                        <div class="col">
                                                            <h5 class="mb-0">$ 80.00 <s class="opacity-50 fs-14">$ 120.00</s></h5>
                                                            <p class="text-secondary">
                                                                <i class="bi bi-star-fill small text-warning"></i> <b>5.0</b>
                                                                <small class="text-secondary">(315 Reviews)</small>
                                                            </p>
                                                        </div>
                                                        <div class="col-auto">
                                        ...
                                        <div class="swiper-slide width-250">
                                            <div class="card adminuiux-card shadow-sm mb-4">
                                                ...
                                                <div class="card-body pt-0 position-relative">
                                                    ...
                                                    <div class="row align-items-center mb-2">
                                                        <div class="col">
                                                            <h5 class="mb-0">$ 90.00 <s class="opacity-50 fs-14">$ 150.00</s></h5>
                                                            <p class="text-secondary">
                                                                <i class="bi bi-star-fill small text-warning"></i> <b>4.0</b>
                                                                <small class="text-secondary">(352 Reviews)</small>
                                                            </p>
                                                        </div>
                                                        <div class="col-auto">
                                        ...
                                        <div class="swiper-slide width-250">
                                            <div class="card adminuiux-card shadow-sm mb-4">
                                                ...
                                                <div class="card-body pt-0 position-relative">
                                                    ...
                                                    <div class="row align-items-center mb-2">
                                                        <div class="col">
                                                            <h5 class="mb-0">$ 75.00 <s class="opacity-50 fs-14">$ 110.00</s></h5>
                                                            <p class="text-secondary">
                                                                <i class="bi bi-star-fill small text-warning"></i> <b>4.5</b>
                                                                <small class="text-secondary">(156 Reviews)</small>
                                                            </p>
                                                        </div>
                                                        <div class="col-auto">
                                                    ...
                                                    <div class="row align-items-center">
                                                        <div class="col">
                                                            <button class="btn btn-sm btn-square btn-outline-theme rounded-circle theme-red me-1"><i class="bi bi-heart"></i></button>
                                                            <button class="btn btn-sm btn-square btn-outline-theme rounded-circle theme-skyblue me-1"><i class="bi bi-share"></i></button>
                                                        </div>
                                                        <div class="col-auto">
                                                            <button class="btn btn-link btn-square rounded-circle">
                                                                <i class="bi bi-cart"></i>
                                        ...
                                        <div class="swiper-slide width-250">
                                            <div class="card adminuiux-card shadow-sm mb-4">
                                                ...
                                                <div class="card-body pt-0 position-relative">
                                                    <span class="ribbon bg-theme-1 position-absolute top-0 end-0 z-index-1 mt-3">Trending</span>
                                                    <div class="height-180 w-100 rounded coverimg position-relative mb-3">
