                    ...
                    <div class="row gx-2">
                        ...
                        <main class="adminuiux-content has-sidebar" onclick="contentClick()">
                                    ...
                                    <div class="col-12 col-md">
                                        ...
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb mb-3 mb-md-0">
                                                ...
                                                <li class="breadcrumb-item active bi" aria-current="page">E Courses</li>
                                            </ol>
                                        </nav>
                                    </div>
                            ...
                            <div class="container mt-4" id="main-content">
                                                ...
                                                <div class="card-body py-0 position-relative">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12 col-sm align-self-end">
                                                            <img src="{{ asset('vendor/learninguiux/img/learning/banner.png') }}" alt="" class="mw-100 rounded mt-0 mt-sm-4">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="swiper swipernav">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide width-120">
                                            <div class="card adminuiux-card text-center shadow-sm mb-4">
                                                <div class="card-body">
                                                    <p class="h4 text-theme-1"><i class="bi bi-code-square"></i></p>
                                                    <p class="fs-12 opacity-75 text-truncated">Development</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide width-120">
                                            <div class="card adminuiux-card text-center shadow-sm mb-4">
                                                <div class="card-body">
                                                    <p class="h4 text-theme-1"><i class="bi bi-briefcase"></i></p>
                                                    <p class="fs-12 opacity-75 text-truncated">Business</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide width-120">
                                            <div class="card adminuiux-card text-center shadow-sm mb-4">
                                                <div class="card-body">
                                                    <p class="h4 text-theme-1"><i class="bi bi-cash-coin"></i></p>
                                                    <p class="fs-12 opacity-75 text-truncated">Finance</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide width-120">
                                            <div class="card adminuiux-card text-center shadow-sm mb-4">
                                                <div class="card-body">
                                                    <p class="h4 text-theme-1"><i class="bi bi-bank"></i></p>
                                                    <p class="fs-12 opacity-75 text-truncated">Accounting</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide width-120">
                                            <div class="card adminuiux-card text-center shadow-sm mb-4">
                                                <div class="card-body">
                                                    <p class="h4 text-theme-1"><i class="bi bi-gear-wide-connected"></i></p>
                                                    <p class="fs-12 opacity-75 text-truncated">Productivity</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide width-120">
                                            <div class="card adminuiux-card text-center shadow-sm mb-4">
                                                <div class="card-body">
                                                    <p class="h4 text-theme-1"><i class="bi bi-person-arms-up"></i></p>
                                                    <p class="fs-12 opacity-75 text-truncated">Personal</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide width-120">
                                            <div class="card adminuiux-card text-center shadow-sm mb-4">
                                                <div class="card-body">
                                                    <p class="h4 text-theme-1"><i class="bi bi-palette"></i></p>
                                                    <p class="fs-12 opacity-75 text-truncated">Design</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide width-120">
                                            <div class="card adminuiux-card text-center shadow-sm mb-4">
                                                <div class="card-body">
                                                    <p class="h4 text-theme-1"><i class="bi bi-newspaper"></i></p>
                                                    <p class="fs-12 opacity-75 text-truncated">Marketing</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide width-120">
                                            <div class="card adminuiux-card text-center shadow-sm mb-4">
                                                <div class="card-body">
                                                    <p class="h4 text-theme-1"><i class="bi bi-music-note-beamed"></i></p>
                                                    <p class="fs-12 opacity-75 text-truncated">Music</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide width-120">
                                            <div class="card adminuiux-card text-center shadow-sm mb-4">
                                                <div class="card-body">
                                                    <p class="h4 text-theme-1"><i class="bi bi-motherboard"></i></p>
                                                    <p class="fs-12 opacity-75 text-truncated">IT</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide width-120">
                                            <div class="card adminuiux-card text-center shadow-sm mb-4">
                                                <div class="card-body">
                                                    <p class="h4 text-theme-1"><i class="bi bi-building"></i></p>
                                                    <p class="fs-12 opacity-75 text-truncated">Office</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <h5 class="mb-2">Popular for UX Designers</h5>
