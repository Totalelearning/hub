                    ...
                    <div class="row gx-2">
                        ...
                        <main class="adminuiux-content has-sidebar" onclick="contentClick()">
                            ...
                            <div class="container-fluid mt-2" id="main-content">
                                <div class="card adminuiux-card height-dynamic position-relative overflow-hidden bg-theme-accent-r-gradient" style="--h-dynamic: calc(100vh - 140px)">
                                    <figure class="m-0 position-absolute top-0 start-0 h-100 w-100 coverimg opacity-50">
                                        <img src="{{ asset('vendor/learninguiux/img/learning/error.jpg') }}" alt="">
                                    </figure>
                                    <div class="card-body z-index-1">
                                        <div class="row align-items-center justify-content-center text-center h-100">
                                            <div class="col-auto">
                                                <h1 class="fw-bold mb-2" style="font-size: 100px;">4<i class="bi bi-bug-fill mx-2"></i>4</h1>
                                                <h1 class="display-4 mb-3">Page Not <b class="fw-bold">FOUND</b>!</h1>
                                                <p class="fw-normal h5">The page doesn't exist or removed.<br>Please check url or we suggest to go back to home.</p>
                                                <br>
                                                <a href="{{ route('preview.learning-dashboard') }}" class="btn btn-theme">Back to home <i class="bi bi-arrow-right ms-1"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
