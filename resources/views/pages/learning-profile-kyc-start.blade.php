                    ...
                    <nav aria-label="breadcrumb">
                      <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item bi">
                          <a href="{{ route('preview.learning-dashboard') }}">Home</a>
                        </li>
                ...
                <div class="row justify-content-center">
                  <div class="col-12 col-md-8 col-lg-5">
                    ...
                    <div class="card adminuiux-card shadow-sm overflow-hidden mb-4">
                      <div class="card-body">
                        <div class="card adminuiux-card text-center overflow-hidden mb-4">
                          <div class="card-body coverimg position-relative height-240">
                            <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/user-3.jpg') }}" alt="">
                            <i class="h1 bi bi-check2-circle avatar avatar-50 text-white position-absolute end-0 top-0 m-3 p-2 bg-theme-1 theme-green rounded-circle"></i>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-12 col-md-6">
                            <div class="row gx-3">
                              <div class="col-auto">
                                <span class="avatar avatar-40 rounded bg-theme-1-subtle text-theme-1 h5 mb-3">1</span>
                              </div>
                              <div class="col">
                                <p class="text-secondary small">
                                  You will have to submit your documents to verify your identity.
                                </p>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="col-12 col-md-6">
                            <div class="row gx-3">
                              <div class="col-auto">
                                <span class="avatar avatar-40 rounded bg-theme-1-subtle text-theme-1 h5 mb-3">2</span>
                              </div>
                              <div class="col">
                                <p class="text-secondary small">
                                  Submit and verify your address just by uploading valid address proof.
                                </p>
                              </div>
                            </div>
                          </div>
                        ...
                        <br>
                        <div class="text-center">
                          <a href="{{ route('preview.learning-profile-kyc') }}" class="btn btn-theme">Let's Start KYC <i class="bi bi-arrow-right"></i></a>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="text-center mb-4">
                      <p>
                        If you have any queries, feel free to connect with us at info@adminuiux.coms.
                      </p>
                      <a href="{{ route('preview.learning-help-center') }}">Need more help?</a>
                    </div>
                  </div>
                </div>
              </div>
