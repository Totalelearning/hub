        ...
        <div class="px-3 not-iconic">
            ...
            <main class="adminuiux-content has-sidebar" onclick="contentClick()">
                  ...
                  <div class="col-12 col-sm">
                    ...
                    <nav aria-label="breadcrumb">
                      <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item bi"><a href="{{ route('preview.learning-help-center') }}">Help Center</a></li>
                        <li class="breadcrumb-item active bi" aria-current="page">Support Tickets</li>
                      </ol>
                    </nav>
                  </div>
                  <div class="col-auto py-1 ms-auto">
                    <a href="{{ route('preview.learning-add-ticket') }}" class="btn btn-theme">
                      <i data-feather="plus" class="me-1"></i> Create Ticket
                    </a>
                  </div>
                </div>
              </div>
              ...
              <div class="container mt-4" id="main-content">
                ...
                <!-- Banner title -->
                <div class="card adminuiux-card bg-theme-l-gradient shadow-sm mb-4">
                  <div class="card-body p-1">
                    <div class="card adminuiux-card">
                      <div class="card-body py-5">
                        <div class="row justify-content-center">
                          <div class="col-11 col-md-10 col-lg-8 col-xl-7 col-xxl-6 text-center position-relative">
                            <h2 class="text-center">The Place to find <br>The right answers of your questions.</h2>
                            <p class="text-secondary text-center mb-4">Ask questions, Build network, Connect with same tastes people, share your ideas and help other people by helping, votes and give advices.</p>
                            <!-- search -->
                    ...
                    <div class="card adminuiux-card shadow-sm">
                      <div class="card-body">
                        <div class="row align-items-center">
                          <div class="col-auto">
                            <div class="avatar avatar-60 text-center rounded bg-success-subtle text-success-emphasis">
                              <i class="bi bi-megaphone fs-4"></i>
                            </div>
                          </div>
                          <div class="col px-0">
                            <h4 class="mb-0">100+ <small>million</small></h4>
                  ...
                  <div class="col-12 col-sm-6 col-xxl-3 mb-4">
                    <div class="card adminuiux-card shadow-sm">
                      <div class="card-body">
                        <div class="row gx-3 align-items-center">
                          <div class="col-auto">
                            <div class="avatar avatar-60 text-center rounded bg-info-subtle text-info-emphasis">
                              <i class="bi bi-hospital fs-4"></i>
                            </div>
                          </div>
                          <div class="col">
                            <h4 class="mb-0">45.1+ <small>billion</small></h4>
                  ...
                  <div class="col-12 col-sm-6 col-xxl-3 mb-4">
                    <div class="card adminuiux-card shadow-sm h-100">
                      <div class="card-body">
                        <div class="row gx-3 align-items-center">
                          <div class="col-auto">
                            <div class="avatar avatar-60 text-center rounded bg-warning-subtle text-warning-emphasis">
                              <i class="bi bi-bank fs-4"></i>
                            </div>
                          </div>
                          <div class="col">
                            <h4 class="mb-0">101% <small>ROI</small></h4>
                  ...
                  <div class="col-12 col-sm-6 col-xxl-3 mb-4">
                    <div class="card adminuiux-card shadow-sm">
                      <div class="card-body">
                        <div class="row gx-3 align-items-center">
                          <div class="col-auto">
                            <div class="avatar avatar-60 text-center rounded bg-primary-subtle text-primary-emphasis">
                ...
                <div class="row align-items-center mb-4">
                  ...
                  <div class="col-auto">
                    ...
                    <div class="btn-group btn-group-sm" role="group" aria-label="Filter toggle">
                      ...
                      <input type="radio" name="filterbox" class="btn-check" id="btncheck2filter">
                      <label class="btn btn-outline-theme" for="btncheck2filter">Active</label>

                      <input type="radio" name="filterbox" class="btn-check" id="btncheck3filter">
                      <label class="btn btn-outline-theme" for="btncheck3filter">Unanswered</label>
                ...
                <div class="row mb-4">
                    ...
                    <div class="card adminuiux-card shadow-sm mb-4">
                      <div class="card-body">
                        <div class="row align-items-center mb-3">
                          ...
                          <div class="col-auto">
                            <div class="dropdown">
                              <button class="btn btn-link btn-square text-secondary dropdown-toggle no-caret" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <div class="row align-items-center mb-3">
                          ...
                          <div class="col-auto">
                            <span class="badge badge-light bg-success text-white">Answered</span>
                            <span class="badge badge-light bg-danger-subtle text-danger-emphasis">Closed</span>
                          </div>
                        </div>
                        <p class="text-secondary">You can easily find template for UI with best customize facility named
                          "Get Adminuiux". Adminuiux just right template for all your need flexible, adoptable and elastic bootstrap
                          based HTML template. everWhen you get older many
                          people will listen you carefully, no matter if its correct discussion or not.</p>
                        <p>
                        ...
                        <div class="row align-items-center">
                          ...
                          <div class="col-auto d-none d-lg-block">
                            <div class="avatar avatar-40 coverimg rounded-circle me-1">
                              <img src="{{ asset('vendor/learninguiux/img//modern-ai-image/user-5.jpg') }}" alt="" style="display: none;">
                            </div>
                            <div class="avatar avatar-40 coverimg rounded-circle me-1">
                              <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/user-7.jpg') }}" alt="" style="display: none;">
                            </div>
                            <div class="avatar avatar-40 coverimg rounded-circle me-1">
                              <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/user-2.jpg') }}" alt="" style="display: none;">
                            </div>
                          </div>
                          ...
                          <div class="col-auto">
                            <a class="btn btn-outline-theme" data-bs-toggle="collapse" href="#comment1" role="button" aria-expanded="true" aria-controls="comment1">Answer</a>
                          </div>
                        </div>
                      </div>
                      <div class="collapse show" id="comment1">
                        <div class="card-body border-top">
                          ...
                          <div class="row mb-3">
                            ...
                            <div class="col-auto"><a class="btn btn-link theme-red" data-bs-toggle="collapse" href="#comment1" role="button" aria-expanded="false" aria-controls="comment1">Cancel</a>
                            </div>
                          </div>
                          <hr>
                          <!-- answer per user -->
                          <div class="card adminuiux-card bg-success-subtle mb-1">
                            <div class="card-body">
                              <div class="row">
                                ...
                                <div class="col ps-0">
                                  <p>
                                    <a href="" class="style-none">Jack Lee</a><br>
                                    <span class="text-secondary d-inline-block small">2 min ago</span>
                                  </p>
                                  <p class="mb-0"><span class="badge badge-light bg-success text-white">Correct Answer</span></p>
                                  <p class="text-secondary">I found a solution to your problem. <br>
                                    ...
                                    You can easily find template for UI with best customize facility named "GetAdminuiux". Adminuiux just right template for all your need flexible, adoptable and elastic bootstrap based HTML template. ever When you get older many people will listen you carefully, no matter if its correct discussion or not.
                                  </p>
                                </div>
                                <div class="col-auto">
                                  <div class="dropdown">
                    ...
                    <div class="card adminuiux-card shadow-sm mb-4">
                      <div class="card-body">
                        <div class="row align-items-center mb-3">
                          <div class="col">
                            <h5>
                              <a href="" class="style-none text-theme-1">Suggest best mobile and web app template, I feel
                                adminuiux is best</a>
                            </h5>
                          </div>
                          <div class="col-auto">
                        ...
                        <div class="row align-items-center mb-3">
                          <div class="col-auto">
                            <figure class="avatar avatar-40 rounded-circle coverimg align-middle">
                              <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/user-3.jpg') }}" alt="" style="display: none;">
                            </figure>
                          </div>
                          <div class="col px-0">
                            <p class="small text-secondary mb-0">Asked by</p>
                        ...
                        <p class="text-secondary">You can easily find template for UI with best customize facility named
                          ...
                          people will listen you carefully, no matter if its correct discussion or not.</p>
                        <p>
                          <span class="badge badge-light bg-yellow-subtle text-yellow-emphasis me-1 mt-1">Help Request</span>
                          <span class="badge badge-light bg-blue-subtle text-blue-emphasis me-1 mt-1">Latest</span>
                        </p>
                      </div>
                      <div class="card-footer">
                        <div class="row align-items-center">
                          ...
                          <div class="col-auto">
                            <a class="btn btn-outline-theme" data-bs-toggle="collapse" href="#comment2" role="button" aria-expanded="false" aria-controls="comment1">Answer</a>
                          </div>
                        </div>
                      </div>
                      <div class="collapse" id="comment2">
                        <div class="card-body">
                          ...
                          <div class="row">
                            ...
                            <div class="col-auto"><a class="btn btn-link theme-red" data-bs-toggle="collapse" href="#comment2" role="button" aria-expanded="false" aria-controls="comment2">Cancel</a>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="card adminuiux-card shadow-sm mb-4">
                      <div class="card-body">
                        <div class="row align-items-center mb-3">
                          <div class="col">
                            <h5>
                              <a href="" class="style-none text-theme-1">Create mobile restaurant app with adminuiux dashboard
                                and mobile app HTML template</a>
                            </h5>
                          </div>
                          <div class="col-auto">
                            <div class="dropdown">
                        ...
                        <p class="text-secondary">You can easily find template for UI with best customize facility named
                          ...
                          people will listen you carefully, no matter if its correct discussion or not.</p>
                        <p>
                          <span class="badge badge-light bg-pink-subtle text-pink-emphasis me-1 mt-1">Support</span>
                          <span class="badge badge-light bg-orange-subtle text-orange-emphasis me-1 mt-1">Development</span>
                        </p>
                      </div>
                      <div class="card-footer">
                        <div class="row align-items-center">
                      ...
                      <div class="collapse" id="comment3">
                        <div class="card-body">
                          ...
                          <div class="row">
                            ...
                            <div class="col-auto"><a class="btn btn-link theme-red" data-bs-toggle="collapse" href="#comment3" role="button" aria-expanded="false" aria-controls="comment3">Cancel</a>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="card adminuiux-card shadow-sm mb-4">
                      <div class="card-body">
                        <div class="row align-items-center mb-3">
                          <div class="col">
                            <h5>
                              <a href="" class="style-none text-theme-1">Best class design and extensible UI template Bootstrap
                                HTML Admin ui ux
                                is best </a>
                            </h5>
                          </div>
                        ...
                        <div class="row align-items-center mb-3">
                          <div class="col-auto">
                            <figure class="avatar avatar-40 rounded-circle coverimg align-middle">
                              <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/user-1.jpg') }}" alt="" style="display: none;">
                            </figure>
                          </div>
                          <div class="col px-0">
                            <p class="small text-secondary mb-0">Asked by</p>
                        ...
                        <p class="text-secondary">You can easily find template for UI with best customize facility named
                          ...
                          people will listen you carefully, no matter if its correct discussion or not.</p>
                        <p>
                          <span class="badge badge-light bg-purple-subtle text-purple-emphasis me-1 mt-1">Creative</span>
                      ...
                      <div class="collapse" id="comment4">
                        <div class="card-body">
                          ...
                          <div class="row">
                            ...
                            <div class="col-auto"><a class="btn btn-link theme-red" data-bs-toggle="collapse" href="#comment4" role="button" aria-expanded="false" aria-controls="comment4">Cancel</a>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="card adminuiux-card shadow-sm mb-4">
                      <div class="card-body">
                        <div class="row align-items-center mb-3">
                          <div class="col">
                            <h5>
                              <a href="" class="style-none text-theme-1">How to create admin dashboard for Investment and
                                Finance</a>
                            </h5>
                          </div>
                          <div class="col-auto">
                        ...
                        <p class="text-secondary">You can easily find template for UI with best customize facility named
                          ...
                          people will listen you carefully, no matter if its correct discussion or not.</p>
                        <p>
                          <span class="badge badge-light bg-green-subtle text-green-emphasis me-1 mt-1">Support</span>
                          <span class="badge badge-light bg-danger-subtle text-danger-emphasis me-1 mt-1">Development</span>
                        </p>
                      </div>
                      <div class="card-footer">
                        <div class="row align-items-center">
                      ...
                      <div class="collapse" id="comment5">
                        <div class="card-body">
                          ...
                          <div class="row">
                            ...
                            <div class="col-auto"><a class="btn btn-link theme-red" data-bs-toggle="collapse" href="#comment5" role="button" aria-expanded="false" aria-controls="comment5">Cancel</a>
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="col-12 col-md-4">
                    <div class="position-sticky" style="top: 5.5rem;">
                      ...
                      <p class="mb-4">
                        <a href="" class="badge badge-light text-bg-theme-1 me-1 mb-1">How we can do edits in index pages?</a>
                        <a href="" class="badge badge-light text-bg-theme-1 me-1 mb-1">Is this template comes with Laravel vue js?</a>
                        <a href="" class="badge badge-light text-bg-theme-1 me-1 mb-1">Is there angular development suggestions before starting work?</a>
                        <a href="" class="badge badge-light text-bg-theme-1 me-1 mb-1">How to reduce width of any boxes with responsiveness?</a>
                        <a href="" class="badge badge-light text-bg-theme-1 me-1 mb-1">How can you defined new color set ?</a>
                        <a href="" class="badge badge-light text-bg-theme-1 me-1 mb-1">What are the primary color set and what to keep in mind?</a>
                      </p>

                      <!-- offer -->
                      <div class="card adminuiux-card shadow-sm bg-theme-1 text-white position-relative overflow-hidden mb-4">
                        <figure class="coverimg position-absolute w-100 h-100 start-0 top-0 m-0 z-index-0 opacity-75">
                          <img src="{{ asset('vendor/learninguiux/img/learning/bg-overlay-1.png') }}" class="mw-100" alt="" style="display: none;">
                        </figure>
