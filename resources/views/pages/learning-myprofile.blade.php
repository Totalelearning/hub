                    ...
                    <div class="row gx-2">
                        ...
                        <main class="adminuiux-content has-sidebar" onclick="contentClick()">
                            ...
                            <div class="container mt-4" id="main-content">
                                <div class="coverimg height-200 w-100 rounded position-relative overflow-hidden blur-overlay">
                                    <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/user-3.jpg') }}" alt="">
                                </div>
                                <div class="row z-index-1">
                                    <div class="col-12 col-md-4 col-lg-3 text-center position-relative mt--50">
                                        <figure class="avatar avatar-150 rounded coverimg align-middle shadow-sm position-relative mx-auto mb-4">
                                            <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/user-3.jpg') }}" alt="">
                                        </figure>
                                    </div>
                                    <div class="col-12 col-md mb-4 pt-3">
                                        <h4 class="">Adminuiux Smith <i class="bi bi-star-fill text-theme-1 theme-yellow small"></i></h4>
                                        <p class="">
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-6 col-lg-6 mb-4">
                                        ...
                                        <p class="small mb-3"><span class="text-secondary">Student Information</span></p>
                                        <div class="row">
                                            <div class="col-12 col-md-12 mb-2">
                                                <p class="text-secondary"><i class="bi bi-envelope me-2 align-middle"></i> adminuiux@adminuiux.com</p>
                                            </div>
                                            <div class="col-12 col-md-12 mb-2">
                                                <p class="text-secondary"><i class="bi bi-mortarboard me-2 align-middle"></i> 11<sup>th</sup> Standard</p>
                                            </div>
                                            <div class="col-12 col-md-12 mb-2">
                                                <p class="text-secondary"><i class="bi bi-cake me-2 align-middle"></i> <span class="align-middle">15/09/2000</span></p>
                                            </div>
                                            <div class="col-12 col-md-12 mb-2">
                                        ...
                                        <div class="card adminuiux-card shadow-sm mb-4">
                                            <div class="card-body">
                                                <div class="row align-items-center">
                                                    <div class="col-auto">
                                                        <div class="avatar avatar-40 rounded bg-theme-1-subtle text-theme-1 h4 mb-3">
                                        ...
                                        <div class="card adminuiux-card bg-theme-1 shadow-sm">
                                            <div class="card-body">
                                                <div class="row align-items-center mb-3">
                                                    <div class="col-auto">
                                                        <div class="avatar avatar-40 rounded bg-white-opacity text-white">
                                                            <h6>11<sup>th</sup></h6>
                                                        </div>
                                                    </div>
                                                    <div class="col">
