        ...
        <main class="adminuiux-content" onclick="contentClick()">
                        ...
                        <div class="col col-sm mb-2 mb-sm-0">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item active bi" aria-current="page">Header</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="col-auto ">
            ...
            <div class="container mt-4">
                <div class="card adminuiux-card shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        <header class="adminuiux-header mb-3">
                            <!-- Fixed navbar -->
                            <nav class="navbar navbar-expand-lg z-index-5 shadow-none">
                                <div class="container-fluid">
                                    <!-- main sidebar toggle -->
                                    ...
                                    <a class="navbar-brand" href="#">
                                        ...
                                        <img data-bs-img="dark" src="{{ asset('vendor/learninguiux/img/logo.svg') }}" alt="">
                                        <div class="">
                                            <span class="company-name text-uppercase h4"><b>Admin</b>UIUX</span>
                                            <p class="company-tagline">Web and Mobile HTML template</p>
                                        </div>
                                    </a>
                                    <!-- navigation inline -->
                                    <div class="collapse navbar-collapse right-in-device" id="header-navbar2">
                                        <ul class="navbar-nav mx-lg-3 mb-2 mb-md-0 ">
                                            <li class="nav-item">
                                                <a class="nav-link" href="{{ route('preview.learning-dashboard') }}">Home</a>
                                            </li>
                                            <li class="nav-item dropdown ">
                                                <a class="nav-link dropdown-toggle " data-bs-toggle="dropdown" data-bs-popper="static" href="#" role="button" aria-expanded="false">Pages</a>
                                                <div class="dropdown-menu width-200">
                                                    <div><a class="dropdown-item " href="{{ route('preview.learning-myprofile') }}">Investment Profile</a>
                                                    </div>
                                                    <div><a class="dropdown-item" href="{{ route('preview.learning-personalization') }}">Branding</a></div>
                                                    <div><a class="dropdown-item" href="{{ route('preview.learning-student-all') }}">Users </a></div>
                                                    <div>
                                                        <hr class="dropdown-divider">
                                                    </div>
                                                    <div>
                                                        <a class="dropdown-item" href="{{ route('preview.learning-help-center') }}">
                                                            <i data-feather="help-circle" class="avatar avatar-18 me-1"></i> Help Center </a>
                                                    </div>
                                                    <div>
                                                        <a class="dropdown-item" href="{{ route('preview.learning-onboarding') }}">
                                                            <i data-feather="settings" class="avatar avatar-18 me-1"></i> Onboarding </a>
                                                    </div>
                                                    <div>
                                                        <a class="dropdown-item theme-green" href="{{ route('preview.learning-pages') }}">
                                                            <div class="row gx-0">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" href="{{ route('preview.learning-aboutus') }}">About</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class=" ms-auto "></div>
                                    ...
                                    <div class="ms-auto">
                                        <!-- dark mode -->
                                        <button class="btn btn-link btn-square btnsunmoon btn-link-header" id="btn-layout-modes-dark-page2">
                                            <i class="sun mx-auto" data-feather="sun"></i>
                                            <i class="moon mx-auto" data-feather="moon"></i>
                                        </button>
                                        <!-- global search toggle -->
                                        <button class="btn btn-link btn-square btn-icon btn-link-header d-inline-block d-xxl-none" type="button" onclick="openSearch()">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end width-300 pt-0 px-0">
                                                ...
                                                <div class="px-2">
                                                    <div class="row g-0 text-center mb-2">
                                                        <div class="col-4">
                                                            <a class="dropdown-item square-item" href="{{ route('preview.components') }}">
                                                ...
                                                <div class="text-center">
                                                    <a class="btn btn-link text-center" href="{{ route('preview.components') }}">View all <i class="bi bi-arrow-right fs-14"></i>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end notification-dd sm-mi-95px">
                                                <li>
                                                    <a class="dropdown-item" href="#">
                                                        <p class="mb-0">Congratulation! Your property <span class="fw-bold">#H10215</span> has reached 1000 views.</p>
                                                        <span class="row">
                                                            <span class="col"><span class="badge badge-light rounded-pill text-bg-warning small">Directory</span></span>
                                                            <span class="col-auto small opacity-50">1:00 am</span>
                                                        </span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="#">
                                                        <p class="mb-0">Your property <span class="fw-bold">#H10215</span> is published and live now.</p>
                                                        <span class="row">
                                                ...
                                                <li>
                                                    <a class="dropdown-item" href="#">
                                                        <p class="mb-0">User <span class="fw-bold">Rahana</span> has updated <span class="fw-bold">#H10215</span> property.</p>
                                                        <span class="row">
                                                ...
                                                <li class="text-center">
                                                    <button class="btn btn-link text-center" onclick="notifcationAll()"> View all <i class="bi bi-arrow-right fs-14"></i>
                                                    </button>
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <div class="dropdown d-inline-block">
                                            <a class="dropdown-toggle btn btn-link btn-link-header style-none" id="userprofiledd" data-bs-toggle="dropdown" aria-expanded="false" role="button">
                                                <div class="row gx-0 d-inline-flex">
                                                    ...
                                                    <div class="col align-self-center d-none d-xl-block px-2">
                                                        <span class="mb-0">AdminUIUX</span>
                                                    </div>
                                                </div>
                                            </a>
                                            <div class="dropdown-menu dropdown-menu-end width-300 pt-0 px-0 sm-mi-45px" aria-labelledby="userprofiledd">
                                                ...
                                                <div class="px-2">
                                                    <div><a class="dropdown-item" href="{{ route('preview.learning-myprofile') }}"><i data-feather="user" class="avatar avatar-18 me-1"></i> My Profile</a>
                                                    </div>
                                                    <div>
                                                    ...
                                                    <div>
                                                        <a class="dropdown-item" href="{{ route('preview.learning-earning') }}">
                                                            <i data-feather="dollar-sign" class="avatar avatar-18 me-1"></i> Earning </a>
                                                    </div>
                                                    <div>
                            ...
                            <div class="adminuiux-search-full">
                                <div class="row gx-2 align-items-center">
                                    <div class="col-auto">
                                        ...
                                        <button class="btn btn-square btn-icon" type="button" onclick="closeSearch()">
                                    ...
                                    <div class="col-auto">
                                        ...
                                        <div class="dropdown input-group-text border-0 p-0">
                                            <button class="dropdown-toggle btn btn-link no-caret" type="button" id="searchfilter2" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <p class="text-secondary">Customize header style in the <b>personalization</b>❤️ page</p>
                    </div>
                </div>
                <div class="card adminuiux-card shadow-sm mb-4">
                    <div class="card-header">
                    ...
                    <div class="card-body">
                        <nav class="navbar navbar-expand-lg bg-body-tertiary">
                            <div class="container-fluid">
                                <a class="navbar-brand d-flex py-0" href="#" style="--bs-navbar-brand-font-size:0.8rem">
                                    <img data-bs-img="light" src="{{ asset('vendor/learninguiux/img/logo-light.svg') }}" alt="" class=" me-3">
                                    <img data-bs-img="dark" src="{{ asset('vendor/learninguiux/img/logo.svg') }}" alt="" class=" me-3">
                                    <div class="d-inline-block">
                                        <span class="company-name text-uppercase h4"><b>Admin</b>UIUX</span>
                                        <p class="company-tagline text-secondary small">Web &amp; Mobile HTML template</p>
                                    </div>
                                </a>
            ...
            &lt;/nav&gt;</code></pre>
                ...
                <div class="card adminuiux-card shadow-sm mb-4">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <p class="h6">Standard Header Colored</p>
                            </div>
                            <div class="col-auto">
                        ...
                        <nav class="navbar navbar-expand-lg bg-primary mb-3" data-bs-theme="dark">
                            <div class="container-fluid">
                                <a class="navbar-brand d-flex py-0" href="#" style="--bs-navbar-brand-font-size:0.8rem">
                                    ...
                                    <div class="d-inline-block">
                                        <span class="company-name text-uppercase h4"><b>Admin</b>UIUX</span>
                                        <p class="company-tagline small">Web &amp; Mobile HTML template</p>
                                    </div>
                                </a>
            ...
            &lt;/nav&gt;</code></pre>
                ...
                <div class="bg-theme-1-subtle rounded px-3 py-2 mb-4">
                    <div class="row">
                        <div class="col">
                            <a href="{{ route('preview.component-tables') }}" class="btn btn-accent me-3 my-2"><i class="bi bi-arrow-left mr-2"></i> Tables</a>
                        </div>
                        <div class="col-auto">
                            <a href="{{ route('preview.component-nav') }}" class="btn btn-theme my-2">Navs <i class="bi bi-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                </div>
            </div>
