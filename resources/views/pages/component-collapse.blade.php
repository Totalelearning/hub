        ...
        <main class="adminuiux-content" onclick="contentClick()">
                        ...
                        <div class="col col-sm mb-2 mb-sm-0">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item active bi" aria-current="page">Collapse</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="col-auto ">
                ...
                <div class="card adminuiux-card shadow-sm mb-4">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <p class="h6">Standard Collapse</p>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <p class="d-inline-flex gap-1 mb-0">
                            <a class="btn btn-primary" data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample"> Button 1 with href </a>
                            <button class="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample"> Button 2 with data-bs-target </button>
                        </p>
            ...
            &lt;/div&gt;
                ...
                <div class="bg-theme-1-subtle rounded px-3 py-2 mb-4">
                    <div class="row">
                        <div class="col">
                            <a href="{{ route('preview.component-cards') }}" class="btn btn-accent me-3 my-2"><i class="bi bi-arrow-left mr-2"></i> Cards</a>
                        </div>
                        <div class="col-auto">
                            <a href="{{ route('preview.component-list-groups') }}" class="btn btn-theme my-2">List Groups <i class="bi bi-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                </div>
            </div>
