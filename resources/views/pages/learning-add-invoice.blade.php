                        ...
                        <main class="adminuiux-content has-sidebar" onclick="contentClick()">
                                    ...
                                    <div class="col-12 col-sm">
                                        ...
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb mb-0">
                                                ...
                                                <li class="breadcrumb-item bi"><a href="{{ route('preview.learning-billing') }}">Billing</a></li>
                            ...
                            <div class="container mt-4" id="main-content">
                                    ...
                                    <div class="col-12 col-md-12 col-lg-12 col-xl-8 col-xxl-9">
                                                                ...
                                                                <div class="card adminuiux-card border">
                                                                    <div class="card-body py-2">
                                                                        <div class="row justify-content-center align-items-center">
                                                                            ...
                                                                            <div class="col py-2">
                                                                                <p class="h6 mb-1 ">
                                                                                    <span class="position-relative">John Williams
                                                                                        <span class="position-absolute top-50 start-100 translate-middle p-1 bg-success rounded-circle mx-2">
                                                                                            <span class="visually-hidden">online</span>
                                                                                        </span>
                                                                                    </span>
                                                                                </p>
                                                                                <p class="opacity-75 small">General Expert</p>
                                                                            </div>
                                                                            <div class="col-auto py-2">
                                                                                <span class="badge badge-light rounded-pill text-bg-warning">5
                                                                                    <i class="bi bi-star-fill"></i>
                                                                                </span>
                                                                            </div>
                                                                            <div class="col-auto text-end py-2">
                                                                                <button class="btn btn-square btn-link theme-red">
                                                                ...
                                                                <div class="card adminuiux-card border">
                                                                    <div class="card-body py-2">
                                                                        <div class="row justify-content-center align-items-center">
                                                                            ...
                                                                            <div class="col py-2">
                                                                                <p class="h6 mb-1 ">
                                                                                    <span class="position-relative">Alexa John
                                                                                        <span class="position-absolute top-50 start-100 translate-middle p-1 bg-success rounded-circle mx-2">
                                                                                            <span class="visually-hidden">online</span>
                                                                                        </span>
                                                                                    </span>
                                                                                </p>
                                                                                <p class="opacity-75 small">United States</p>
                                                                            </div>
                                                                            <div class="col-auto text-end py-2">
                                        ...
                                        <div class="collapse patinetcollapse" id="addnewpatient">
                                            <div class="card adminuiux-card shadow-sm mb-4">
                                                <div class="card-body">
                                                    <!-- Details -->
                                                    <p class="h6 mb-3">New Customer Details</p>
                                                    <div class="row mb-1">
                                                    ...
                                                    <!-- Address -->
                                                    <p class="h6 mb-3">New Customer Address</p>
                                                    <div class="row mb-1">
                                                        <div class="col-12 col-lg-6 col-xl-4">
                                                            <div class="form-floating mb-3">
                                                ...
                                                <div class="card adminuiux-card border mb-3">
                                                    <div class="card-body py-2">
                                                        <div class="row justify-content-center align-items-center">
                                                            <div class="col py-2">
                                                                <p class="h6 mb-1 ">
                                                                    <span class="position-relative">Certificate Copy </span>
                                                                </p>
                                                                <p class="opacity-75 small">1 Item </p>
                                                            </div>
                                                            <div class="col-auto">
                                                                <div class="input-group">
                                                                    <button class="btn btn-square btn-link rounded-circle" type="button">-</button>
                                                                    <input type="text" class="form-control text-center width-40 rounded" placeholder="" value="1">
                                                                    <button class="btn btn-square btn-link rounded-circle" type="button">+</button>
                                                                </div>
                                                            </div>
                                                            <div class="col-auto text-end py-2">
                                                ...
                                                <div class="card adminuiux-card border mb-3">
                                                    <div class="card-body py-2">
                                                        <div class="row justify-content-center align-items-center">
                                                            <div class="col py-2">
                                                                <p class="h6 mb-1 ">
                                                                    <span class="position-relative">Annual Book</span>
                                                                </p>
                                                                <p class="opacity-75 small">2 Items </p>
                                                            </div>
                                                            <div class="col-auto">
                                                                <div class="input-group">
                                                                    <button class="btn btn-square btn-link rounded-circle" type="button">-</button>
                                                                    <input type="text" class="form-control text-center width-40 rounded" placeholder="" value="2">
                                                                    <button class="btn btn-square btn-link rounded-circle" type="button">+</button>
                                                                </div>
                                                            </div>
                                                            <div class="col-auto text-end py-2">
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-12 col-sm-6 col-xl-12 mb-4">
                                                    <div class="row align-items-center mb-3">
                                                        ...
                                                        <div class="col-auto">
                                                            <input type="text" id="inlinewrap1" class="form-control width-120 text-end bg-none border-0">
                                                        </div>
                                                    </div>
                                                ...
                                                <!-- appointment timings -->
                                                <div class="col-12 col-sm-6 col-xl-12 mb-4">
                                                    <h6 class="mb-3">Invoice Time</h6>
                                                    <button class="btn btn-sm btn-outline-theme mb-2 me-1 active">
                                                        <span>Automatic</span>
                                                    </button>
                                                    <button class="btn btn-sm btn-outline-theme mb-2 me-1">
                                                        <span>11:00 AM</span>
                                                    </button>
                                                    <button class="btn btn-sm btn-outline-theme mb-2 me-1"><span>11:30
                                                            AM</span></button>
                                                    <button class="btn btn-sm btn-outline-theme mb-2 me-1"><span>12:00
                                                            PM</span></button>
                                                    <button class="btn btn-sm btn-outline-theme mb-2 me-1"><span>12:30
                                                            PM</span></button>
                                                    <button class="btn btn-sm btn-outline-theme mb-2 me-1"><span>1:00
                                                            PM</span></button>
                                                    <button class="btn btn-sm btn-outline-theme mb-2 me-1"><span>1:30
                                                            PM</span></button>
                                                    <button class="btn btn-sm btn-outline-theme mb-2 me-1"><span>2:00
                                                            PM</span></button>
                                                    <button class="btn btn-sm btn-outline-theme mb-2 me-1"><span>2:30
                                                            PM</span></button>
                                                    <button class="btn btn-sm btn-outline-theme mb-2 me-1"><span>3:00
                                                            PM</span></button>
                                                    <button class="btn btn-sm btn-outline-theme mb-2 me-1"><span>3:30
                                                            PM</span></button>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-auto col-md-3 col-xl-2 mb-4">
                                        <h4 class="mb-1">$ 80.00</h4>
                                        <p class="text-secondary small mb-0">Sub Total</p>
                                    </div>
                                    <div class="col-auto col-md-3 col-xl-2 mb-4">
                                        <h4 class="mb-1">$ 6.00</h4>
                                        <p class="text-secondary small mb-0">Total Tax</p>
                                    </div>
                                    <div class="col-auto col-md-3 col-xl-2 text-end text-lg-start ms-auto ms-md-0 mb-4">
                                        <h4 class="mb-1 text-success">$ 86.00</h4>
                                ...
                                <div class="mb-4">
                                    <div class="row">
                                        <div class="col">
                                            <a href="{{ route('preview.learning-billing') }}" class="btn btn-theme my-2"><i class="bi bi-floppy me-2"></i>Create</a>
                                        ...
                                        <div class="col-auto">
                                            <button class="btn btn-link my-2" data-bs-toggle="modal" data-bs-target="#modalcancel">Cancel</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
