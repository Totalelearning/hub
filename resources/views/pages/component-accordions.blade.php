        ...
        <main class="adminuiux-content" onclick="contentClick()">
                        ...
                        <div class="col col-sm mb-2 mb-sm-0">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item active bi" aria-current="page">Accordion</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="col-auto ">
                ...
                <div class="card adminuiux-card shadow-sm mb-4">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <p class="h6">Standard Accordions</p>
                            </div>
                            <div class="col-auto">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        <p class="text-secondary">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent nec tempor nunc. Duis diam sem, fringilla nec elementum eu, dignissim a enim. Phasellus tincidunt suscipit ipsum, vitae rutrum ligula efficitur ut. Curabitur lobortis, diam ac consectetur facilisis, diam tellus dignissim sapien, eget condimentum metus ante non sapien.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
            ...
            &lt;/div&gt;
                ...
                <div class="card adminuiux-card shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        <div class="accordion adminuiux-accordion" id="accordionExample2">
                            <div class="accordion-item">
                                <div class="accordion-header">
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne2" aria-expanded="true" aria-controls="collapseOne2"> Accordion Item #1 </button>
                                </div>
                            ...
                            <div class="accordion-item">
                                <div class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo2" aria-expanded="false" aria-controls="collapseTwo2"> Accordion Item #2 </button>
                                </div>
                            ...
                            <div class="accordion-item">
                                <div class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree3" aria-expanded="false" aria-controls="collapseThree3"> Accordion Item #3 </button>
                                </div>
                                <div id="collapseThree3" class="accordion-collapse collapse" data-bs-parent="#accordionExample2">
                                    <div class="accordion-body">
                                        <p class="text-secondary">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent nec tempor nunc. Duis diam sem, fringilla nec elementum eu, dignissim a enim. Phasellus tincidunt suscipit ipsum, vitae rutrum ligula efficitur ut. Curabitur lobortis, diam ac consectetur facilisis, diam tellus dignissim sapien, eget condimentum metus ante non sapien.</p>
                                    </div>
                                </div>
                ...
                <div class="card adminuiux-card shadow-sm mb-4">
                    ...
                    <div class="card-body px-0">
                        <div class="accordion accordion-flush" id="accordionExample3">
                            <div class="accordion-item">
                                <div class="accordion-header">
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne4" aria-expanded="true" aria-controls="collapseOne4"> Accordion Item #1 </button>
                                </div>
                                <div id="collapseOne4" class="accordion-collapse collapse show" data-bs-parent="#accordionExample3">
                                    <div class="accordion-body">
                                        <p class="text-secondary">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent nec tempor nunc. Duis diam sem, fringilla nec elementum eu, dignissim a enim. Phasellus tincidunt suscipit ipsum, vitae rutrum ligula efficitur ut. Curabitur lobortis, diam ac consectetur facilisis, diam tellus dignissim sapien, eget condimentum metus ante non sapien.</p>
                                    </div>
                                </div>
                            ...
                            <div class="accordion-item">
                                <div class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo5" aria-expanded="false" aria-controls="collapseTwo5"> Accordion Item #2 </button>
                                </div>
                                <div id="collapseTwo5" class="accordion-collapse collapse" data-bs-parent="#accordionExample3">
                                    <div class="accordion-body">
                                        <p class="text-secondary">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent nec tempor nunc. Duis diam sem, fringilla nec elementum eu, dignissim a enim. Phasellus tincidunt suscipit ipsum, vitae rutrum ligula efficitur ut. Curabitur lobortis, diam ac consectetur facilisis, diam tellus dignissim sapien, eget condimentum metus ante non sapien.</p>
                                    </div>
                                </div>
                            ...
                            <div class="accordion-item">
                                <div class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree6" aria-expanded="false" aria-controls="collapseThree6"> Accordion Item #3 </button>
                                </div>
                                <div id="collapseThree6" class="accordion-collapse collapse" data-bs-parent="#accordionExample3">
                                    <div class="accordion-body">
                                        <p class="text-secondary">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent nec tempor nunc. Duis diam sem, fringilla nec elementum eu, dignissim a enim. Phasellus tincidunt suscipit ipsum, vitae rutrum ligula efficitur ut. Curabitur lobortis, diam ac consectetur facilisis, diam tellus dignissim sapien, eget condimentum metus ante non sapien.</p>
                                    </div>
                                </div>
            ...
            &lt;/div&gt;
                ...
                <div class="bg-theme-1-subtle rounded px-3 py-2 mb-4">
                    <div class="row">
                        <div class="col">
                            <a href="{{ route('preview.component-spinners-loaders') }}" class="btn btn-accent me-3 my-2"><i class="bi bi-arrow-left mr-2"></i> Spinners Loaders</a>
                        </div>
                        <div class="col-auto">
                            <a href="{{ route('preview.component-cards') }}" class="btn btn-theme my-2">Cards <i class="bi bi-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                </div>
            </div>
