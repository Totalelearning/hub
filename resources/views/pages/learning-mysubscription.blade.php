                                    ...
                                    <div class="col-12 col-sm">
                                        ...
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb mb-0">
                                                ...
                                                <li class="breadcrumb-item bi"><a href="{{ route('preview.learning-myprofile') }}">My Profile</a></li>
                                                <li class="breadcrumb-item active bi" aria-current="page">My Subscription</li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-12 col-lg-4 col-xl-3 mb-4">
                                        <div class=" text-center text-lg-start mb-3">
                                            <figure class="avatar avatar-150 rounded coverimg align-middle shadow-sm position-relative mb-3" style="background-image: url(&quot;{{ asset('vendor/learninguiux/img/modern-ai-image/user-3.jpg&quot;') }});">
                                                <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/user-3.jpg') }}" alt="" style="display: none;">
                                            </figure>
                                            <h4>Adminuiux Smith <i class="bi bi-star-fill text-theme-1 theme-yellow small"></i></h4>
                                            <p>
                                                <span class="badge badge-light bg-theme-1-subtle text-theme-1 theme-teal">Present</span>
                                                <span class="badge badge-light bg-theme-1-subtle text-theme-1 theme-orange">In-Campus</span>
                                            </p>
                                            <p class="text-secondary mb-1"><i class="bi bi-envelope me-2 align-middle"></i> adminuiux@adminuiux.com</p>
                                            <p class="text-secondary"><i class="bi bi-mortarboard me-2 align-middle"></i> 11<sup>th</sup> Standard</p>
                                        </div>
                                        <div class="alert alert-info alert-dismissible mb-0" role="alert"><button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                            <h6><i class="bi bi-telephone-plus-fill me-1"></i> Add a phone number</h6>
                                            <p class="small">Ensure you never lose access to your account and receive important account updates like billing and
                                                security alerts.</p>
                                        </div>
                                    </div>
                                    <div class="col-12 col-lg-8 col-xl-9">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-12 col-md-12 col-lg-6 col-xl-4 mb-4 mb-lg-0">
                                                        <div class="card adminuiux-card bg-theme-r-gradient text-white mb-3 mb-lg-0">
                                                            <div class="position-absolute start-0 top-0 h-100 w-100 rounded overflow-hidden coverimg z-index-0">
                                                                <img src="{{ asset('vendor/learninguiux/img/learning/bg-overlay-1.png') }}" alt="">
                                                            </div>
                                                            ...
                                                            <div class="card-body text-center z-index-1 position-relative">
                                                                <figure class="avatar avatar-60 mb-4 mx-auto rounded">
                                                                    <img src="{{ asset('vendor/learninguiux/img/logo-512.png') }}" class="mw-100" alt="">
                                                                </figure>
                                                                <h4 class="mb-0">Business</h4>
                                                                <p class="small opacity-50">Annual Plan</p>
                                                                <h2 class="mb-4">$ 250.00</h2>
                                                                <a href="{{ route('preview.learning-subscriptions') }}" class="btn btn-sm btn-outline-light">Upgrade plan</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-md-6 col-lg-6 col-xl-4 mb-4 mb-lg-0">
                                                        <h6 class="mb-1">Plan Features</h6>
                                                        <p class="small text-secondary mb-4">Including features of basic plan</p>
                                                        <div class="row mb-2">
                                                            <div class="col-auto">
                                                        ...
                                                        <a href="" class="btn btn-sm btn-link ">More details <i class="bi bi-chevron-right"></i></a>
                                                    </div>
                                                    <div class="col-12 col-md-6 col-lg-12 col-xl-4">
                                                        <h6 class="mb-1">Payment Method</h6>
                                                        <p class="small text-secondary mb-4">1 Credit Card is saved</p>
                                                        <div class="row mb-3">
                                                            <div class="col-auto">
                                                                <i class="bi bi-credit-card text-secondary"></i>
                                                            </div>
                                                            <div class="col-auto ps-0">
                                                                Visa ending ****<b>25480</b>
                                                            </div>
                                                        </div>
                                                        <div class="row mb-3">
                                                            <div class="col-auto">
                                                            ...
                                                            <div class="col-auto ps-0">
                                                                Next Due date is <b>22-June-2022</b>
                                                            </div>
                                                        </div>
                                                        <div>
                                                            <button class="btn btn-sm btn-theme">Change Card</button>
                                                            <button class="btn btn-sm btn-link theme-red mx-2">Cancel</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card adminuiux-card shadow-sm mb-4">
                                            <div class="card-body pb-0">
                                                <div class="row mb-4">
                                                    <div class="col-auto">
                                                        <i class="bi bi-quote display-1 lh-20 me-1"></i>
                                                    </div>
                                                    <div class="col ps-0">
                                                        <h4 class="mb-2 mt-2">Best way to work fast and east to use.<br>Stay tracked and also committed with priorities.</h4>
                                                        <p class="text-secondary">Get involved in the race of technology and digitization. Win the heart not the war. Go beyond of imagination but not far from your loved ones.</p>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-12 col-md-12 col-lg-6">
                                                        ...
                                                        <p class="text-secondary mb-4">All the export functionalities are available for your reports and email to any person around the world.</p>
                                                        <div class="row mb-4">
                                                            <div class="col-auto">
                                                            ...
                                                            <div class="col ps-0">
                                                                <h6>PDF export</h6>
                                                                <p class="small text-secondary">Pdf export functionalities available for all kind of reports including charts and background images.</p>
                                                        ...
                                                        <div class="row mb-4">
                                                            ...
                                                            <div class="col ps-0">
                                                                <h6>Excel export</h6>
                                                                <p class="small text-secondary">Excel export functionalities available for all kind of reports including charts. </p>
                                                                <button class="btn btn-sm btn-link">Buy now </button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12 col-md-12 col-lg-6">
                                                        ...
                                                        <p class="text-secondary mb-4">Keep the eye on your visitors and users. Downloads, Clicked,shared with region, gender and people are available.</p>
                                                        <div class="row mb-4">
                                                            <div class="col-auto">
                                                            ...
                                                            <div class="col ps-0">
                                                                <h6>Reporting</h6>
                                                                <p class="small text-secondary">Subscription and manage features as per your need. More advance designs available to customize.</p>
                                                                <button class="btn btn-sm btn-link">Buy now </button>
                                                            </div>
                                                        </div>
                                                        <div class="row mb-4">
                                                            ...
                                                            <div class="col ps-0">
                                                                ...
                                                                <p class="small text-secondary">Now you can able to track more resource availability and share your progress with multiple users.</p>
                                                                <button class="btn btn-sm btn-link">Buy now </button>
                                                            </div>
                                                        </div>
                                                    </div>
