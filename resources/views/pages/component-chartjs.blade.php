        ...
        <main class="adminuiux-content" onclick="contentClick()">
                        ...
                        <div class="col col-sm mb-2 mb-sm-0">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item active bi" aria-current="page">Chart js</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="col-auto ">
            ...
            <div class="container mt-4">
                <div class="card adminuiux-card shadow-sm mb-4">
                    ...
                    <div class="card-body ">
                        <p class="text-secondary">Simple yet flexible JavaScript charting library for the modern web </p>
                        <div class="row">
                            <div class="col-12 col-md-6 col-lg-3">
                                ...
                                <div class="card mb-3">
                                    <div class="card-body">
                                        <div class="summarychart height-50  w-100"><canvas id="areachartred1"></canvas></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-6 col-lg-3">
                                <div class="card mb-3">
                                    <div class="card-body">
                                        <div class="summarychart height-50 w-100"><canvas id="areachartgreen1"></canvas></div>
                                    </div>
                                </div>
                                <div class="card mb-3">
                                    <div class="card-body">
                                        <div class="summarychart height-50 w-100"><canvas id="areachartyellow1"></canvas></div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <a href="https://www.chartjs.org/" target="_blank" class="btn btn-link">View more charts and details</a>
                    </div>
            ...
            &lt;script&gt;</code></pre>
                ...
                <div class="bg-theme-1-subtle rounded px-3 py-2 mb-4">
                    <div class="row">
                        <div class="col">
                            <a href="{{ route('preview.component-feather-icons') }}" class="btn btn-accent me-3 my-2"><i class="bi bi-arrow-left mr-2"></i> Feather Icons</a>
                        </div>
                        <div class="col-auto">
