                        ...
                        <main class="adminuiux-content has-sidebar" onclick="contentClick()">
                            ...
                            <div class="container mt-4" id="main-content">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-10 col-sm col-md">
                                        <a href="{{ route('preview.learning-profile-kyc') }}" class="card shadow-sm overflow-hidden style-none mb-4">
                                            <div class="card-body">
                                                <div class="row gx-3">
                                                    <div class="col-auto">
                                                        <span class="avatar avatar-40 rounded bg-theme-1-subtle text-theme-1 h5">1</span>
                                                    </div>
                                                    <div class="col">
                                                        <h5 class="mb-1">Basic Details</h5>
                                                        <p class="small text-secondary">Please type details very carefully and fill out the form with your personal details exact match with your identity proof. Your can't edit these details once you submitted.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </a>
                                    ...
                                    <div class="col-10 col-sm col-md">
                                        <a href="{{ route('preview.learning-profile-kyc-2') }}" class="card border-theme-1 shadow-sm overflow-hidden style-none mb-4">
                                            <div class="card-body">
                                                <div class="row gx-3">
                                                    <div class="col-auto">
                                                        <span class="avatar avatar-40 rounded bg-theme-1 text-white h5">2</span>
                                                    </div>
                                                    <div class="col">
                                                        <h5 class="mb-1 text-theme-1">Address Details</h5>
                                                        <p class="small text-theme-1 opacity-75">Please type details very carefully and fill out the form with your address details exact match with your address proof. Your can't edit these details once you submitted.
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-md-4 col-lg-3">
                                                ...
                                                <form action="/target" class="dropzone mb-2" id="myDropzone3">
                                            ...
                                            <div class="col-12 col-md-4 col-lg-3">
                                                ...
                                                <form action="/target" class="dropzone mb-2" id="myDropzone4">
                                                    <div class="dz-default dz-message my-2">
                                                        <i class="h1 bi bi-cloud-upload"></i><br>
                                                        <button class="dz-button" type="button">Drag and Drop or Click here to upload</button>
                                                    </div>
                                ...
                                <div class="form-check mb-3">
                                    ...
                                    <label class="form-check-label" for="flexCheckChecked">
                                        All the personal details and address details I have provided is correct.
                                    </label>
                                </div>
