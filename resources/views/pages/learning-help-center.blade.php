    ...
    <div class="adminuiux-sidebar-inner">
        ...
        <div class="px-3 not-iconic">
            ...
            <div class="container mt-4">
                <div class="row gx-3 align-items-center">
                    ...
                    <div class="col-auto py-1 ms-auto">
                        <a href="{{ route('preview.learning-ticket-list') }}" class="btn btn-theme"> Tickets <i data-feather="arrow-right"></i>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="container mt-4" id="main-content">
                            ...
                            <div class="card-body">
                                <div class="row justify-content-center pt-4">
                                    <div class="col-11 col-md-10 col-lg-8 col-xl-7 col-xxl-5 text-center position-relative z-index-1">
                                        ...
                                        <h5 class="fw-normal text-secondary mb-4">Find solution for your troubles. We have wide range of learning tutorials and supports.</h5>
                                        <!-- search -->
                                ...
                                <br>
                                <!-- top queries  -->
                                <p class="text-center text-secondary mb-3">Popular Questions</p>
                        ...
                        <div class="card adminuiux-card shadow-sm mb-4">
                            <div class="card-body">
                                <div class="row align-items-center mb-4">
                                    ...
                                    <div class="col">
                                        <h5 class="mb-1">Login and Logout</h5>
                        ...
                        <div class="card adminuiux-card shadow-sm mb-4">
                            <div class="card-body">
                                <div class="row align-items-center mb-4">
                                    ...
                                    <div class="col">
                                        <h5 class="mb-1">Customization &amp; Settings</h5>
                                        <p class="text-secondary small">Make it more like yours</p>
                                    </div>
                                </div>
                                <div class="list-group adminuiux-list-group list-group-flush">
                                    <a href="#" class="list-group-item list-group-item-action">How to change color scheme? </a>
                                    <a href="#" class="list-group-item list-group-item-action">Personalize background images?</a>
                                    <a href="#" class="list-group-item list-group-item-action">Update colors in theme colors?</a>
                                    <a href="#" class="list-group-item list-group-item-action">How to create new theme colors set?</a>
                                    <a href="#" class="list-group-item list-group-item-action">Purpose of the crowd assets?</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card adminuiux-card shadow-sm mb-4">
                            <div class="card-body">
                                <div class="row align-items-center mb-4">
                                    ...
                                    <div class="col">
                                        <h5 class="mb-1">License and Usage</h5>
                                        <p class="text-secondary small">Read more about usage & licenses</p>
                                    </div>
                                </div>
                                <div class="list-group adminuiux-list-group list-group-flush">
                                    <a href="#" class="list-group-item list-group-item-action">What is mean bt free license?</a>
                                    <a href="#" class="list-group-item list-group-item-action">What is business license?</a>
                                    <a href="#" class="list-group-item list-group-item-action">How is PRO different from free license?</a>
                                    <a href="#" class="list-group-item list-group-item-action">Benefits of PRO license?</a>
                                    <a href="#" class="list-group-item list-group-item-action">Personal use limitation and restrictions?</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <!-- raise ticket -->
                <div class="mb-4 text-center py-4 py-lg-5">
                    <div class="row justify-content-center">
                        <div class="col-12 col-md-10 col-lg-8">
                            <h1>Couldn't find what you are looking for?</h1>
                            <p class="mb-4">Its possible human made mistakes and possibly we may missed it. We are happy to assist you as well as upgrade our system. Do let us know your query, concern and feedback.</p>
                            <a href="{{ route('preview.learning-contactus') }}" class="btn btn-theme mx-1">Connect with us</a>
                            <a href="" class="btn btn-outline-theme mx-1">Leave us feedback</a>
                        </div>
                    </div>
                </div>
                <!-- quick links -->
                    ...
                    <div class="col-12 col-md-4 col-lg-4">
                        <div class="card adminuiux-card shadow-sm mb-4">
                            <div class="card-body">
                                ...
                                <p class="text-secondary mb-4">You have live assistant with whom you can share your query &amp; get answered. </p>
                                <a href="{{ route('preview.learning-ticket-list') }}" class="btn btn-theme">Watch Community</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-4 col-lg-4">
                        <div class="card adminuiux-card  mb-4">
                            <div class="card-body">
                                ...
                                <p class="text-secondary mb-4">Connect with our expert by submitting details with photos &amp; documents.</p>
                                <a href="{{ route('preview.learning-add-ticket') }}" class="btn btn-theme">Create Ticket</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-4 col-lg-4">
                        <div class="card adminuiux-card shadow-sm mb-4">
                            <div class="card-body">
                                ...
                                <p class="text-secondary mb-4">Get details of features and quick look on how it works. Schedule a demo.</p>
