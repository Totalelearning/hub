        ...
        <main class="adminuiux-content" onclick="contentClick()">
                        ...
                        <div class="col col-sm mb-2 mb-sm-0">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item active bi" aria-current="page">Riskometer</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="col-auto ">
            ...
            <div class="container mt-4">
                <div class="card adminuiux-card shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        <p class="text-secondary">CSS riskometer have multiple class level for risk from low to high-risk. You can add class on riskometer div <code>low</code>, <code>low-moderate</code>, <code>moderate</code>, <code>moderate-high</code>, <code>high</code>, <code>very-high</code>
                        </p>
                        <br>
                        ...
                        <p class="text-secondary">You can also change size by adding style property <code>--riskometer-width:200px</code>
                        <div class="riskometer moderate mb-3" style="--riskometer-width: 200px;">
                            <!-- low low-moderate moderate moderate-high very-high high-->
                            <div class="indicator"></div>
                        </div>
                    </div>
