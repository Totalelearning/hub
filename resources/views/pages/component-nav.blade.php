        ...
        <main class="adminuiux-content" onclick="contentClick()">
                        ...
                        <div class="col col-sm mb-2 mb-sm-0">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item active bi" aria-current="page">Navs</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="col-auto ">
            ...
            &lt;/nav&gt;
                ...
                <div class="card adminuiux-card shadow-sm mb-4">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <p class="h6">Nav Tabs and Pills</p>
                            </div>
                            <div class="col-auto">
            ...
            &lt;/ul&gt;
                ...
                <div class="bg-theme-1-subtle rounded px-3 py-2 mb-4">
                    <div class="row">
                        <div class="col">
                            <a href="{{ route('preview.component-header') }}" class="btn btn-accent me-3 my-2"><i class="bi bi-arrow-left mr-2"></i> Header</a>
                        </div>
                        <div class="col-auto">
                            <a href="{{ route('preview.component-tabs') }}" class="btn btn-theme my-2">Tabs <i class="bi bi-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                </div>
            </div>
