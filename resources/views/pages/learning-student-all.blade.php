    ...
    <div class="adminuiux-sidebar-inner">
        ...
        <div class="px-3 not-iconic">
                    ...
                    <div class="col-12 col-md">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-3 mb-md-0">
                                ...
                                <li class="breadcrumb-item active bi" aria-current="page">All Student</li>
                            </ol>
                        </nav>
                    </div>
            ...
            <div class="container mt-4" id="main-content">
                <div class="row">
                    <!-- attendance summary -->
                    <div class="col-6 col-md-6 col-lg-3 pt-2 mb-4">
                        <div class="card adminuiux-card shadow-sm position-relative">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-auto">
                                        <div class="avatar avatar-70 rounded bg-theme-1 text-white theme-teal h2 mt--25 mb-3 mb-sm-0">
                    ...
                    <div class="col-6 col-md-6 col-lg-3 pt-2 mb-4">
                        <div class="card adminuiux-card shadow-sm position-relative">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-auto">
                                        <div class="avatar avatar-70 rounded bg-theme-1 text-white theme-red h2 mt--25 mb-3 mb-sm-0">
                    ...
                    <div class="col-6 col-md-6 col-lg-3 pt-2 mb-4">
                        <div class="card adminuiux-card shadow-sm position-relative">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-auto">
                                        <div class="avatar avatar-70 rounded bg-theme-1 text-white theme-orange h2 mt--25 mb-3 mb-sm-0">
                    ...
                    <div class="col-6 col-md-6 col-lg-3 pt-2 mb-4">
                        <div class="card adminuiux-card shadow-sm position-relative">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-auto">
                                        <div class="avatar avatar-70 rounded bg-theme-1 text-white theme-blue h2 mt--25 mb-3 mb-sm-0">
                    ...
                    <div class="col-12 col-md-6 col-lg-3 mb-4">
                        <div class="card adminuiux-card shadow-sm">
                            <div class="card-header z-index-1">
                                <div class="row align-items-center">
                                    <div class="col mb-3 mb-lg-0">
                                        <h5 class="mb-2">Kittu Johnson</h5>
                                        <h6 class="text-secondary">Class 10<sup>th</sup></h6>
                                    </div>
                                    <div class="col-auto">
                                        <div class="dropdown d-inline-block">
                            ...
                            <div class="card-body py-0 position-relative">
                                <div class="height-300 w-100 rounded coverimg position-relative">
                            ...
                            <div class="card-footer z-index-1">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <p class="small text-secondary">Class 9<sup>th</sup>, Grade A+, 88<small class="fs-14">%</small></p>
                                    </div>
                                    <div class="col-auto">
                                        <a href="{{ route('preview.learning-student-profile') }}" class="btn btn-link btn-square rounded-circle">
                    ...
                    <div class="col-12 col-md-6 col-lg-3 mb-4">
                        <div class="card adminuiux-card shadow-sm">
                            <div class="card-header z-index-1">
                                <div class="row align-items-center">
                                    <div class="col mb-3 mb-lg-0">
                                        <h5 class="mb-2">Ariana Gill <i class="bi bi-star-fill small text-theme-1 theme-yellow"></i></h5>
                                        <h6 class="text-secondary">Class 10<sup>th</sup></h6>
                                    </div>
                                    <div class="col-auto">
                                        <div class="dropdown d-inline-block">
                    ...
                    <div class="col-12 col-md-6 col-lg-3 mb-4">
                        <div class="card adminuiux-card shadow-sm">
                            <div class="card-header z-index-1">
                                <div class="row align-items-center">
                                    <div class="col mb-3 mb-lg-0">
                                        <h5 class="mb-2">Jenelia Smith</h5>
                                        <h6 class="text-secondary">Class 10<sup>th</sup></h6>
                                    </div>
                                    <div class="col-auto">
                            ...
                            <div class="card-body py-0 z-index-1 position-relative overflow-hidden">
                                <div class="height-300 w-100 rounded coverimg">
                            ...
                            <div class="card-footer z-index-1">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <p class="small text-secondary">Class 9<sup>th</sup>, Grade A+, 88.50<small class="fs-14">%</small></p>
                                    </div>
                                    <div class="col-auto">
                                        <a href="{{ route('preview.learning-student-profile') }}" class="btn btn-link btn-square rounded-circle">
                                            <i class="bi bi-arrow-right"></i>
                    ...
                    <div class="col-12 col-md-6 col-lg-3 mb-4">
                        <div class="card adminuiux-card shadow-sm">
                            <div class="card-header z-index-1">
                                <div class="row align-items-center">
                                    <div class="col mb-3 mb-lg-0">
                                        <h5 class="mb-2">Will Smith</h5>
                                        <h6 class="text-secondary">Class 9<sup>th</sup></h6>
                                    </div>
                                    <div class="col-auto">
                            ...
                            <div class="card-footer z-index-1">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <p class="small text-secondary">Class 9<sup>th</sup>, Grade A+, 82.15<small class="fs-14">%</small></p>
                                    </div>
                                    <div class="col-auto">
                                        <a href="{{ route('preview.learning-student-profile') }}" class="btn btn-link btn-square rounded-circle">
                                            <i class="bi bi-arrow-right"></i>
                        ...
                        <div class="swiper-slide width-250">
                            <div class="card adminuiux-card shadow-sm mb-4">
                                <div class="card-header z-index-1">
                                    <div class="row align-items-center">
                                        <div class="col mb-3 mb-lg-0">
                                            <h6 class="mb-0">Kittu Johnson</h6>
                                            <p class="text-secondary">Class 10<sup>th</sup></p>
                                        </div>
                                        <div class="col-auto">
                                            <div class="dropdown d-inline-block">
                                                <a class="btn btn-sm btn-link btn-square no-caret" data-bs-toggle="dropdown"><i class="bi bi-three-dots"></i></a>
                                ...
                                <div class="card-body py-0 position-relative">
                                    <div class="height-220 w-100 rounded coverimg position-relative">
                                        <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/user-3.jpg') }}" alt="">
                                        <div class="position-absolute top-0 end-0 p-2">
                                            <div class="badge badge-light bg-theme-1 text-white theme-green"><i class="bi bi-check-all me-1"></i>Present</div>
                                        </div>
                        ...
                        <div class="swiper-slide width-250">
                            <div class="card adminuiux-card shadow-sm mb-4">
                                <div class="card-header z-index-1">
                                    <div class="row align-items-center">
                                        <div class="col mb-3 mb-lg-0">
                                            <h6 class="mb-0">Ariana Gill <i class="bi bi-star-fill small text-theme-1 theme-yellow"></i></h6>
                                            <p class="text-secondary">Class 10<sup>th</sup></p>
                                        </div>
                                        <div class="col-auto">
                                            <div class="dropdown d-inline-block">
                        ...
                        <div class="swiper-slide width-250">
                            <div class="card adminuiux-card shadow-sm mb-4">
                                <div class="card-header">
                                    <div class="row align-items-center">
                                        <div class="col mb-3 mb-lg-0">
                                            <h6 class="mb-0">Jenelia Smith</h6>
                                            <p class="text-secondary">Class 10<sup>th</sup></p>
                                        </div>
                                        <div class="col-auto">
                                            <div class="badge badge-light bg-theme-1-subtle text-theme-1 theme-red"><i class="bi bi-check-all me-1"></i>Absent</div>
                                ...
                                <div class="card-body py-0 position-relative overflow-hidden">
                                    <div class="height-220 w-100 rounded coverimg">
                                        <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/user-1-kid.jpg') }}" alt="">
                                    </div>
                                </div>
                                <div class="card-footer">
                            ...
                            <div class="card adminuiux-card shadow-sm mb-4">
                                <div class="card-header z-index-1">
                                    <div class="row align-items-center">
                                        <div class="col mb-3 mb-lg-0">
                                            <h6 class="mb-0">Will Smith</h6>
                                            <p class="text-secondary">Class 9<sup>th</sup></p>
                                        </div>
                                        <div class="col-auto">
                                            <div class="badge badge-light bg-theme-1-subtle text-theme-1 theme-green"><i class="bi bi-check-all me-1"></i>Present</div>
                                        </div>
