        ...
        <div class="px-3 not-iconic">
            ...
            <div class="container mt-4" id="main-content">
                <div class="row">
                        ...
                        <div class="card adminuiux-card shadow-sm mb-4">
                            <div class="card-body px-xl-4">
                                ...
                                <div class="row align-items-center mb-4">
                                    ...
                                    <div class="col">
                                        <p class="text-secondary">per user</p>
                                    </div>
                                </div>
                                <hr>
                                <h6>Basic includes:</h6>
                                <ul class="list-group adminuiux-list-group mb-4">
                                    <li class="list-group-item text-secondary"><i class="bi bi-check-circle vm me-1"></i> All courses access</li>
                                    <li class="list-group-item text-secondary"><i class="bi bi-check-circle vm me-1"></i> Unlimited Download</li>
                                    <li class="list-group-item text-secondary"><i class="bi bi-check-circle vm me-1"></i> Weekly Assignments</li>
                                    <li class="list-group-item text-secondary"><i class="bi bi-check-circle vm me-1"></i> Parental Guidance</li>
                                    <li class="list-group-item text-secondary"><i class="bi bi-check-circle vm me-1"></i> Online Progress Tracking</li>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="card adminuiux-card shadow-sm bg-r-gradient border border-theme-1 mb-4">
                            <div class="card-body px-xl-4">
                                <div class="text-center mb-4">
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="card adminuiux-card shadow-sm mb-4 bg-theme-1">
                            <div class="position-absolute start-0 top-0 h-100 w-100 rounded overflow-hidden coverimg z-index-0">
                                <img src="{{ asset('vendor/learninguiux/img/learning/bg-overlay-1.png') }}" alt="">
                            </div>
                            <div class="card-body px-xl-4 z-index-1 position-relative">
                                <div class="text-center mb-4">
                                ...
                                <div class="row align-items-center mb-4">
                                    ...
                                    <div class="col">
                                        <p class="opacity-75">per user</p>
                                    </div>
                                </div>
                                <hr class="border-top opacity-50">
                                <h6>Ultra Pro includes:</h6>
                                <ul class="list-group adminuiux-list-group bg-white-opacity mb-4">
                                    <li class="list-group-item text-white"><i class="bi bi-check-circle vm me-1"></i> All courses access</li>
                                    <li class="list-group-item text-white"><i class="bi bi-check-circle vm me-1"></i> Unlimited Download</li>
                                    <li class="list-group-item text-white"><i class="bi bi-check-circle vm me-1"></i> Weekly Assignments</li>
                                    <li class="list-group-item text-white"><i class="bi bi-check-circle vm me-1"></i> Parental Guidance</li>
                                    <li class="list-group-item text-white"><i class="bi bi-check-circle vm me-1"></i> Online Progress Tracking</li>
