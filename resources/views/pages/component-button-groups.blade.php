        ...
        <main class="adminuiux-content" onclick="contentClick()">
                        ...
                        <div class="col col-sm mb-2 mb-sm-0">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item active bi" aria-current="page">Button Group</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="col-auto ">
                ...
                <div class="card adminuiux-card shadow-sm mb-4">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <p class="h6">Standard Buttons Group</p>
                            </div>
                            <div class="col-auto">
            ...
            &lt;/div&gt;</code></pre>
                ...
                <div class="card adminuiux-card shadow-sm mb-4">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <p class="h6">Checkbox Buttons Group</p>
                            </div>
                            <div class="col-auto">
            ...
            &lt;/div&gt;</code></pre>
                ...
                <div class="card adminuiux-card shadow-sm mb-4">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <p class="h6">Radio Buttons Types</p>
                            </div>
                            <div class="col-auto">
            ...
            &lt;/div&gt;</code></pre>
                ...
                <div class="card adminuiux-card shadow-sm mb-4">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <p class="h6">Mix with dropdown</p>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                            ...
                            <div class="btn-group" role="group">
                                <button type="button" class="btn btn-theme dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"> Dropdown 1 </button>
            ...
            &lt;/div&gt;</code></pre>
                ...
                <div class="card adminuiux-card shadow-sm mb-4">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <p class="h6">Vertical Button Groups</p>
                            </div>
                            <div class="col-auto">
            ...
            &lt;/div&gt;</code></pre>
                ...
                <div class="card adminuiux-card shadow-sm mb-4">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <p class="h6">Mixed Colors Buttons Groups</p>
                            </div>
                            <div class="col-auto">
            ...
            &lt;/div&gt;</code></pre>
                ...
                <div class="bg-theme-1-subtle rounded px-3 py-2 mb-4">
                    <div class="row">
                        <div class="col">
                            <a href="{{ route('preview.component-buttons') }}" class="btn btn-accent me-3 my-2"><i class="bi bi-arrow-left mr-2"></i> Buttons</a>
                        </div>
                        <div class="col-auto">
                            <a href="{{ route('preview.component-icon-buttons') }}" class="btn btn-theme my-2">Icon Buttons <i class="bi bi-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                </div>
            </div>
