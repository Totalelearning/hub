                        ...
                        <main class="adminuiux-content has-sidebar" onclick="contentClick()">
                            ...
                            <div class="container mt-4">
                                <div class="row align-items-center">
                                    <div class="col-12 col-md order-1 order-md-1">
                                        ...
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb mb-3 mb-md-0">
                                                ...
                                                <li class="breadcrumb-item active bi" aria-current="page">Event Calendar</li>
                                            </ol>
                                        </nav>
                                    </div>
                                    ...
                                    <div class="col-auto col-md-auto order-4 mb-md-0">
                                        <button class="btn btn-theme" data-bs-toggle="modal" data-bs-target="#addeventmodal">
                            ...
                            <div class="container mt-4" id="main-content">
                                <div class="row align-items-center mb-3">
                                    <div class="col-auto">
                                        <p class="text-secondary mb-1">Filtered with: </p>
                                    </div>
                                    <div class="col">
                                        <span class="badge badge-light text-bg-theme-1 theme-green me-1 mb-1">
                                            <span class="row align-items-center gx-2">
                                                ...
                                                <span class="col-auto">
                                                    <button class="btn btn-link p-0 avatar avatar-20 rounded-circle text-center theme-red"><i class="bi bi-x"></i></button>
                                                </span>
                                            </span>
                                        </span>
                                    </div>
...
@push('scripts')
<script src="{{ asset('vendor/learninguiux/js/learning/learning-fullcalendar.js') }}"></script>
@endpush
