                    ...
                    <div class="row gx-2">
                        ...
                        <main class="adminuiux-content has-sidebar" onclick="contentClick()">
                                    ...
                                    <div class="col-12 col-sm">
                                        ...
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb mb-0">
                                                ...
                                                <li class="breadcrumb-item active bi" aria-current="page">Blogs</li>
                                            </ol>
                                        </nav>
                                    </div>
                                    <div class="col-auto py-1">
                                        <a href="{{ route('preview.learning-add-blog') }}" class="btn btn-theme">
                                            <i class="bi bi-file-earmark-plus me-0 me-md-1"></i>
                            ...
                            <div class="container mt-4" id="main-content">
                                ...
                                <div class="swiper swipernav mb-4" data-pagination="{el: '.swiper-pagination',}">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="card adminuiux-card shadow-sm">
                                                <div class="card-body px-lg-4 px-xl-5 pt-lg-4 pt-xl-5 pb-5">
                                                    <p><span class="badge badge-light rounded-pill text-bg-theme-1">Investment Revolution</span></p>
                                                    <h1>Learning UI UX Design with HTML ready to use template is most delighted themes</h1>
                                                    <p class="text-secondary my-4">Connects and integrates all your appointment sources - Website, Leads,
                                                        Mobile, and reception desk. Everything is in a central appointment management software! Set up
                                                        appointments for your patients in the most effective way and manage record of patient, set
                                                        reminder, sent messages etc. with the help of the Investment and Financial Freedom Software
                                                        App.
                                                    </p>
                                                    <p><a href="{{ route('preview.learning-blog-details') }}" class="btn btn-theme">Continue reading...</a></p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="card adminuiux-card shadow-sm bg-theme-1 position-relative overflow-hidden">
                                                ...
                                                <div class="card-body z-index-1 px-lg-4 px-xl-5 pt-lg-4 pt-xl-5 pb-5 position-relative">
                                                    <p><span class="badge badge-light rounded-pill bg-pink text-white">Investment Revolution</span>
                                                    </p>
                                                    <h1>Learning UI UX Design with HTML ready to use template is most delighted themes</h1>
                                                    <p class="my-4">Connects and integrates all your appointment sources - Website, Leads,
                                                        Mobile, and reception desk. Everything is in a central appointment management software! Set up
                                                        appointments for your patients in the most effective way and manage record of patient, set
                                                        reminder, sent messages etc. with the help of the Investment and Financial Freedom Software
                                                        App.
                                        ...
                                        <div class="swiper-slide">
                                            <div class="card adminuiux-card shadow-sm position-relative bg-theme-1 overflow-hidden">
                                                <div class="coverimg h-100 w-100 start-0 top-0 position-absolute z-index-0 opacity-50">
                                        ...
                                        <div class="card adminuiux-card shadow-sm overflow-hidden mb-4">
                                            <div class="row position-relative">
                                                <div class="col-8 d-flex flex-column position-static">
                                                    <div class="card-body">
                                                        <p>
                                                            <span class="badge badge-light rounded-pill bg-blue-subtle text-blue-emphasis">World</span>
                                                            <span class="badge badge-light rounded-pill bg-yellow-subtle text-yellow-emphasis">Featured</span>
                                                        </p>
                                                        <p class="h5">Best of Technology</p>
                                                        <p class="small text-secondary">Nov 12 2024</p>
                                                        <p class="text-secondary">Now a days AI takes over everywhere in each field to improve
                                                            productivity and performance but human mind squeezing day by day</p>
                                                        <a href="{{ route('preview.learning-blog-details') }}" class="">Read more <i class="bi bi-arrow-right"></i></a>
                                                    </div>
                                                </div>
                                                <div class="col-4 d-lg-block position-relative">
                                                    <div class="coverimg h-100 w-100 start-0 top-0 position-absolute z-index-0 ">
                                                        <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/pet-3.jpg') }}" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card adminuiux-card shadow-sm overflow-hidden mb-4">
                                            <div class="row position-relative">
                                                <div class="col-8 d-flex flex-column position-static">
                                                    <div class="card-body">
                                                        <p>
                                                            <span class="badge badge-light rounded-pill bg-pink-subtle text-pink-emphasis">Cutest
                                                                things</span>
                                                            <span class="badge badge-light rounded-pill bg-yellow-subtle text-yellow-emphasis">Featured</span>
                                                        </p>
                                                        <p class="h5">Best of Technology</p>
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-8">
                                        <div class="card adminuiux-card shadow-sm overflow-hidden mb-4">
                                            <div class="card-body">
                                                <div class="coverimg miheight-300 w-100 rounded mb-3">
                                                    <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/bus-2.jpg') }}" alt="">
                                                </div>
                                                <p>
                                                    <span class="badge badge-light rounded-pill bg-blue-subtle text-blue-emphasis">World</span>
                                                    <span class="badge badge-light rounded-pill bg-yellow-subtle text-yellow-emphasis">Featured</span>
                                                ...
                                                <p class="text-secondary">Now a days AI takes over everywhere in each field to improve
                                                    productivity and performance but human mind squeezing day by day</p>
                                                <a href="{{ route('preview.learning-blog-details') }}" class="btn btn-theme">
                                        ...
                                        <div class="card adminuiux-card shadow-sm overflow-hidden mb-4">
                                            <div class="card-body">
                                                <div class="coverimg miheight-300 w-100 rounded mb-3">
                                                    <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/tree-20.jpg') }}" alt="">
                                                </div>
                                                <p>
                                                    <span class="badge badge-light rounded-pill bg-blue-subtle text-blue-emphasis">World</span>
                                                    <span class="badge badge-light rounded-pill bg-yellow-subtle text-yellow-emphasis">Featured</span>
                                        ...
                                        <div class="position-sticky" style="top: 5.5rem;">
                                            <div class="card adminuiux-card bg-theme-1-subtle mb-4">
                                                <div class="card-body">
                                                    ...
                                                    <p>AdminUIUX is way better than any other template design in terms of
                                                        user experience design and modern touch of experience design sense. More flexibility and
                                                        customization available at with easy to develope</p>
                                                </div>
                                            </div>
                                                    ...
                                                    <a class="style-none" href="#">
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col" style="max-width: calc(100% - 110px);">
                                                                ...
                                                                <p class="text-secondary text-truncated mb-2">Just feeling like another world exploring at</p>
                                                ...
                                                <li class="pb-3">
                                                    <a class="style-none" href="#">
                                                        <div class="row align-items-center">
                                                            <div class="col-auto">
                                                                <div class="avatar avatar-80 rounded coverimg">
                                                                    <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/tree-18.jpg') }}" alt="">
                                                                </div>
                                                            </div>
                                                            <div class="col" style="max-width: calc(100% - 110px);">
                                                ...
                                                <li class="pb-3">
                                                    <a class="style-none" href="#">
                                                        <div class="row align-items-center">
                                                            <div class="col-auto">
                                                                <div class="avatar avatar-80 rounded coverimg">
                                                                    <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/bus-7.jpg') }}" alt="">
                                                                </div>
                                                            </div>
                                                            <div class="col" style="max-width: calc(100% - 110px);">
                                            ...
                                            <ol class="list-group adminuiux-list-group list-group-flush mb-4">
                                                <li class="list-group-item bg-none"><a href="#" class="style-none">March 2025</a></li>
                                                <li class="list-group-item bg-none"><a href="#" class="style-none">February 2025</a></li>
                                                <li class="list-group-item bg-none"><a href="#" class="style-none">January 2025</a></li>
                                                <li class="list-group-item bg-none"><a href="#" class="style-none">December 2024</a></li>
                                                <li class="list-group-item bg-none"><a href="#" class="style-none">November 2024</a></li>
                                                <li class="list-group-item bg-none"><a href="#" class="style-none">October 2024</a></li>
                                            </ol>

                                            <h6 class="mb-3">Elsewhere</h6>
                                            <ol class="list-group adminuiux-list-group list-group-flush mb-4">
                                                <li class="list-group-item bg-none"><a href="#" class="style-none">GitHub</a></li>
                                                <li class="list-group-item bg-none"><a href="#" class="style-none">Twitter</a></li>
                                                <li class="list-group-item bg-none"><a href="#" class="style-none">Facebook</a></li>
                                            </ol>
                                ...
                                <div class="text-center my-4 my-xl-5">
                                    <h1>More trending stories to cover</h1>
                                    <p class="text-secondary mb-0">Stay up to date with latest trending topics.</p>
                                </div>
                                ...
                                <div class="swiper swipernav">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide width-300">
                                            <div class="card adminuiux-card shadow-sm position-relative overflow-hidden theme-red mb-3">
                                                <div class="card-body z-index-1 p-xl-4 position-relative">
                                                    <p><span class="badge badge-light rounded-pill text-bg-theme-1">Creative UI UX</span>
                                                    </p>
                                                    <p class="text-truncated h5">Learning UI UX Design with HTML ready to use template is most delighted themes</p>
                                                    <p class="text-secondary mb-4">Connects and integrates all your appointment sources - Website,
                                                        Leads, Mobile,
                                                    </p>
                                                    <div class="row align-items-center">
                                                        <div class="col">
                                                            <p class="small text-secondary mb-0">Author</p>
                                                            <p>Adminuiux</p>
                                                        </div>
                                                        <div class="col-auto text-end">
                                                            <p>
                                                                <a href="{{ route('preview.learning-blog-details') }}" class="btn btn-link">More
                                        ...
                                        <div class="swiper-slide width-300">
                                            <div class="card adminuiux-card shadow-sm position-relative overflow-hidden theme-pink mb-3">
                                                <div class="card-body z-index-1 p-xl-4 position-relative">
                                                    <p><span class="badge badge-light rounded-pill text-bg-theme-1">New to world</span>
                                                    </p>
                                                    <p class="text-truncated h5">Learning UI UX Design with HTML ready to use template is most delighted themes</p>
                                                    <p class="text-secondary mb-4">Connects and integrates all your appointment sources - Website,
                                                        Leads, Mobile,
                                        ...
                                        <div class="swiper-slide width-300">
                                            <div class="card adminuiux-card shadow-sm position-relative overflow-hidden theme-purple mb-3">
                                                <div class="card-body z-index-1 p-xl-4 position-relative">
                                                    <p><span class="badge badge-light rounded-pill text-bg-theme-1">New to world</span>
                                                    </p>
                                                    <p class="text-truncated h5">Learning UI UX Design with HTML ready to use template is most delighted themes</p>
                                        ...
                                        <div class="swiper-slide width-300">
                                            <div class="card adminuiux-card shadow-sm bg-success text-white position-relative overflow-hidden mb-3">
                                                <div class="coverimg h-100 w-100 start-0 top-0 position-absolute z-index-0 opacity-25">
                                                    <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/tree-5.jpg') }}" alt="">
                                                </div>
                                                <div class=" card-body z-index-1 p-xl-4 position-relative">
                                                    <p><span class="badge badge-light rounded-pill bg-green text-white">Appointment</span>
                                                    </p>
                                                    <p class="text-truncated h5">Learning UI UX Design with HTML ready to use template is most delighted themes</p>
                                                    <p class="mb-4">Connects and integrates all your appointment sources - Website, Leads,
                                                        Mobile,
                                                    </p>
                                                    <p><a href="{{ route('preview.learning-blog-details') }}" class="btn btn-theme theme-green">Read More <i class="bi bi-arrow-right"></i></a>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide width-300">
                                            <div class="card adminuiux-card shadow-sm bg-theme-1 text-white position-relative overflow-hidden theme-orange mb-3">
                                                <div class="coverimg h-100 w-100 start-0 top-0 position-absolute z-index-0 opacity-50">
                                                    <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/tree-4.jpg') }}" alt="">
                                                </div>
                                                <div class="card-body z-index-1 p-xl-4 position-relative">
                                                    <p><span class="badge badge-light rounded-pill bg-orange text-white">Medical Champ</span>
                                                    </p>
                                                    <p class="text-truncated h5">Learning UI UX Design with HTML ready to use template is most delighted themes</p>
                                                    <p class="mb-4">Connects and integrates all your appointment sources - Website, Leads,
                                                        Mobile,
                                                    </p>
                                                    <p><a href="{{ route('preview.learning-blog-details') }}" class="btn btn-theme theme-orange">Read More <i class="bi bi-arrow-right"></i></a>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
