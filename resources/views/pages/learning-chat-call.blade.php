                            ...
                            <div class="row flex-nowrap">
                              ...
                              <div class="col-9 align-self-center ps-0">
                                <div class="row g-0">
                                  ...
                                  <div class="col-4 text-end"><small class="opacity-50 fs-10 mb-1"><i class="bi bi-check"></i> 2:00 am</small></div>
                                </div>
                            ...
                            <div class="row">
                              ...
                              <div class="col-9 align-self-center ps-0">
                                <div class="row g-0">
                                  ...
                                  <div class="col-4 text-end"><small class="opacity-50 fs-10 mb-1"><i class="bi bi-check-all"></i> 2:00 am</small></div>
                                </div>
                                <p class="opacity-75 small text-truncate">Spread love and spread this template</p>
                              </div>
                            </div>
                            ...
                            <div class="row">
                              ...
                              <div class="col-9 align-self-center ps-0">
                                <div class="row g-0">
                                  ...
                                  <div class="col-4 text-end"><small class="opacity-50 fs-10 mb-1"><i class="bi bi-check-all text-info"></i>
                                      2:00 am</small></div>
                                </div>
                                <p class="opacity-75 small text-truncate">Spread love and spread this template</p>
                              </div>
                            ...
                            <div class="row">
                              ...
                              <div class="col-9 align-self-center ps-0">
                                <div class="row g-0">
                                  ...
                                  <div class="col-4 text-end"><small class="opacity-50 fs-10 mb-1"><i class="bi bi-check-all text-success"></i> 2 days</small></div>
                                </div>
                                <p class="opacity-75 small text-truncate">Spread love and spread this template</p>
                              </div>
                            </div>
                            ...
                            <div class="row">
                              ...
                              <div class="col-9 align-self-center ps-0">
                                <div class="row g-0">
                                  ...
                                  <div class="col-4 text-end"><small class="opacity-50 fs-10 mb-1"><i class="bi bi-check-all"></i>
                                      4
                                      days
                                    </small></div>
                                </div>
                            ...
                            <div class="row">
                              ...
                              <div class="col-9 align-self-center ps-0">
                                <div class="row g-0">
                                  ...
                                  <div class="col-4 text-end"><small class="opacity-50 fs-10 mb-1"><i class="bi bi-check"></i> 1
                                      mo
                                    </small></div>
                                </div>
                                <p class="opacity-75 small text-truncate">Spread love and spread this template</p>
                            ...
                            <div class="row align-items-center gx-2">
                              ...
                              <div class="col-auto">
                                <div class="row align-items-center gx-2">
                                  ...
                                  <div class="col align-self-center">
                                    <h6 class="mb-0">
                                      <span class="position-relative">Alice Johanson
                            ...
                            <div class="row no-margin right-chat">
                              <div class="col-12">
                                <div class="chat-block">
                                  <div class="row">
                                    <div class="col">
                                      <p>Ohh... Thats great. Adminuiux is HTML template can be used in various business domains
                                        like
                                        SAAS, CRM, Content Management, Manufacturing, inventory, IT, administration etc.</p>
                                    </div>
                                  </div>
                                </div>
                              </div>
                                  ...
                                  <div class="accordion-body">
                                    <div class="swiper swipernav">
                                      <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide w-auto">
                                          <figure class="avatar avatar-80 coverimg rounded">
                                            <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/pet-1.jpg') }}" alt="">
                                          </figure>
                                        </div>
                                        <div class="swiper-slide w-auto">
                                          <figure class="avatar avatar-80 coverimg rounded">
                                  ...
                                  <div class="accordion-body">
                                    <div class="swiper swipernav">
                                      <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide width-100">
                                          <figure class="coverimg height-100 w-100 rounded d-flex justify-content-center align-items-center">
                                            <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/flamingo-2.jpg') }}" alt="">
                                            <i class="bi bi-play text-white fs-4 rounded-circle avatar avatar-60 bg-theme-1-subtle d-block mx-auto"></i>
                                          </figure>
                                        </div>
                                        <div class="swiper-slide width-100">
                                          <figure class="coverimg height-100 w-100 rounded d-flex justify-content-center align-items-center">
                                            <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/flamingo-3.jpg') }}" alt="">
                                            <i class="bi bi-play text-white fs-4 rounded-circle avatar avatar-60 bg-theme-1-subtle d-block mx-auto"></i>
                                          </figure>
                                        </div>
                                        <div class="swiper-slide width-100">
                                          <figure class="coverimg height-100 w-100 rounded d-flex justify-content-center align-items-center">
                                            <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/flamingo-4.jpg') }}" alt="">
                                            <i class="bi bi-play text-white fs-4 rounded-circle avatar avatar-60 bg-theme-1-subtle d-block mx-auto"></i>
                                          </figure>
                                        </div>
                                        <div class="swiper-slide width-100">
                                      ...
                                      <div class="swiper-wrapper">
                                        <div class="swiper-slide width-100">
                                          <figure class="coverimg height-100 w-100 rounded d-flex align-items-center justify-content-center text-center">
                                            <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/tree-1.jpg') }}" alt="">
                                            <i class="bi bi-music-note-beamed text-white fs-4 rounded-circle avatar avatar-60 bg-theme-1-subtle d-block mx-auto"></i>
                                          </figure>
                                        </div>
                                        <div class="swiper-slide width-100">
                                          <figure class="coverimg height-100 w-100 rounded d-flex align-items-center justify-content-center text-center">
                                            <img src="{{ asset('vendor/learninguiux/img/modern-ai-image/tree-2.jpg') }}" alt="">
                                            <i class="bi bi-music-note-beamed text-white fs-4 rounded-circle avatar avatar-60 bg-theme-1-subtle d-block mx-auto"></i>
                                          </figure>
                                        </div>
                                        <div class="swiper-slide width-100">
                ...
                <div class="modal-dialog modal-dialog-centered modal-fullscreen-lg-down">
                  <div class="modal-content">
                    <div class="modal-body p-0 position-relative">
                      <video src="{{ asset('vendor/learninguiux/img/learning/5200355-hd_720_1280_50fps.mp4') }}" autoplay loop class="top-0 start-0 w-100 h-100 z-index-0 d-block rounded">
                      </video>
                      ...
                      <div class="position-absolute bottom-0 start-0 end-0 m-3 m-lg-4 rounded z-index-1">
                        <div class="row justify-content-center">
                          <div class="col-auto mb-3 position-relative">
                            ...
                            <video src="{{ asset('vendor/learninguiux/img/learning/8342934-hd_720_1280_25fps.mp4') }}" autoplay loop class="top-0 start-0 width-100 h-auto z-index-0 d-block rounded border border-2 shadow">
                            </video>
                          </div>
                          <div class="col-auto mb-3 position-relative">
                            <button class="btn btn-light btn-square rounded-circle position-absolute top-0 end-0 mt-1 mx-3">
                            ...
                            <video src="{{ asset('vendor/learninguiux/img/learning/6935820-hd_720_1280_30fps.mp4') }}" autoplay loop class="top-0 start-0 width-100 h-auto z-index-0 d-block rounded border border-2 shadow">
                            </video>
                          </div>
                        </div>
