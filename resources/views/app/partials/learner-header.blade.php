...
<header class="adminuiux-header">
    <nav class="navbar navbar-expand-lg fixed-top">
        <div class="container-fluid">
            ...
            {{-- Logo --}}
            <a class="navbar-brand" href="{{ route('app.feed') }}">
            ...
            <div class="ms-auto d-flex align-items-center">
                ...
                <a href="{{ route('app.reminders') }}" class="btn btn-link btn-square btn-icon btn-link-header position-relative">
                    <i data-feather="bell" @if($unreadNotificationCount > 0) style="color:#dc2626;" @endif></i>
                    @if ($unreadNotificationCount > 0)
                        <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger" style="font-size:.65rem;min-width:18px;padding:3px 5px;">
                ...
                <div class="dropdown d-inline-block">
                    <a class="dropdown-toggle btn btn-link btn-square btn-link-header style-none no-caret px-0"
                       id="learnerHeaderProfileDd" data-bs-toggle="dropdown" aria-expanded="false" role="button">
                    ...
                    <div class="dropdown-menu dropdown-menu-end width-300 px-0 sm-mi-45px" aria-labelledby="learnerHeaderProfileDd">
